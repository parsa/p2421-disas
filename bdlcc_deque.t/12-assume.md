...
0000000000000018: 05	movl	$88, %esi
000000000000001d: 03	movq	%rdx, %rdi
0000000000000020: 03	callq	*16(%rax)
0000000000000023: 03	movq	%rax, %rbx
0000000000000026: 07	movq	$4950336, (%rax)
000000000000002d: 04	leaq	8(%rax), %r15
0000000000000031: 04	movups	(%rbp), %xmm0
0000000000000035: 04	movups	16(%rbp), %xmm1
0000000000000039: 04	movups	%xmm0, 8(%rax)
000000000000003d: 04	movups	%xmm1, 24(%rax)
0000000000000041: 04	leaq	40(%rax), %rdi
0000000000000045: 08	movq	$0, 40(%rax)
000000000000004d: 04	movq	%r14, 80(%rax)
0000000000000051: 07	movaps	187032(%rip), %xmm0  # 4e6290 <MULTI_THREADED_TRY_PUSH::nullItem+0x150>
0000000000000058: 04	movups	%xmm0, 64(%rax)
...
0000000000000091: 02	je	0x4b8843 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_10::EmptyDequeFunctor>(unsigned long*, TEST_CASE_10::EmptyDequeFunctor const&, BloombergLP::bslma::Allocator*)+0xa3>
...
00000000000000a5: 02	je	0x4b8878 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_10::EmptyDequeFunctor>(unsigned long*, TEST_CASE_10::EmptyDequeFunctor const&, BloombergLP::bslma::Allocator*)+0xd8>
00000000000000a7: 05	cmpq	$23, 72(%rbx)
00000000000000ac: 02	je	0x4b885c <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_10::EmptyDequeFunctor>(unsigned long*, TEST_CASE_10::EmptyDequeFunctor const&, BloombergLP::bslma::Allocator*)+0xbc>
00000000000000ae: 04	movq	40(%rbx), %rsi
00000000000000b2: 04	movq	80(%rbx), %rdi
00000000000000b6: 03	movq	(%rdi), %rax
00000000000000b9: 03	callq	*24(%rax)
00000000000000bc: 08	movq	$-1, 64(%rbx)
00000000000000c4: 03	movq	%r15, %rdi
00000000000000c7: 05	callq	0x476a40 <TEST_CASE_10::EmptyDequeFunctor::~EmptyDequeFunctor()>
...
0000000000000108: 02	je	0x4b88c7 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_10::EmptyDequeFunctor>(unsigned long*, TEST_CASE_10::EmptyDequeFunctor const&, BloombergLP::bslma::Allocator*)+0x127>
...
000000000000011a: 02	jmp	0x4b88c7 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_10::EmptyDequeFunctor>(unsigned long*, TEST_CASE_10::EmptyDequeFunctor const&, BloombergLP::bslma::Allocator*)+0x127>
...
0000000000000127: 05	cmpq	$23, 72(%rbx)
000000000000012c: 02	je	0x4b88dc <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_10::EmptyDequeFunctor>(unsigned long*, TEST_CASE_10::EmptyDequeFunctor const&, BloombergLP::bslma::Allocator*)+0x13c>
000000000000012e: 04	movq	40(%rbx), %rsi
0000000000000132: 04	movq	80(%rbx), %rdi
0000000000000136: 03	movq	(%rdi), %rax
0000000000000139: 03	callq	*24(%rax)
000000000000013c: 08	movq	$-1, 64(%rbx)
0000000000000144: 03	movq	%r15, %rdi
0000000000000147: 05	callq	0x476a40 <TEST_CASE_10::EmptyDequeFunctor::~EmptyDequeFunctor()>
...
0000000000000158: 02	jmp	0x4b8929 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_10::EmptyDequeFunctor>(unsigned long*, TEST_CASE_10::EmptyDequeFunctor const&, BloombergLP::bslma::Allocator*)+0x189>
...
000000000000016d: 08	movq	$0, 64(%rbx)
0000000000000175: 03	movq	%r15, %rdi
0000000000000178: 05	callq	0x476a40 <TEST_CASE_10::EmptyDequeFunctor::~EmptyDequeFunctor()>
