...
0000000000000018: 02	jne	0x4b651e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_11::HighWaterMarkFunctor<double> >(unsigned long*, TEST_CASE_11::HighWaterMarkFunctor<double> const&, BloombergLP::bslma::Allocator*)+0x2e>
000000000000001a: 07	movq	2555919(%rip), %r14  # 726520 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000021: 03	testq	%r14, %r14
0000000000000024: 02	jne	0x4b651e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_11::HighWaterMarkFunctor<double> >(unsigned long*, TEST_CASE_11::HighWaterMarkFunctor<double> const&, BloombergLP::bslma::Allocator*)+0x2e>
...
0000000000000031: 05	movl	$80, %esi
0000000000000036: 03	movq	%r14, %rdi
0000000000000039: 03	callq	*16(%rax)
000000000000003c: 03	movq	%rax, %rbx
000000000000003f: 07	movq	$4941488, (%rax)
0000000000000046: 04	leaq	8(%rax), %r15
000000000000004a: 04	movups	(%rbp), %xmm0
000000000000004e: 04	movups	%xmm0, 8(%rax)
0000000000000052: 04	movq	16(%rbp), %rax
0000000000000056: 04	movq	%rax, 24(%rbx)
000000000000005a: 04	leaq	32(%rbx), %rdi
000000000000005e: 08	movq	$0, 32(%rbx)
0000000000000066: 04	movq	%r14, 72(%rbx)
000000000000006a: 07	movaps	197791(%rip), %xmm0  # 4e6a00 <MULTI_THREADED_TRY_PUSH::nullItem+0x150>
0000000000000071: 04	movups	%xmm0, 56(%rbx)
...
00000000000000aa: 02	je	0x4b65ac <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_11::HighWaterMarkFunctor<double> >(unsigned long*, TEST_CASE_11::HighWaterMarkFunctor<double> const&, BloombergLP::bslma::Allocator*)+0xbc>
...
00000000000000be: 02	je	0x4b65e1 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_11::HighWaterMarkFunctor<double> >(unsigned long*, TEST_CASE_11::HighWaterMarkFunctor<double> const&, BloombergLP::bslma::Allocator*)+0xf1>
00000000000000c0: 05	cmpq	$23, 64(%rbx)
00000000000000c5: 02	je	0x4b65c5 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_11::HighWaterMarkFunctor<double> >(unsigned long*, TEST_CASE_11::HighWaterMarkFunctor<double> const&, BloombergLP::bslma::Allocator*)+0xd5>
00000000000000c7: 04	movq	32(%rbx), %rsi
00000000000000cb: 04	movq	72(%rbx), %rdi
00000000000000cf: 03	movq	(%rdi), %rax
00000000000000d2: 03	callq	*24(%rax)
00000000000000d5: 08	movq	$-1, 56(%rbx)
00000000000000dd: 03	movq	%r15, %rdi
00000000000000e0: 05	callq	0x4b6470 <TEST_CASE_11::HighWaterMarkFunctor<double>::~HighWaterMarkFunctor()>
...
0000000000000121: 02	je	0x4b6630 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_11::HighWaterMarkFunctor<double> >(unsigned long*, TEST_CASE_11::HighWaterMarkFunctor<double> const&, BloombergLP::bslma::Allocator*)+0x140>
...
0000000000000133: 02	jmp	0x4b6630 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_11::HighWaterMarkFunctor<double> >(unsigned long*, TEST_CASE_11::HighWaterMarkFunctor<double> const&, BloombergLP::bslma::Allocator*)+0x140>
...
0000000000000140: 05	cmpq	$23, 64(%rbx)
0000000000000145: 02	je	0x4b6645 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_11::HighWaterMarkFunctor<double> >(unsigned long*, TEST_CASE_11::HighWaterMarkFunctor<double> const&, BloombergLP::bslma::Allocator*)+0x155>
0000000000000147: 04	movq	32(%rbx), %rsi
000000000000014b: 04	movq	72(%rbx), %rdi
000000000000014f: 03	movq	(%rdi), %rax
0000000000000152: 03	callq	*24(%rax)
0000000000000155: 08	movq	$-1, 56(%rbx)
000000000000015d: 03	movq	%r15, %rdi
0000000000000160: 05	callq	0x4b6470 <TEST_CASE_11::HighWaterMarkFunctor<double>::~HighWaterMarkFunctor()>
...
0000000000000171: 02	jmp	0x4b6692 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<TEST_CASE_11::HighWaterMarkFunctor<double> >(unsigned long*, TEST_CASE_11::HighWaterMarkFunctor<double> const&, BloombergLP::bslma::Allocator*)+0x1a2>
...
0000000000000186: 08	movq	$0, 56(%rbx)
000000000000018e: 03	movq	%r15, %rdi
0000000000000191: 05	callq	0x4b6470 <TEST_CASE_11::HighWaterMarkFunctor<double>::~HighWaterMarkFunctor()>
