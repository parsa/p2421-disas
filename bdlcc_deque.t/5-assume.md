# `int BloombergLP::bslmt::ThreadUtil::createWithAllocator<USAGE_EXAMPLE_2::WorkerFunctor>(unsigned long*, USAGE_EXAMPLE_2::WorkerFunctor const&, BloombergLP::bslma::Allocator*)` - Assumed
...
0000000000000024: 07	movq	$4798960, (%rax)
...
000000000000004b: 07	movaps	338382(%rip), %xmm0  # 4e6290 <MULTI_THREADED_TRY_PUSH::nullItem+0x150>
0000000000000052: 04	movups	%xmm0, 56(%rbx)
0000000000000056: 05	movl	$5148848, %ecx
000000000000005b: 02	xorl	%esi, %esi
000000000000005d: 02	xorl	%edx, %edx
000000000000005f: 05	callq	0x4c2e20 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>
0000000000000064: 03	movq	%rsp, %rdi
0000000000000067: 05	callq	0x4be750 <BloombergLP::bslmt::ThreadAttributes::ThreadAttributes()>
000000000000006c: 03	movq	%rsp, %rsi
000000000000006f: 05	movl	$4973232, %edx
...
0000000000000087: 02	je	0x493909 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<USAGE_EXAMPLE_2::WorkerFunctor>(unsigned long*, USAGE_EXAMPLE_2::WorkerFunctor const&, BloombergLP::bslma::Allocator*)+0x99>
...
000000000000009b: 02	je	0x493936 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<USAGE_EXAMPLE_2::WorkerFunctor>(unsigned long*, USAGE_EXAMPLE_2::WorkerFunctor const&, BloombergLP::bslma::Allocator*)+0xc6>
000000000000009d: 05	cmpq	$23, 64(%rbx)
00000000000000a2: 02	je	0x493922 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<USAGE_EXAMPLE_2::WorkerFunctor>(unsigned long*, USAGE_EXAMPLE_2::WorkerFunctor const&, BloombergLP::bslma::Allocator*)+0xb2>
...
00000000000000f4: 02	je	0x493983 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<USAGE_EXAMPLE_2::WorkerFunctor>(unsigned long*, USAGE_EXAMPLE_2::WorkerFunctor const&, BloombergLP::bslma::Allocator*)+0x113>
...
0000000000000106: 02	jmp	0x493983 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<USAGE_EXAMPLE_2::WorkerFunctor>(unsigned long*, USAGE_EXAMPLE_2::WorkerFunctor const&, BloombergLP::bslma::Allocator*)+0x113>
0000000000000108: 03	movq	%rax, %rdi
000000000000010b: 05	callq	0x433eb0 <__clang_call_terminate>
0000000000000110: 03	movq	%rax, %r15
0000000000000113: 05	cmpq	$23, 64(%rbx)
0000000000000118: 02	je	0x493998 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<USAGE_EXAMPLE_2::WorkerFunctor>(unsigned long*, USAGE_EXAMPLE_2::WorkerFunctor const&, BloombergLP::bslma::Allocator*)+0x128>
...
000000000000013c: 02	jmp	0x4939d5 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<USAGE_EXAMPLE_2::WorkerFunctor>(unsigned long*, USAGE_EXAMPLE_2::WorkerFunctor const&, BloombergLP::bslma::Allocator*)+0x165>
...
0000000000000168: 05	callq	0x404850 <_Unwind_Resume@plt>
000000000000016d: 03	movq	%rax, %rdi
0000000000000170: 05	callq	0x433eb0 <__clang_call_terminate>
