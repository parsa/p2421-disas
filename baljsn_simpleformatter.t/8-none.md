# `int BloombergLP::baljsn::SimpleFormatter::addValue<BloombergLP::bdlt::TimeTz>(BloombergLP::bdlt::TimeTz const&)` - Ignored

```nasm
000000000042a940 <int BloombergLP::baljsn::SimpleFormatter::addValue<BloombergLP::bdlt::TimeTz>(BloombergLP::bdlt::TimeTz const&)>:
...
M0000000000000016:	jne	0x42a9b7 <int BloombergLP::baljsn::SimpleFormatter::addValue<BloombergLP::bdlt::TimeTz>(BloombergLP::bdlt::TimeTz const&)+0x77>	;  2 bytes
M0000000000000018:	movb	10(%rbx), %bpl	;  4 bytes
M000000000000001c:	movb	$1, 9(%rbx)	;  4 bytes
M0000000000000020:	cmpb	$0, 8(%rbx)	;  4 bytes
M0000000000000024:	je	0x42a99a <int BloombergLP::baljsn::SimpleFormatter::addValue<BloombergLP::bdlt::TimeTz>(BloombergLP::bdlt::TimeTz const&)+0x5a>	;  2 bytes
...
M0000000000000041:	jne	0x42a99a <int BloombergLP::baljsn::SimpleFormatter::addValue<BloombergLP::bdlt::TimeTz>(BloombergLP::bdlt::TimeTz const&)+0x5a>	;  2 bytes
...
M0000000000000065:	jne	0x42a9fd <int BloombergLP::baljsn::SimpleFormatter::addValue<BloombergLP::bdlt::TimeTz>(BloombergLP::bdlt::TimeTz const&)+0xbd>	;  2 bytes
...
M0000000000000075:	jmp	0x42a9fd <int BloombergLP::baljsn::SimpleFormatter::addValue<BloombergLP::bdlt::TimeTz>(BloombergLP::bdlt::TimeTz const&)+0xbd>	;  2 bytes
M0000000000000077:	movb	$1, 9(%rbx)	;  4 bytes
M000000000000007b:	cmpb	$0, 8(%rbx)	;  4 bytes
M000000000000007f:	je	0x42a9f5 <int BloombergLP::baljsn::SimpleFormatter::addValue<BloombergLP::bdlt::TimeTz>(BloombergLP::bdlt::TimeTz const&)+0xb5>	;  2 bytes
...
M000000000000009c:	jne	0x42a9f5 <int BloombergLP::baljsn::SimpleFormatter::addValue<BloombergLP::bdlt::TimeTz>(BloombergLP::bdlt::TimeTz const&)+0xb5>	;  2 bytes
...
M00000000000000eb:	callq	0x440270 <BloombergLP::bdlt::Iso8601Util::generate(char*, int, BloombergLP::bdlt::TimeTz const&, BloombergLP::bdlt::Iso8601UtilConfiguration const&)>	;  5 bytes
