...
M000000000000001d:	je	0x420f65 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> const&, BloombergLP::bslma::Allocator*)+0x25>	;  2 bytes
M000000000000001f:	movq	24(%r15), %rbp	;  4 bytes
M0000000000000023:	jmp	0x420f69 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> const&, BloombergLP::bslma::Allocator*)+0x29>	;  2 bytes
...
M000000000000003a:	movq	$4329600, (%rax)	;  7 bytes
...
M0000000000000051:	movaps	65752(%rip), %xmm0  # 431070 <__dso_handle+0x288>	;  7 bytes
...
M0000000000000083:	je	0x420fee <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> const&, BloombergLP::bslma::Allocator*)+0xae>	;  2 bytes
M0000000000000085:	cmpq	$23, 48(%rbx)	;  5 bytes
M000000000000008a:	je	0x420fda <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> const&, BloombergLP::bslma::Allocator*)+0x9a>	;  2 bytes
...
M00000000000000d7:	je	0x421027 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> const&, BloombergLP::bslma::Allocator*)+0xe7>	;  2 bytes
...
M00000000000000fb:	jmp	0x421064 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<4193280> const&, BloombergLP::bslma::Allocator*)+0x124>	;  2 bytes
