# `int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> const&, BloombergLP::bslma::Allocator*)` - Assumed
...
M000000000000001d:	je	0x41ab85 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> const&, BloombergLP::bslma::Allocator*)+0x25>	;  2 bytes
M000000000000001f:	movq	24(%r15), %rbp	;  4 bytes
M0000000000000023:	jmp	0x41ab89 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> const&, BloombergLP::bslma::Allocator*)+0x29>	;  2 bytes
...
M000000000000003a:	movq	$4304032, (%rax)	;  7 bytes
...
M0000000000000051:	movaps	91320(%rip), %xmm0  # 431070 <__dso_handle+0x288>	;  7 bytes
...
M0000000000000083:	je	0x41ac0e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> const&, BloombergLP::bslma::Allocator*)+0xae>	;  2 bytes
M0000000000000085:	cmpq	$23, 48(%rbx)	;  5 bytes
M000000000000008a:	je	0x41abfa <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> const&, BloombergLP::bslma::Allocator*)+0x9a>	;  2 bytes
...
M00000000000000d7:	je	0x41ac47 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> const&, BloombergLP::bslma::Allocator*)+0xe7>	;  2 bytes
...
M00000000000000fb:	jmp	0x41ac84 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<24576> const&, BloombergLP::bslma::Allocator*)+0x124>	;  2 bytes
