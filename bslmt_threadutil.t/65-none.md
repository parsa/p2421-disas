# `int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> const&, BloombergLP::bslma::Allocator*)` - Ignored

```nasm
00000000004196e0 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> const&, BloombergLP::bslma::Allocator*)>:
...
M0000000000000019:	je	0x419701 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> const&, BloombergLP::bslma::Allocator*)+0x21>	;  2 bytes
M000000000000001b:	movq	24(%r15), %r13	;  4 bytes
M000000000000001f:	jmp	0x419705 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> const&, BloombergLP::bslma::Allocator*)+0x25>	;  2 bytes
...
M000000000000002c:	jne	0x419722 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> const&, BloombergLP::bslma::Allocator*)+0x42>	;  2 bytes
M000000000000002e:	movq	2274203(%rip), %r14  # 644ab0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000035:	testq	%r14, %r14	;  3 bytes
M0000000000000038:	jne	0x419722 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> const&, BloombergLP::bslma::Allocator*)+0x42>	;  2 bytes
...
M0000000000000053:	movq	$4298800, (%rax)	;  7 bytes
...
M000000000000006a:	movaps	97871(%rip), %xmm0  # 4315a0 <__dso_handle+0x288>	;  7 bytes
...
M000000000000009c:	je	0x4197a7 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> const&, BloombergLP::bslma::Allocator*)+0xc7>	;  2 bytes
M000000000000009e:	cmpq	$23, 48(%rbx)	;  5 bytes
M00000000000000a3:	je	0x419793 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> const&, BloombergLP::bslma::Allocator*)+0xb3>	;  2 bytes
...
M00000000000000f0:	je	0x4197e0 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> const&, BloombergLP::bslma::Allocator*)+0x100>	;  2 bytes
...
M0000000000000114:	jmp	0x41981d <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<8192> const&, BloombergLP::bslma::Allocator*)+0x13d>	;  2 bytes
