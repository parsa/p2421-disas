# `int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> const&, BloombergLP::bslma::Allocator*)` - Assumed

```nasm
000000000041cd60 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> const&, BloombergLP::bslma::Allocator*)>:
...
M000000000000001d:	je	0x41cd85 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> const&, BloombergLP::bslma::Allocator*)+0x25>	;  2 bytes
M000000000000001f:	movq	24(%r15), %rbp	;  4 bytes
M0000000000000023:	jmp	0x41cd89 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> const&, BloombergLP::bslma::Allocator*)+0x29>	;  2 bytes
...
M000000000000003a:	movq	$4312736, (%rax)	;  7 bytes
...
M0000000000000051:	movaps	82616(%rip), %xmm0  # 431070 <__dso_handle+0x288>	;  7 bytes
...
M0000000000000083:	je	0x41ce0e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> const&, BloombergLP::bslma::Allocator*)+0xae>	;  2 bytes
M0000000000000085:	cmpq	$23, 48(%rbx)	;  5 bytes
M000000000000008a:	je	0x41cdfa <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> const&, BloombergLP::bslma::Allocator*)+0x9a>	;  2 bytes
...
M00000000000000d7:	je	0x41ce47 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> const&, BloombergLP::bslma::Allocator*)+0xe7>	;  2 bytes
...
M00000000000000fb:	jmp	0x41ce84 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<66560> const&, BloombergLP::bslma::Allocator*)+0x124>	;  2 bytes
