...
M000000000000001d:	je	0x418875 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_CONFIGURATION_TEST_NAMESPACE::Func>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_CONFIGURATION_TEST_NAMESPACE::Func const&, BloombergLP::bslma::Allocator*)+0x25>	;  2 bytes
M000000000000001f:	movq	24(%r15), %r13	;  4 bytes
M0000000000000023:	jmp	0x418879 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_CONFIGURATION_TEST_NAMESPACE::Func>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_CONFIGURATION_TEST_NAMESPACE::Func const&, BloombergLP::bslma::Allocator*)+0x29>	;  2 bytes
...
M0000000000000030:	jne	0x418896 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_CONFIGURATION_TEST_NAMESPACE::Func>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_CONFIGURATION_TEST_NAMESPACE::Func const&, BloombergLP::bslma::Allocator*)+0x46>	;  2 bytes
M0000000000000032:	movq	2277927(%rip), %r14  # 644ab0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000039:	testq	%r14, %r14	;  3 bytes
M000000000000003c:	jne	0x418896 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_CONFIGURATION_TEST_NAMESPACE::Func>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_CONFIGURATION_TEST_NAMESPACE::Func const&, BloombergLP::bslma::Allocator*)+0x46>	;  2 bytes
...
M0000000000000057:	movq	$4294528, (%rax)	;  7 bytes
...
M0000000000000077:	movaps	101586(%rip), %xmm0  # 4315a0 <__dso_handle+0x288>	;  7 bytes
M000000000000007e:	movups	%xmm0, 48(%rax)	;  4 bytes
M0000000000000082:	movl	$4402443, %ecx	;  5 bytes
M0000000000000087:	movq	%r13, %rsi	;  3 bytes
M000000000000008a:	movq	%rbp, %rdx	;  3 bytes
M000000000000008d:	callq	0x4254b0 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M0000000000000092:	movl	$4336848, %edx	;  5 bytes
M0000000000000097:	movq	(%rsp), %rdi	;  4 bytes
M000000000000009b:	movq	%r15, %rsi	;  3 bytes
M000000000000009e:	movq	%rbx, %rcx	;  3 bytes
M00000000000000a1:	callq	0x423340 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>	;  5 bytes
M00000000000000a6:	movl	%eax, %ebp	;  2 bytes
M00000000000000a8:	testl	%eax, %eax	;  2 bytes
M00000000000000aa:	je	0x418925 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_CONFIGURATION_TEST_NAMESPACE::Func>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_CONFIGURATION_TEST_NAMESPACE::Func const&, BloombergLP::bslma::Allocator*)+0xd5>	;  2 bytes
M00000000000000ac:	cmpq	$23, 56(%rbx)	;  5 bytes
M00000000000000b1:	je	0x418911 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_CONFIGURATION_TEST_NAMESPACE::Func>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_CONFIGURATION_TEST_NAMESPACE::Func const&, BloombergLP::bslma::Allocator*)+0xc1>	;  2 bytes
...
M00000000000000e9:	callq	0x40c3e0 <__clang_call_terminate>	;  5 bytes
M00000000000000ee:	movq	%rax, %rdi	;  3 bytes
M00000000000000f1:	callq	0x40c3e0 <__clang_call_terminate>	;  5 bytes
M00000000000000f6:	movq	%rax, %rbp	;  3 bytes
M00000000000000f9:	cmpq	$23, 56(%rbx)	;  5 bytes
M00000000000000fe:	je	0x41895e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_CONFIGURATION_TEST_NAMESPACE::Func>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_CONFIGURATION_TEST_NAMESPACE::Func const&, BloombergLP::bslma::Allocator*)+0x10e>	;  2 bytes
...
M0000000000000122:	jmp	0x41899b <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_CONFIGURATION_TEST_NAMESPACE::Func>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_CONFIGURATION_TEST_NAMESPACE::Func const&, BloombergLP::bslma::Allocator*)+0x14b>	;  2 bytes
M0000000000000124:	movq	%rax, %rdi	;  3 bytes
M0000000000000127:	callq	0x40c3e0 <__clang_call_terminate>	;  5 bytes
M000000000000012c:	movq	%rax, %rdi	;  3 bytes
M000000000000012f:	callq	0x40c3e0 <__clang_call_terminate>	;  5 bytes
...
M000000000000014e:	callq	0x4040f0 <_Unwind_Resume@plt>	;  5 bytes
M0000000000000153:	movq	%rax, %rdi	;  3 bytes
M0000000000000156:	callq	0x40c3e0 <__clang_call_terminate>	;  5 bytes
