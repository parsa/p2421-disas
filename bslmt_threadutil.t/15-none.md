...
0000000000000019: 02	je	0x41f0b1 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> const&, BloombergLP::bslma::Allocator*)+0x21>
000000000000001b: 04	movq	24(%r15), %r13
000000000000001f: 02	jmp	0x41f0b5 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> const&, BloombergLP::bslma::Allocator*)+0x25>
0000000000000021: 04	leaq	24(%r15), %r13
0000000000000025: 04	movq	48(%r15), %rbp
0000000000000029: 03	testq	%r14, %r14
000000000000002c: 02	jne	0x41f0d2 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> const&, BloombergLP::bslma::Allocator*)+0x42>
000000000000002e: 07	movq	2251243(%rip), %r14  # 644ab0 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000035: 03	testq	%r14, %r14
0000000000000038: 02	jne	0x41f0d2 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> const&, BloombergLP::bslma::Allocator*)+0x42>
...
0000000000000053: 07	movq	$4321760, (%rax)
000000000000005a: 04	leaq	16(%rax), %rdi
000000000000005e: 08	movq	$0, 16(%rax)
0000000000000066: 04	movq	%r14, 56(%rax)
000000000000006a: 07	movaps	74911(%rip), %xmm0  # 4315a0 <__dso_handle+0x288>
...
000000000000009c: 02	je	0x41f157 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> const&, BloombergLP::bslma::Allocator*)+0xc7>
000000000000009e: 05	cmpq	$23, 48(%rbx)
00000000000000a3: 02	je	0x41f143 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> const&, BloombergLP::bslma::Allocator*)+0xb3>
...
00000000000000f0: 02	je	0x41f190 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> const&, BloombergLP::bslma::Allocator*)+0x100>
...
0000000000000114: 02	jmp	0x41f1cd <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> >(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, STACKSIZE_TEST_CASE_NAMESPACE::Func<126976> const&, BloombergLP::bslma::Allocator*)+0x13d>
