...
0000000000000021: 02	je	0x418179 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_THREAD_POLICY_CREATION_TEST::Touch>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_THREAD_POLICY_CREATION_TEST::Touch const&, BloombergLP::bslma::Allocator*)+0x29>
0000000000000023: 04	movq	24(%r15), %rbp
0000000000000027: 02	jmp	0x41817d <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_THREAD_POLICY_CREATION_TEST::Touch>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_THREAD_POLICY_CREATION_TEST::Touch const&, BloombergLP::bslma::Allocator*)+0x2d>
...
000000000000003e: 07	movq	$4293280, (%rax)
...
000000000000005d: 07	movaps	102076(%rip), %xmm0  # 431070 <__dso_handle+0x288>
0000000000000064: 04	movups	%xmm0, 40(%rbx)
0000000000000068: 05	movl	$4401119, %ecx
000000000000006d: 03	movq	%rbp, %rsi
0000000000000070: 03	movq	%r13, %rdx
0000000000000073: 05	callq	0x424f70 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>
0000000000000078: 05	movl	$4335536, %edx
000000000000007d: 04	movq	(%rsp), %rdi
0000000000000081: 03	movq	%r15, %rsi
0000000000000084: 03	movq	%rbx, %rcx
0000000000000087: 05	callq	0x422e20 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>
000000000000008c: 02	movl	%eax, %ebp
000000000000008e: 02	testl	%eax, %eax
0000000000000090: 02	je	0x41820b <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_THREAD_POLICY_CREATION_TEST::Touch>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_THREAD_POLICY_CREATION_TEST::Touch const&, BloombergLP::bslma::Allocator*)+0xbb>
0000000000000092: 05	cmpq	$23, 48(%rbx)
0000000000000097: 02	je	0x4181f7 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_THREAD_POLICY_CREATION_TEST::Touch>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_THREAD_POLICY_CREATION_TEST::Touch const&, BloombergLP::bslma::Allocator*)+0xa7>
...
00000000000000cf: 05	callq	0x40c3c0 <__clang_call_terminate>
00000000000000d4: 03	movq	%rax, %rdi
00000000000000d7: 05	callq	0x40c3c0 <__clang_call_terminate>
00000000000000dc: 03	movq	%rax, %r15
00000000000000df: 05	cmpq	$23, 48(%rbx)
00000000000000e4: 02	je	0x418244 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_THREAD_POLICY_CREATION_TEST::Touch>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_THREAD_POLICY_CREATION_TEST::Touch const&, BloombergLP::bslma::Allocator*)+0xf4>
...
0000000000000108: 02	jmp	0x418281 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BSLMT_THREAD_POLICY_CREATION_TEST::Touch>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BSLMT_THREAD_POLICY_CREATION_TEST::Touch const&, BloombergLP::bslma::Allocator*)+0x131>
000000000000010a: 03	movq	%rax, %rdi
000000000000010d: 05	callq	0x40c3c0 <__clang_call_terminate>
0000000000000112: 03	movq	%rax, %rdi
0000000000000115: 05	callq	0x40c3c0 <__clang_call_terminate>
...
0000000000000134: 05	callq	0x4040f0 <_Unwind_Resume@plt>
0000000000000139: 03	movq	%rax, %rdi
000000000000013c: 05	callq	0x40c3c0 <__clang_call_terminate>
