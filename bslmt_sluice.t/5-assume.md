...
0000000000000021: 02	je	0x405b79 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0x29>
0000000000000023: 04	movq	24(%r15), %rbp
0000000000000027: 02	jmp	0x405b7d <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0x2d>
...
000000000000003e: 07	movq	$4218016, (%rax)
...
0000000000000068: 07	movaps	165121(%rip), %xmm0  # 42e0c0 <__dso_handle+0x28>
000000000000006f: 04	movups	%xmm0, 64(%rax)
0000000000000073: 05	movl	$4384167, %ecx
0000000000000078: 03	movq	%rbp, %rsi
000000000000007b: 03	movq	%r13, %rdx
000000000000007e: 05	callq	0x409680 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>
0000000000000083: 05	movl	$4221200, %edx
0000000000000088: 04	movq	(%rsp), %rdi
000000000000008c: 03	movq	%r15, %rsi
000000000000008f: 03	movq	%rbx, %rcx
0000000000000092: 05	callq	0x407350 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>
0000000000000097: 02	movl	%eax, %ebp
0000000000000099: 02	testl	%eax, %eax
000000000000009b: 02	je	0x405c16 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0xc6>
000000000000009d: 05	cmpq	$23, 72(%rbx)
00000000000000a2: 02	je	0x405c02 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0xb2>
...
00000000000000da: 05	callq	0x4057c0 <__clang_call_terminate>
00000000000000df: 03	movq	%rax, %rdi
00000000000000e2: 05	callq	0x4057c0 <__clang_call_terminate>
00000000000000e7: 03	movq	%rax, %r15
00000000000000ea: 05	cmpq	$23, 72(%rbx)
00000000000000ef: 02	je	0x405c4f <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0xff>
...
0000000000000113: 02	jmp	0x405c8c <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0x13c>
0000000000000115: 03	movq	%rax, %rdi
0000000000000118: 05	callq	0x4057c0 <__clang_call_terminate>
000000000000011d: 03	movq	%rax, %rdi
0000000000000120: 05	callq	0x4057c0 <__clang_call_terminate>
...
000000000000013f: 05	callq	0x403a30 <_Unwind_Resume@plt>
0000000000000144: 03	movq	%rax, %rdi
0000000000000147: 05	callq	0x4057c0 <__clang_call_terminate>
