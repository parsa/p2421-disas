...
M0000000000000021:	je	0x405b79 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0x29>	;  2 bytes
M0000000000000023:	movq	24(%r15), %rbp	;  4 bytes
M0000000000000027:	jmp	0x405b7d <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0x2d>	;  2 bytes
...
M000000000000003e:	movq	$4218016, (%rax)	;  7 bytes
...
M0000000000000068:	movaps	165121(%rip), %xmm0  # 42e0c0 <__dso_handle+0x28>	;  7 bytes
M000000000000006f:	movups	%xmm0, 64(%rax)	;  4 bytes
M0000000000000073:	movl	$4384167, %ecx	;  5 bytes
M0000000000000078:	movq	%rbp, %rsi	;  3 bytes
M000000000000007b:	movq	%r13, %rdx	;  3 bytes
M000000000000007e:	callq	0x409680 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M0000000000000083:	movl	$4221200, %edx	;  5 bytes
M0000000000000088:	movq	(%rsp), %rdi	;  4 bytes
M000000000000008c:	movq	%r15, %rsi	;  3 bytes
M000000000000008f:	movq	%rbx, %rcx	;  3 bytes
M0000000000000092:	callq	0x407350 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>	;  5 bytes
M0000000000000097:	movl	%eax, %ebp	;  2 bytes
M0000000000000099:	testl	%eax, %eax	;  2 bytes
M000000000000009b:	je	0x405c16 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0xc6>	;  2 bytes
M000000000000009d:	cmpq	$23, 72(%rbx)	;  5 bytes
M00000000000000a2:	je	0x405c02 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0xb2>	;  2 bytes
...
M00000000000000da:	callq	0x4057c0 <__clang_call_terminate>	;  5 bytes
M00000000000000df:	movq	%rax, %rdi	;  3 bytes
M00000000000000e2:	callq	0x4057c0 <__clang_call_terminate>	;  5 bytes
M00000000000000e7:	movq	%rax, %r15	;  3 bytes
M00000000000000ea:	cmpq	$23, 72(%rbx)	;  5 bytes
M00000000000000ef:	je	0x405c4f <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0xff>	;  2 bytes
...
M0000000000000113:	jmp	0x405c8c <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<EnterAndWaitUntilDoneJob>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, EnterAndWaitUntilDoneJob const&, BloombergLP::bslma::Allocator*)+0x13c>	;  2 bytes
M0000000000000115:	movq	%rax, %rdi	;  3 bytes
M0000000000000118:	callq	0x4057c0 <__clang_call_terminate>	;  5 bytes
M000000000000011d:	movq	%rax, %rdi	;  3 bytes
M0000000000000120:	callq	0x4057c0 <__clang_call_terminate>	;  5 bytes
...
M000000000000013f:	callq	0x403a30 <_Unwind_Resume@plt>	;  5 bytes
M0000000000000144:	movq	%rax, %rdi	;  3 bytes
M0000000000000147:	callq	0x4057c0 <__clang_call_terminate>	;  5 bytes
