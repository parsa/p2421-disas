...
M0000000000000016:	jne	0x4049dc <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitAndSetJob>(unsigned long*, WaitAndSetJob const&, BloombergLP::bslma::Allocator*)+0x2c>	;  2 bytes
M0000000000000018:	movq	2178369(%rip), %r14  # 618710 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M000000000000001f:	testq	%r14, %r14	;  3 bytes
M0000000000000022:	jne	0x4049dc <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitAndSetJob>(unsigned long*, WaitAndSetJob const&, BloombergLP::bslma::Allocator*)+0x2c>	;  2 bytes
M0000000000000024:	callq	0x410650 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
...
M000000000000003d:	movq	$4213568, (%rax)	;  7 bytes
...
M000000000000005c:	movaps	49677(%rip), %xmm0  # 410c20 <__dso_handle+0x38>	;  7 bytes
M0000000000000063:	movups	%xmm0, 48(%rax)	;  4 bytes
M0000000000000067:	movl	$4263425, %ecx	;  5 bytes
M000000000000006c:	xorl	%esi, %esi	;  2 bytes
M000000000000006e:	xorl	%edx, %edx	;  2 bytes
M0000000000000070:	callq	0x407670 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M0000000000000075:	movq	%rsp, %rdi	;  3 bytes
M0000000000000078:	callq	0x404ca0 <BloombergLP::bslmt::ThreadAttributes::ThreadAttributes()>	;  5 bytes
M000000000000007d:	movq	%rsp, %rsi	;  3 bytes
M0000000000000080:	movl	$4213792, %edx	;  5 bytes
M0000000000000085:	movq	%r15, %rdi	;  3 bytes
M0000000000000088:	movq	%rbx, %rcx	;  3 bytes
M000000000000008b:	callq	0x404ff0 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>	;  5 bytes
M0000000000000090:	movl	%eax, %ebp	;  2 bytes
M0000000000000092:	cmpq	$23, 56(%rsp)	;  6 bytes
M0000000000000098:	je	0x404a5a <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitAndSetJob>(unsigned long*, WaitAndSetJob const&, BloombergLP::bslma::Allocator*)+0xaa>	;  2 bytes
...
M00000000000000ac:	je	0x404a87 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitAndSetJob>(unsigned long*, WaitAndSetJob const&, BloombergLP::bslma::Allocator*)+0xd7>	;  2 bytes
M00000000000000ae:	cmpq	$23, 56(%rbx)	;  5 bytes
M00000000000000b3:	je	0x404a73 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitAndSetJob>(unsigned long*, WaitAndSetJob const&, BloombergLP::bslma::Allocator*)+0xc3>	;  2 bytes
...
M00000000000000e7:	callq	0x404150 <__clang_call_terminate>	;  5 bytes
M00000000000000ec:	movq	%rax, %rdi	;  3 bytes
M00000000000000ef:	callq	0x404150 <__clang_call_terminate>	;  5 bytes
M00000000000000f4:	movq	%rax, %rdi	;  3 bytes
M00000000000000f7:	callq	0x404150 <__clang_call_terminate>	;  5 bytes
M00000000000000fc:	movq	%rax, %r15	;  3 bytes
M00000000000000ff:	cmpq	$23, 56(%rsp)	;  6 bytes
M0000000000000105:	je	0x404ad4 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitAndSetJob>(unsigned long*, WaitAndSetJob const&, BloombergLP::bslma::Allocator*)+0x124>	;  2 bytes
...
M0000000000000117:	jmp	0x404ad4 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitAndSetJob>(unsigned long*, WaitAndSetJob const&, BloombergLP::bslma::Allocator*)+0x124>	;  2 bytes
M0000000000000119:	movq	%rax, %rdi	;  3 bytes
M000000000000011c:	callq	0x404150 <__clang_call_terminate>	;  5 bytes
M0000000000000121:	movq	%rax, %r15	;  3 bytes
M0000000000000124:	cmpq	$23, 56(%rbx)	;  5 bytes
M0000000000000129:	je	0x404ae9 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitAndSetJob>(unsigned long*, WaitAndSetJob const&, BloombergLP::bslma::Allocator*)+0x139>	;  2 bytes
...
M000000000000014d:	jmp	0x404b26 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitAndSetJob>(unsigned long*, WaitAndSetJob const&, BloombergLP::bslma::Allocator*)+0x176>	;  2 bytes
M000000000000014f:	movq	%rax, %rdi	;  3 bytes
M0000000000000152:	callq	0x404150 <__clang_call_terminate>	;  5 bytes
M0000000000000157:	movq	%rax, %rdi	;  3 bytes
M000000000000015a:	callq	0x404150 <__clang_call_terminate>	;  5 bytes
...
M0000000000000179:	callq	0x4033b0 <_Unwind_Resume@plt>	;  5 bytes
M000000000000017e:	movq	%rax, %rdi	;  3 bytes
M0000000000000181:	callq	0x404150 <__clang_call_terminate>	;  5 bytes
