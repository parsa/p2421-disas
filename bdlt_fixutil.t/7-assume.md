...
000000000000002c: 05	callq	0x43c3a0 <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::DatetimeTz*, char const*, int)>
0000000000000031: 02	testl	%eax, %eax
0000000000000033: 06	jne	0x43c25b <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x1db>
...
0000000000000052: 02	jle	0x43c147 <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0xc7>
0000000000000054: 05	movl	$1, %edi
0000000000000059: 05	movl	$1, %esi
000000000000005e: 05	movl	$1, %edx
0000000000000063: 05	callq	0x43cc20 <BloombergLP::bdlt::PosixDateImpUtil::ymdToSerial(int, int, int)>
...
00000000000000b2: 06	jns	0x43c269 <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x1e9>
00000000000000b8: 05	movl	$4294967295, %eax
00000000000000bd: 03	cmpq	%r13, %rbx
00000000000000c0: 02	jbe	0x43c1c0 <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x140>
00000000000000c2: 05	jmp	0x43c25b <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x1db>
00000000000000c7: 02	jns	0x43c1c0 <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x140>
00000000000000c9: 05	movl	$9999, %edi
00000000000000ce: 05	movl	$12, %esi
00000000000000d3: 05	movl	$31, %edx
00000000000000d8: 05	callq	0x43cc20 <BloombergLP::bdlt::PosixDateImpUtil::ymdToSerial(int, int, int)>
...
000000000000012c: 06	jns	0x43c333 <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x2b3>
0000000000000132: 05	movl	$4294967295, %eax
0000000000000137: 03	cmpq	%r13, %rbx
000000000000013a: 06	jb	0x43c25b <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x1db>
0000000000000140: 05	movq	8(%rsp), %rbx
0000000000000145: 03	testq	%rbx, %rbx
0000000000000148: 06	jns	0x43c2ce <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x24e>
000000000000014e: 05	movslq	16(%rsp), %rax
0000000000000153: 03	testq	%rax, %rax
0000000000000156: 02	je	0x43c256 <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x1d6>
...
00000000000001e9: 05	movl	$6785816, %edi
00000000000001ee: 05	callq	0x440850 <BloombergLP::bsls::Review::updateCount(BloombergLP::bsls::Atomic_TypeTraits<BloombergLP::bsls::AtomicOperations_ALL_ALL_ClangIntrinsics>::Int*)>
00000000000001f3: 09	movq	$4529248, 24(%rsp)
00000000000001fc: 09	movq	$4529302, 32(%rsp)
0000000000000205: 08	movl	$1126, 40(%rsp)
000000000000020d: 09	movq	$4628378, 48(%rsp)
0000000000000216: 04	movl	%eax, 56(%rsp)
000000000000021a: 05	leaq	24(%rsp), %rdi
000000000000021f: 05	callq	0x440870 <BloombergLP::bsls::Review::invokeHandler(BloombergLP::bsls::ReviewViolation const&)>
...
0000000000000249: 05	jmp	0x43c138 <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0xb8>
000000000000024e: 05	movl	$6785816, %edi
0000000000000253: 05	callq	0x440850 <BloombergLP::bsls::Review::updateCount(BloombergLP::bsls::Atomic_TypeTraits<BloombergLP::bsls::AtomicOperations_ALL_ALL_ClangIntrinsics>::Int*)>
0000000000000258: 09	movq	$4529248, 24(%rsp)
0000000000000261: 09	movq	$4529302, 32(%rsp)
000000000000026a: 08	movl	$1126, 40(%rsp)
0000000000000272: 09	movq	$4628378, 48(%rsp)
000000000000027b: 04	movl	%eax, 56(%rsp)
000000000000027f: 05	leaq	24(%rsp), %rdi
0000000000000284: 05	callq	0x440870 <BloombergLP::bsls::Review::invokeHandler(BloombergLP::bsls::ReviewViolation const&)>
...
00000000000002ae: 05	jmp	0x43c1ce <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x14e>
00000000000002b3: 05	movl	$6785816, %edi
00000000000002b8: 05	callq	0x440850 <BloombergLP::bsls::Review::updateCount(BloombergLP::bsls::Atomic_TypeTraits<BloombergLP::bsls::AtomicOperations_ALL_ALL_ClangIntrinsics>::Int*)>
00000000000002bd: 09	movq	$4529248, 24(%rsp)
00000000000002c6: 09	movq	$4529302, 32(%rsp)
00000000000002cf: 08	movl	$1126, 40(%rsp)
00000000000002d7: 09	movq	$4628378, 48(%rsp)
00000000000002e0: 04	movl	%eax, 56(%rsp)
00000000000002e4: 05	leaq	24(%rsp), %rdi
00000000000002e9: 05	callq	0x440870 <BloombergLP::bsls::Review::invokeHandler(BloombergLP::bsls::ReviewViolation const&)>
...
0000000000000313: 05	jmp	0x43c1b2 <BloombergLP::bdlt::FixUtil::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x132>
