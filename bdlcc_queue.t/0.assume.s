...
M0000000000000021:	je	0x41fb69 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<QUEUE_TEST_CASE_MINUS_1::Consumer>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, QUEUE_TEST_CASE_MINUS_1::Consumer const&, BloombergLP::bslma::Allocator*)+0x29>	;  2 bytes
M0000000000000023:	movq	24(%r15), %rbp	;  4 bytes
M0000000000000027:	jmp	0x41fb6d <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<QUEUE_TEST_CASE_MINUS_1::Consumer>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, QUEUE_TEST_CASE_MINUS_1::Consumer const&, BloombergLP::bslma::Allocator*)+0x2d>	;  2 bytes
...
M000000000000003e:	movq	$4324496, (%rax)	;  7 bytes
...
M000000000000005d:	movaps	167980(%rip), %xmm0  # 448bd0 <__dso_handle+0x128>	;  7 bytes
M0000000000000064:	movups	%xmm0, 40(%rbx)	;  4 bytes
M0000000000000068:	movl	$4497181, %ecx	;  5 bytes
M000000000000006d:	movq	%rbp, %rsi	;  3 bytes
M0000000000000070:	movq	%r13, %rdx	;  3 bytes
M0000000000000073:	callq	0x426630 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M0000000000000078:	movl	$4337712, %edx	;  5 bytes
M000000000000007d:	movq	(%rsp), %rdi	;  4 bytes
M0000000000000081:	movq	%r15, %rsi	;  3 bytes
M0000000000000084:	movq	%rbx, %rcx	;  3 bytes
M0000000000000087:	callq	0x423770 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>	;  5 bytes
M000000000000008c:	movl	%eax, %ebp	;  2 bytes
M000000000000008e:	testl	%eax, %eax	;  2 bytes
M0000000000000090:	je	0x41fbfb <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<QUEUE_TEST_CASE_MINUS_1::Consumer>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, QUEUE_TEST_CASE_MINUS_1::Consumer const&, BloombergLP::bslma::Allocator*)+0xbb>	;  2 bytes
M0000000000000092:	cmpq	$23, 48(%rbx)	;  5 bytes
M0000000000000097:	je	0x41fbe7 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<QUEUE_TEST_CASE_MINUS_1::Consumer>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, QUEUE_TEST_CASE_MINUS_1::Consumer const&, BloombergLP::bslma::Allocator*)+0xa7>	;  2 bytes
...
M00000000000000cf:	callq	0x4180f0 <__clang_call_terminate>	;  5 bytes
M00000000000000d4:	movq	%rax, %rdi	;  3 bytes
M00000000000000d7:	callq	0x4180f0 <__clang_call_terminate>	;  5 bytes
M00000000000000dc:	movq	%rax, %r15	;  3 bytes
M00000000000000df:	cmpq	$23, 48(%rbx)	;  5 bytes
M00000000000000e4:	je	0x41fc34 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<QUEUE_TEST_CASE_MINUS_1::Consumer>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, QUEUE_TEST_CASE_MINUS_1::Consumer const&, BloombergLP::bslma::Allocator*)+0xf4>	;  2 bytes
...
M0000000000000108:	jmp	0x41fc71 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<QUEUE_TEST_CASE_MINUS_1::Consumer>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, QUEUE_TEST_CASE_MINUS_1::Consumer const&, BloombergLP::bslma::Allocator*)+0x131>	;  2 bytes
M000000000000010a:	movq	%rax, %rdi	;  3 bytes
M000000000000010d:	callq	0x4180f0 <__clang_call_terminate>	;  5 bytes
M0000000000000112:	movq	%rax, %rdi	;  3 bytes
M0000000000000115:	callq	0x4180f0 <__clang_call_terminate>	;  5 bytes
...
M0000000000000134:	callq	0x403e50 <_Unwind_Resume@plt>	;  5 bytes
M0000000000000139:	movq	%rax, %rdi	;  3 bytes
M000000000000013c:	callq	0x4180f0 <__clang_call_terminate>	;  5 bytes
