...
0000000000000012: 06	je	0x41f59c <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x24c>
...
0000000000000023: 02	je	0x41f3aa <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x5a>
...
000000000000003d: 02	jge	0x41f3aa <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x5a>
...
0000000000000067: 05	movq	8(%r12), %rcx
000000000000006c: 04	subq	(%r12), %rcx
0000000000000070: 04	leaq	(%rax,%rax,2), %rbx
0000000000000074: 04	shrq	$3, %rcx
0000000000000078: 06	imull	$2863311531, %ecx, %eax
000000000000007e: 04	leal	1(%rbp,%rax), %esi
0000000000000082: 03	movq	%r12, %rdi
0000000000000085: 05	callq	0x41f860 <bsl::vector<BloombergLP::bdlbb::BlobBuffer, bsl::allocator<BloombergLP::bdlbb::BlobBuffer> >::reserve(unsigned long)>
000000000000008a: 04	movq	(%r12), %rax
000000000000008e: 05	leaq	24(%rax,%rbx,8), %rbx
0000000000000093: 03	movq	(%r14), %r13
0000000000000096: 03	movslq	%r15d, %rdx
0000000000000099: 03	xorps	%xmm0, %xmm0
000000000000009c: 05	movaps	%xmm0, 16(%rsp)
00000000000000a1: 08	movl	$0, 32(%rsp)
00000000000000a9: 05	leaq	16(%rsp), %rcx
00000000000000ae: 03	movq	%r12, %rdi
00000000000000b1: 03	movq	%rbx, %rsi
00000000000000b4: 04	movq	%rdx, (%rsp)
00000000000000b8: 05	callq	0x420340 <bsl::vector<BloombergLP::bdlbb::BlobBuffer, bsl::allocator<BloombergLP::bdlbb::BlobBuffer> >::insert(BloombergLP::bdlbb::BlobBuffer const*, unsigned long, BloombergLP::bdlbb::BlobBuffer const&)>
00000000000000bd: 05	movq	24(%rsp), %rdi
00000000000000c2: 03	testq	%rdi, %rdi
00000000000000c5: 02	je	0x41f41c <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0xcc>
00000000000000c7: 05	callq	0x4257c0 <BloombergLP::bslma::SharedPtrRep::releaseRef()>
00000000000000cc: 03	movslq	%ebp, %rax
00000000000000cf: 02	testl	%ebp, %ebp
00000000000000d1: 06	js	0x41f4c4 <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x174>
00000000000000d7: 02	je	0x41f499 <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x149>
00000000000000d9: 03	movl	%r15d, %ecx
00000000000000dc: 03	andl	$-2, %ecx
00000000000000df: 02	negl	%ecx
...
0000000000000147: 02	jne	0x41f440 <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0xf0>
0000000000000149: 04	testb	$1, %r15b
000000000000014d: 02	je	0x41f4c4 <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x174>
...
000000000000018e: 02	je	0x41f4e7 <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x197>
...
00000000000001b7: 02	je	0x41f56f <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x21f>
...
00000000000001e0: 02	jmp	0x41f549 <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x1f9>
...
00000000000001f7: 02	je	0x41f55a <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x20a>
00000000000001f9: 05	movq	8(%rbx,%r13), %rdi
00000000000001fe: 03	testq	%rdi, %rdi
0000000000000201: 02	je	0x41f540 <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x1f0>
0000000000000203: 05	callq	0x4257c0 <BloombergLP::bslma::SharedPtrRep::releaseRef()>
0000000000000208: 02	jmp	0x41f540 <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x1f0>
000000000000020a: 05	movq	8(%rsp), %rsi
000000000000020f: 03	subq	%rsi, %r12
0000000000000212: 02	je	0x41f56f <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x21f>
...
000000000000026e: 02	je	0x41f5c5 <BloombergLP::bdlbb::Blob::moveAndAppendDataBuffers(BloombergLP::bdlbb::Blob*)+0x275>
0000000000000270: 05	callq	0x4257c0 <BloombergLP::bslma::SharedPtrRep::releaseRef()>
