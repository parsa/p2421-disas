...
M0000000000000016:	jne	0x408e0c <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x2c>	;  2 bytes
M0000000000000018:	movq	2349985(%rip), %r14  # 6469a0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M000000000000001f:	testq	%r14, %r14	;  3 bytes
M0000000000000022:	jne	0x408e0c <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x2c>	;  2 bytes
...
M000000000000003d:	movq	$4231040, (%rax)	;  7 bytes
...
M000000000000006c:	movaps	158365(%rip), %xmm0  # 42f8f0 <__dso_handle+0x68>	;  7 bytes
M0000000000000073:	movups	%xmm0, 72(%rbx)	;  4 bytes
M0000000000000077:	movl	$4391799, %ecx	;  5 bytes
M000000000000007c:	xorl	%esi, %esi	;  2 bytes
M000000000000007e:	xorl	%edx, %edx	;  2 bytes
M0000000000000080:	callq	0x40c000 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M0000000000000085:	movq	%rsp, %rdi	;  3 bytes
M0000000000000088:	callq	0x409610 <BloombergLP::bslmt::ThreadAttributes::ThreadAttributes()>	;  5 bytes
M000000000000008d:	movq	%rsp, %rsi	;  3 bytes
M0000000000000090:	movl	$4232240, %edx	;  5 bytes
M0000000000000095:	movq	%r15, %rdi	;  3 bytes
M0000000000000098:	movq	%rbx, %rcx	;  3 bytes
M000000000000009b:	callq	0x409960 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>	;  5 bytes
M00000000000000a0:	movl	%eax, %ebp	;  2 bytes
M00000000000000a2:	cmpq	$23, 56(%rsp)	;  6 bytes
M00000000000000a8:	je	0x408e9a <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0xba>	;  2 bytes
...
M00000000000000bc:	je	0x408ec7 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0xe7>	;  2 bytes
M00000000000000be:	cmpq	$23, 80(%rbx)	;  5 bytes
M00000000000000c3:	je	0x408eb3 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0xd3>	;  2 bytes
...
M00000000000000f7:	callq	0x407cb0 <__clang_call_terminate>	;  5 bytes
...
M0000000000000115:	je	0x408f14 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x134>	;  2 bytes
...
M0000000000000127:	jmp	0x408f14 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x134>	;  2 bytes
M0000000000000129:	movq	%rax, %rdi	;  3 bytes
M000000000000012c:	callq	0x407cb0 <__clang_call_terminate>	;  5 bytes
M0000000000000131:	movq	%rax, %r15	;  3 bytes
M0000000000000134:	cmpq	$23, 80(%rbx)	;  5 bytes
M0000000000000139:	je	0x408f29 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x149>	;  2 bytes
...
M000000000000015d:	jmp	0x408f66 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x186>	;  2 bytes
M000000000000015f:	movq	%rax, %rdi	;  3 bytes
M0000000000000162:	callq	0x407cb0 <__clang_call_terminate>	;  5 bytes
...
M0000000000000189:	callq	0x404350 <_Unwind_Resume@plt>	;  5 bytes
M000000000000018e:	movq	%rax, %rdi	;  3 bytes
M0000000000000191:	callq	0x407cb0 <__clang_call_terminate>	;  5 bytes
