# `int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)` - Assumed

```nasm
0000000000408dc0 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)>:
...
M0000000000000024:	movq	$4230976, (%rax)	;  7 bytes
...
M0000000000000053:	movaps	158294(%rip), %xmm0  # 42f870 <__dso_handle+0x68>	;  7 bytes
M000000000000005a:	movups	%xmm0, 72(%rbx)	;  4 bytes
M000000000000005e:	movl	$4391675, %ecx	;  5 bytes
M0000000000000063:	xorl	%esi, %esi	;  2 bytes
M0000000000000065:	xorl	%edx, %edx	;  2 bytes
M0000000000000067:	callq	0x40bfa0 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M000000000000006c:	movq	%rsp, %rdi	;  3 bytes
M000000000000006f:	callq	0x4095d0 <BloombergLP::bslmt::ThreadAttributes::ThreadAttributes()>	;  5 bytes
M0000000000000074:	movq	%rsp, %rsi	;  3 bytes
M0000000000000077:	movl	$4232176, %edx	;  5 bytes
M000000000000007c:	movq	%r15, %rdi	;  3 bytes
M000000000000007f:	movq	%rbx, %rcx	;  3 bytes
M0000000000000082:	callq	0x409920 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>	;  5 bytes
M0000000000000087:	movl	%eax, %ebp	;  2 bytes
M0000000000000089:	cmpq	$23, 56(%rsp)	;  6 bytes
M000000000000008f:	je	0x408e61 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0xa1>	;  2 bytes
...
M00000000000000a3:	je	0x408e8e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0xce>	;  2 bytes
M00000000000000a5:	cmpq	$23, 80(%rbx)	;  5 bytes
M00000000000000aa:	je	0x408e7a <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0xba>	;  2 bytes
...
M00000000000000de:	callq	0x407cb0 <__clang_call_terminate>	;  5 bytes
...
M00000000000000fc:	je	0x408edb <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x11b>	;  2 bytes
...
M000000000000010e:	jmp	0x408edb <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x11b>	;  2 bytes
M0000000000000110:	movq	%rax, %rdi	;  3 bytes
M0000000000000113:	callq	0x407cb0 <__clang_call_terminate>	;  5 bytes
M0000000000000118:	movq	%rax, %r15	;  3 bytes
M000000000000011b:	cmpq	$23, 80(%rbx)	;  5 bytes
M0000000000000120:	je	0x408ef0 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x130>	;  2 bytes
...
M0000000000000144:	jmp	0x408f2d <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x16d>	;  2 bytes
M0000000000000146:	movq	%rax, %rdi	;  3 bytes
M0000000000000149:	callq	0x407cb0 <__clang_call_terminate>	;  5 bytes
...
M0000000000000170:	callq	0x404350 <_Unwind_Resume@plt>	;  5 bytes
M0000000000000175:	movq	%rax, %rdi	;  3 bytes
M0000000000000178:	callq	0x407cb0 <__clang_call_terminate>	;  5 bytes
