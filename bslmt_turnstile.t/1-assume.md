...
0000000000000024: 07	movq	$4230976, (%rax)
...
0000000000000053: 07	movaps	158294(%rip), %xmm0  # 42f870 <__dso_handle+0x68>
000000000000005a: 04	movups	%xmm0, 72(%rbx)
000000000000005e: 05	movl	$4391675, %ecx
0000000000000063: 02	xorl	%esi, %esi
0000000000000065: 02	xorl	%edx, %edx
0000000000000067: 05	callq	0x40bfa0 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>
000000000000006c: 03	movq	%rsp, %rdi
000000000000006f: 05	callq	0x4095d0 <BloombergLP::bslmt::ThreadAttributes::ThreadAttributes()>
0000000000000074: 03	movq	%rsp, %rsi
0000000000000077: 05	movl	$4232176, %edx
000000000000007c: 03	movq	%r15, %rdi
000000000000007f: 03	movq	%rbx, %rcx
0000000000000082: 05	callq	0x409920 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>
0000000000000087: 02	movl	%eax, %ebp
0000000000000089: 06	cmpq	$23, 56(%rsp)
000000000000008f: 02	je	0x408e61 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0xa1>
...
00000000000000a3: 02	je	0x408e8e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0xce>
00000000000000a5: 05	cmpq	$23, 80(%rbx)
00000000000000aa: 02	je	0x408e7a <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0xba>
...
00000000000000de: 05	callq	0x407cb0 <__clang_call_terminate>
...
00000000000000fc: 02	je	0x408edb <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x11b>
...
000000000000010e: 02	jmp	0x408edb <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x11b>
0000000000000110: 03	movq	%rax, %rdi
0000000000000113: 05	callq	0x407cb0 <__clang_call_terminate>
0000000000000118: 03	movq	%rax, %r15
000000000000011b: 05	cmpq	$23, 80(%rbx)
0000000000000120: 02	je	0x408ef0 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x130>
...
0000000000000144: 02	jmp	0x408f2d <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<WaitTurnCallbackJob>(unsigned long*, WaitTurnCallbackJob const&, BloombergLP::bslma::Allocator*)+0x16d>
0000000000000146: 03	movq	%rax, %rdi
0000000000000149: 05	callq	0x407cb0 <__clang_call_terminate>
...
0000000000000170: 05	callq	0x404350 <_Unwind_Resume@plt>
0000000000000175: 03	movq	%rax, %rdi
0000000000000178: 05	callq	0x407cb0 <__clang_call_terminate>
