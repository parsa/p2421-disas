...
000000000000001e: 02	je	0x437d66 <BloombergLP::bdlmt::ThreadPool::enqueueJob(bsl::function<void ()>&&)+0x86>
0000000000000020: 03	movq	%rbx, %rdi
0000000000000023: 03	movq	%r15, %rsi
0000000000000026: 05	callq	0x438190 <bsl::deque<bsl::function<void ()>, bsl::allocator<bsl::function<void ()> > >::push_back(bsl::function<void ()>&&)>
000000000000002b: 08	cmpq	$0, 256(%rbx)
0000000000000033: 02	je	0x437d5a <BloombergLP::bdlmt::ThreadPool::enqueueJob(bsl::function<void ()>&&)+0x7a>
...
0000000000000069: 02	je	0x437d5a <BloombergLP::bdlmt::ThreadPool::enqueueJob(bsl::function<void ()>&&)+0x7a>
...
0000000000000084: 02	jmp	0x437d6b <BloombergLP::bdlmt::ThreadPool::enqueueJob(bsl::function<void ()>&&)+0x8b>
