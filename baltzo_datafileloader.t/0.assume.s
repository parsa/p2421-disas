...
M0000000000000097:	callq	0x41e880 <BloombergLP::bslalg::RbTreeUtil::insertAt(BloombergLP::bslalg::RbTreeAnchor*, BloombergLP::bslalg::RbTreeNode*, bool, BloombergLP::bslalg::RbTreeNode*)>	;  5 bytes
...
M0000000000000191:	callq	0x410310 <bsl::vector<BloombergLP::baltzo::ZoneinfoTransition, bsl::allocator<BloombergLP::baltzo::ZoneinfoTransition> >::insert(BloombergLP::baltzo::ZoneinfoTransition const*, unsigned long, BloombergLP::baltzo::ZoneinfoTransition const&)>	;  5 bytes
...
M00000000000001a0:	callq	0x40edf0 <bsl::vector<BloombergLP::baltzo::ZoneinfoTransition, bsl::allocator<BloombergLP::baltzo::ZoneinfoTransition> >::push_back(BloombergLP::baltzo::ZoneinfoTransition const&)>	;  5 bytes
...
M000000000000022d:	callq	0x41e7e0 <BloombergLP::bslalg::RbTreeUtil::next(BloombergLP::bslalg::RbTreeNode const*)>	;  5 bytes
M0000000000000232:	movq	8(%rsp), %rdi	;  5 bytes
M0000000000000237:	movq	%r12, %rsi	;  3 bytes
M000000000000023a:	callq	0x41eb90 <BloombergLP::bslalg::RbTreeUtil::remove(BloombergLP::bslalg::RbTreeAnchor*, BloombergLP::bslalg::RbTreeNode*)>	;  5 bytes
...
M0000000000000286:	callq	0x406490 <_Unwind_Resume@plt>	;  5 bytes
M000000000000028b:	movq	%rax, %rdi	;  3 bytes
M000000000000028e:	callq	0x406490 <_Unwind_Resume@plt>	;  5 bytes
M0000000000000293:	movq	%rax, %rdi	;  3 bytes
M0000000000000296:	callq	0x406490 <_Unwind_Resume@plt>	;  5 bytes
