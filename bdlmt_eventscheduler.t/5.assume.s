...
M0000000000000024:	movq	$4362992, (%rax)	;  7 bytes
...
M0000000000000063:	movaps	229526(%rip), %xmm0  # 461260 <__dso_handle+0x1c8>	;  7 bytes
M000000000000006a:	movups	%xmm0, 64(%rbx)	;  4 bytes
M000000000000006e:	movl	$4606220, %ecx	;  5 bytes
M0000000000000073:	xorl	%esi, %esi	;  2 bytes
M0000000000000075:	xorl	%edx, %edx	;  2 bytes
M0000000000000077:	callq	0x43df40 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M000000000000007c:	movq	%rsp, %rdi	;  3 bytes
M000000000000007f:	callq	0x4397e0 <BloombergLP::bslmt::ThreadAttributes::ThreadAttributes()>	;  5 bytes
M0000000000000084:	movq	%rsp, %rsi	;  3 bytes
M0000000000000087:	movl	$4428624, %edx	;  5 bytes
M000000000000008c:	movq	%r15, %rdi	;  3 bytes
M000000000000008f:	movq	%rbx, %rcx	;  3 bytes
M0000000000000092:	callq	0x439cd0 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>	;  5 bytes
M0000000000000097:	movl	%eax, %ebp	;  2 bytes
M0000000000000099:	cmpq	$23, 56(%rsp)	;  6 bytes
M000000000000009f:	je	0x429211 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > >(unsigned long*, BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > const&, BloombergLP::bslma::Allocator*)+0xb1>	;  2 bytes
...
M00000000000000b3:	je	0x42923e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > >(unsigned long*, BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > const&, BloombergLP::bslma::Allocator*)+0xde>	;  2 bytes
M00000000000000b5:	cmpq	$23, 72(%rbx)	;  5 bytes
M00000000000000ba:	je	0x42922a <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > >(unsigned long*, BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > const&, BloombergLP::bslma::Allocator*)+0xca>	;  2 bytes
...
M00000000000000fe:	callq	0x424850 <__clang_call_terminate>	;  5 bytes
M0000000000000103:	movq	%rax, %r15	;  3 bytes
M0000000000000106:	cmpq	$23, 56(%rsp)	;  6 bytes
M000000000000010c:	je	0x42928b <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > >(unsigned long*, BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > const&, BloombergLP::bslma::Allocator*)+0x12b>	;  2 bytes
...
M000000000000011e:	jmp	0x42928b <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > >(unsigned long*, BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > const&, BloombergLP::bslma::Allocator*)+0x12b>	;  2 bytes
M0000000000000120:	movq	%rax, %rdi	;  3 bytes
M0000000000000123:	callq	0x424850 <__clang_call_terminate>	;  5 bytes
M0000000000000128:	movq	%rax, %r15	;  3 bytes
M000000000000012b:	cmpq	$23, 72(%rbx)	;  5 bytes
M0000000000000130:	je	0x4292a0 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > >(unsigned long*, BloombergLP::bdlf::Bind<BloombergLP::bslmf::Nil, void (*)(BloombergLP::bdlmt::EventScheduler*, int, int, int, int), BloombergLP::bdlf::Bind_BoundTuple5<BloombergLP::bdlmt::EventScheduler*, int, int, int, int> > const&, BloombergLP::bslma::Allocator*)+0x140>	;  2 bytes
...
M0000000000000161:	callq	0x424850 <__clang_call_terminate>	;  5 bytes
...
M0000000000000180:	callq	0x404730 <_Unwind_Resume@plt>	;  5 bytes
M0000000000000185:	movq	%rax, %rdi	;  3 bytes
M0000000000000188:	callq	0x424850 <__clang_call_terminate>	;  5 bytes
