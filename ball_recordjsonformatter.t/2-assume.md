# `BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)` - Assumed
...
0000000000000013: 06	je	0x41b40e <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xbe>
...
0000000000000034: 06	jae	0x41b410 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xc0>
...
0000000000000058: 02	jne	0x41b3f0 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xa0>
000000000000005a: 03	movq	(%rbx), %rax
000000000000005d: 06	cmpl	$1701667182, (%rax)
0000000000000063: 02	jne	0x41b3f0 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xa0>
0000000000000065: 03	movswl	%cx, %eax
0000000000000068: 03	cmpl	$14, %eax
000000000000006b: 02	je	0x41b3c2 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x72>
000000000000006d: 03	cmpl	$5, %eax
0000000000000070: 02	jne	0x41b3cc <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x7c>
0000000000000072: 04	movq	16(%rbx), %rsi
0000000000000076: 04	movslq	24(%rbx), %rdx
000000000000007a: 02	jmp	0x41b3d5 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x85>
...
00000000000000a3: 02	je	0x41b407 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xb7>
...
00000000000000b5: 02	jb	0x41b3a0 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x50>
00000000000000b7: 03	cmpq	%r12, %rbp
00000000000000ba: 02	sbbl	%eax, %eax
00000000000000bc: 02	jmp	0x41b410 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xc0>
