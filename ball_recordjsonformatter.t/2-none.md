...
0000000000000013: 06	je	0x41c4ae <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xce>
...
0000000000000034: 06	jae	0x41c4b0 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xd0>
...
0000000000000058: 02	jne	0x41c490 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xb0>
000000000000005a: 03	movq	(%rbx), %rax
000000000000005d: 06	cmpl	$1701667182, (%rax)
0000000000000063: 02	jne	0x41c490 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xb0>
0000000000000065: 03	movswl	%cx, %eax
0000000000000068: 03	cmpl	$14, %eax
000000000000006b: 02	je	0x41c46c <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x8c>
000000000000006d: 03	cmpl	$5, %eax
0000000000000070: 02	je	0x41c46c <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x8c>
0000000000000072: 05	movl	$0, %esi
0000000000000077: 05	movl	$0, %edx
000000000000007c: 03	cmpl	$4, %eax
000000000000007f: 02	jne	0x41c474 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x94>
0000000000000081: 04	leaq	17(%rbx), %rsi
0000000000000085: 05	movsbq	16(%rbx), %rdx
000000000000008a: 02	jmp	0x41c474 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x94>
...
00000000000000b3: 02	je	0x41c4a7 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xc7>
...
00000000000000c5: 02	jb	0x41c430 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x50>
00000000000000c7: 03	cmpq	%r12, %rbp
00000000000000ca: 02	sbbl	%eax, %eax
00000000000000cc: 02	jmp	0x41c4b0 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xd0>
