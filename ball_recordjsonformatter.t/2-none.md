# `BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)` - Ignored

```nasm
000000000041c3e0 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)>:
...
M0000000000000013:	je	0x41c4ae <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xce>	;  6 bytes
...
M0000000000000034:	jae	0x41c4b0 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xd0>	;  6 bytes
...
M0000000000000058:	jne	0x41c490 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xb0>	;  2 bytes
M000000000000005a:	movq	(%rbx), %rax	;  3 bytes
M000000000000005d:	cmpl	$1701667182, (%rax)	;  6 bytes
M0000000000000063:	jne	0x41c490 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xb0>	;  2 bytes
M0000000000000065:	movswl	%cx, %eax	;  3 bytes
M0000000000000068:	cmpl	$14, %eax	;  3 bytes
M000000000000006b:	je	0x41c46c <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x8c>	;  2 bytes
M000000000000006d:	cmpl	$5, %eax	;  3 bytes
M0000000000000070:	je	0x41c46c <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x8c>	;  2 bytes
M0000000000000072:	movl	$0, %esi	;  5 bytes
M0000000000000077:	movl	$0, %edx	;  5 bytes
M000000000000007c:	cmpl	$4, %eax	;  3 bytes
M000000000000007f:	jne	0x41c474 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x94>	;  2 bytes
M0000000000000081:	leaq	17(%rbx), %rsi	;  4 bytes
M0000000000000085:	movsbq	16(%rbx), %rdx	;  5 bytes
M000000000000008a:	jmp	0x41c474 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x94>	;  2 bytes
...
M00000000000000b3:	je	0x41c4a7 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xc7>	;  2 bytes
...
M00000000000000c5:	jb	0x41c430 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0x50>	;  2 bytes
M00000000000000c7:	cmpq	%r12, %rbp	;  3 bytes
M00000000000000ca:	sbbl	%eax, %eax	;  2 bytes
M00000000000000cc:	jmp	0x41c4b0 <BloombergLP::ball::(anonymous namespace)::AttributeFormatter::parse(BloombergLP::bdld::DatumMapRef)+0xd0>	;  2 bytes
