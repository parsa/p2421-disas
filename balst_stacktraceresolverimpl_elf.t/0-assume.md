...
M000000000000002d:	movq	$-1, %rcx	;  7 bytes
M0000000000000034:	xorl	%edx, %edx	;  2 bytes
M0000000000000036:	xorl	%eax, %eax	;  2 bytes
M0000000000000038:	xorl	%ebx, %ebx	;  2 bytes
M000000000000003a:	nopw	(%rax,%rax)	;  6 bytes
M0000000000000040:	movq	56(%r14), %rsi	;  4 bytes
M0000000000000044:	movq	%rcx, (%rsi,%rbx)	;  4 bytes
M0000000000000048:	movq	56(%r14), %rsi	;  4 bytes
M000000000000004c:	movq	%rdx, 216(%rsi,%rbx)	;  8 bytes
M0000000000000054:	movq	56(%r14), %rsi	;  4 bytes
M0000000000000058:	leaq	1(%rdx), %rdi	;  4 bytes
M000000000000005c:	movq	%rdi, 432(%rsi,%rbx)	;  8 bytes
M0000000000000064:	addq	%r12, %rcx	;  3 bytes
M0000000000000067:	addq	$648, %rbx	;  7 bytes
M000000000000006e:	addl	$-3, %eax	;  3 bytes
M0000000000000071:	addq	%r15, %rdx	;  3 bytes
M0000000000000074:	cmpl	$4294966528, %eax	;  5 bytes
M0000000000000079:	jne	0x404dd0 <stuffRandomAddresses(BloombergLP::balst::StackTrace*)+0x40>	;  2 bytes
M000000000000007b:	movl	$256, %ecx	;  5 bytes
...
M0000000000000090:	movq	56(%r14), %rdi	;  4 bytes
M0000000000000094:	movq	%rsi, (%rdi,%rbx)	;  4 bytes
M0000000000000098:	movq	56(%r14), %rdi	;  4 bytes
M000000000000009c:	leaq	-1(%rdx), %rbp	;  4 bytes
M00000000000000a0:	movq	%rbp, 216(%rdi,%rbx)	;  8 bytes
M00000000000000a8:	movq	56(%r14), %rdi	;  4 bytes
M00000000000000ac:	movq	%rdx, 432(%rdi,%rbx)	;  8 bytes
M00000000000000b4:	addq	%r12, %rsi	;  3 bytes
M00000000000000b7:	addq	$648, %rbx	;  7 bytes
M00000000000000be:	addl	$-3, %eax	;  3 bytes
M00000000000000c1:	addq	%r15, %rdx	;  3 bytes
M00000000000000c4:	decl	%ecx	;  2 bytes
M00000000000000c6:	jne	0x404e20 <stuffRandomAddresses(BloombergLP::balst::StackTrace*)+0x90>	;  2 bytes
M00000000000000c8:	movl	$4294967293, %ebp	;  5 bytes
M00000000000000cd:	subl	%eax, %ebp	;  2 bytes
M00000000000000cf:	movl	$1, %eax	;  5 bytes
M00000000000000d4:	movl	$256, %ecx	;  5 bytes
M00000000000000d9:	movq	$-1, %rdx	;  7 bytes
...
M0000000000000124:	movl	$4442512, %esi	;  5 bytes
...
M0000000000000139:	jae	0x404f4b <stuffRandomAddresses(BloombergLP::balst::StackTrace*)+0x1bb>	;  6 bytes
