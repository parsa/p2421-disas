# `int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)` - Assumed

```nasm
0000000000451670 <int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)>:
...
M0000000000000049:	je	0x451736 <int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)+0xc6>	;  2 bytes
...
M0000000000000069:	ja	0x451748 <int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)+0xd8>	;  2 bytes
M000000000000006b:	movb	$1, %cl	;  2 bytes
M000000000000006d:	jmpq	*4800880(,%rdi,8)	;  7 bytes
M0000000000000074:	movb	$7, %cl	;  2 bytes
M0000000000000076:	jmp	0x451700 <int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)+0x90>	;  2 bytes
M0000000000000078:	movb	$6, %cl	;  2 bytes
M000000000000007a:	jmp	0x451700 <int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)+0x90>	;  2 bytes
M000000000000007c:	movb	$2, %cl	;  2 bytes
M000000000000007e:	jmp	0x451700 <int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)+0x90>	;  2 bytes
M0000000000000080:	movb	$5, %cl	;  2 bytes
M0000000000000082:	jmp	0x451700 <int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)+0x90>	;  2 bytes
M0000000000000084:	movb	$3, %cl	;  2 bytes
M0000000000000086:	jmp	0x451700 <int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)+0x90>	;  2 bytes
...
M00000000000000ae:	jae	0x451748 <int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)+0xd8>	;  2 bytes
...
M00000000000000c4:	jne	0x4516d0 <int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)+0x60>	;  2 bytes
...
M00000000000000f1:	jmp	0x451736 <int loadWeekendDaysTransition<BloombergLP::bdlt::PackedCalendar>(char const**, BloombergLP::bdlt::PackedCalendar*, BloombergLP::bdlt::Date const&)+0xc6>	;  2 bytes
M00000000000000f3:	movq	%rax, %rdi	;  3 bytes
M00000000000000f6:	callq	0x403e70 <_Unwind_Resume@plt>	;  5 bytes
