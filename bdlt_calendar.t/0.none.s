...
M0000000000000049:	je	0x451406 <int loadWeekendDaysTransition<BloombergLP::bdlt::Calendar>(char const**, BloombergLP::bdlt::Calendar*, BloombergLP::bdlt::Date const&)+0xc6>	;  2 bytes
...
M0000000000000069:	ja	0x451420 <int loadWeekendDaysTransition<BloombergLP::bdlt::Calendar>(char const**, BloombergLP::bdlt::Calendar*, BloombergLP::bdlt::Date const&)+0xe0>	;  2 bytes
M000000000000006b:	movb	$1, %cl	;  2 bytes
M000000000000006d:	jmpq	*4802192(,%rdi,8)	;  7 bytes
M0000000000000074:	movb	$7, %cl	;  2 bytes
M0000000000000076:	jmp	0x4513d0 <int loadWeekendDaysTransition<BloombergLP::bdlt::Calendar>(char const**, BloombergLP::bdlt::Calendar*, BloombergLP::bdlt::Date const&)+0x90>	;  2 bytes
M0000000000000078:	movb	$6, %cl	;  2 bytes
M000000000000007a:	jmp	0x4513d0 <int loadWeekendDaysTransition<BloombergLP::bdlt::Calendar>(char const**, BloombergLP::bdlt::Calendar*, BloombergLP::bdlt::Date const&)+0x90>	;  2 bytes
M000000000000007c:	movb	$2, %cl	;  2 bytes
M000000000000007e:	jmp	0x4513d0 <int loadWeekendDaysTransition<BloombergLP::bdlt::Calendar>(char const**, BloombergLP::bdlt::Calendar*, BloombergLP::bdlt::Date const&)+0x90>	;  2 bytes
M0000000000000080:	movb	$5, %cl	;  2 bytes
M0000000000000082:	jmp	0x4513d0 <int loadWeekendDaysTransition<BloombergLP::bdlt::Calendar>(char const**, BloombergLP::bdlt::Calendar*, BloombergLP::bdlt::Date const&)+0x90>	;  2 bytes
M0000000000000084:	movb	$3, %cl	;  2 bytes
M0000000000000086:	jmp	0x4513d0 <int loadWeekendDaysTransition<BloombergLP::bdlt::Calendar>(char const**, BloombergLP::bdlt::Calendar*, BloombergLP::bdlt::Date const&)+0x90>	;  2 bytes
...
M00000000000000ae:	jae	0x451420 <int loadWeekendDaysTransition<BloombergLP::bdlt::Calendar>(char const**, BloombergLP::bdlt::Calendar*, BloombergLP::bdlt::Date const&)+0xe0>	;  2 bytes
...
M00000000000000c4:	jne	0x4513a0 <int loadWeekendDaysTransition<BloombergLP::bdlt::Calendar>(char const**, BloombergLP::bdlt::Calendar*, BloombergLP::bdlt::Date const&)+0x60>	;  2 bytes
...
M00000000000000d9:	callq	0x4517d0 <BloombergLP::bdlt::Calendar::synchronizeCache()>	;  5 bytes
...
M00000000000000f9:	jmp	0x451406 <int loadWeekendDaysTransition<BloombergLP::bdlt::Calendar>(char const**, BloombergLP::bdlt::Calendar*, BloombergLP::bdlt::Date const&)+0xc6>	;  2 bytes
