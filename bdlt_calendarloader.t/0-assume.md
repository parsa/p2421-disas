...
0000000000000017: 05	callq	0x410ce0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
000000000000001c: 05	movl	$1990, %edi
0000000000000021: 05	movl	$1, %esi
0000000000000026: 05	movl	$1, %edx
000000000000002b: 05	callq	0x408be0 <BloombergLP::bdlt::PosixDateImpUtil::ymdToSerial(int, int, int)>
...
0000000000000045: 05	callq	0x408be0 <BloombergLP::bdlt::PosixDateImpUtil::ymdToSerial(int, int, int)>
...
000000000000005e: 05	callq	0x405d30 <BloombergLP::bdlt::PackedCalendar::removeAll()>
0000000000000063: 05	leaq	24(%rsp), %rsi
0000000000000068: 05	leaq	16(%rsp), %rdx
000000000000006d: 03	movq	%r14, %rdi
0000000000000070: 05	callq	0x406120 <BloombergLP::bdlt::PackedCalendar::setValidRange(BloombergLP::bdlt::Date const&, BloombergLP::bdlt::Date const&)>
0000000000000075: 05	movb	$-126, 32(%rsp)
000000000000007a: 05	leaq	32(%rsp), %rsi
000000000000007f: 03	movq	%r14, %rdi
0000000000000082: 05	callq	0x405480 <BloombergLP::bdlt::PackedCalendar::addWeekendDays(BloombergLP::bdlt::DayOfWeekSet const&)>
...
00000000000000a4: 05	callq	0x410ce0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
00000000000000bd: 05	callq	0x408be0 <BloombergLP::bdlt::PosixDateImpUtil::ymdToSerial(int, int, int)>
00000000000000c2: 04	movl	%eax, 8(%rsp)
00000000000000c6: 05	leaq	32(%rsp), %rdi
00000000000000cb: 05	leaq	8(%rsp), %rsi
00000000000000d0: 05	callq	0x403270 <bsl::vector<BloombergLP::bdlt::Date, bsl::allocator<BloombergLP::bdlt::Date> >::push_back(BloombergLP::bdlt::Date&&)>
00000000000000d5: 05	movl	$1990, %edi
00000000000000da: 05	movl	$7, %esi
00000000000000df: 05	movl	$4, %edx
00000000000000e4: 05	callq	0x408be0 <BloombergLP::bdlt::PosixDateImpUtil::ymdToSerial(int, int, int)>
00000000000000e9: 04	movl	%eax, 8(%rsp)
00000000000000ed: 05	leaq	32(%rsp), %rdi
00000000000000f2: 05	leaq	8(%rsp), %rsi
00000000000000f7: 05	callq	0x403270 <bsl::vector<BloombergLP::bdlt::Date, bsl::allocator<BloombergLP::bdlt::Date> >::push_back(BloombergLP::bdlt::Date&&)>
00000000000000fc: 05	movl	$1990, %edi
0000000000000101: 05	movl	$9, %esi
0000000000000106: 05	movl	$3, %edx
000000000000010b: 05	callq	0x408be0 <BloombergLP::bdlt::PosixDateImpUtil::ymdToSerial(int, int, int)>
0000000000000110: 04	movl	%eax, 8(%rsp)
0000000000000114: 05	leaq	32(%rsp), %rdi
0000000000000119: 05	leaq	8(%rsp), %rsi
000000000000011e: 05	callq	0x403270 <bsl::vector<BloombergLP::bdlt::Date, bsl::allocator<BloombergLP::bdlt::Date> >::push_back(BloombergLP::bdlt::Date&&)>
...
0000000000000154: 05	callq	0x4051f0 <BloombergLP::bdlt::PackedCalendar::addHoliday(BloombergLP::bdlt::Date const&)>
...
0000000000000195: 05	callq	0x403380 <__clang_call_terminate>
000000000000019a: 03	movq	%rax, %rdi
000000000000019d: 05	callq	0x403380 <__clang_call_terminate>
00000000000001a2: 03	movq	%rax, %rdi
00000000000001a5: 05	callq	0x403380 <__clang_call_terminate>
00000000000001aa: 02	jmp	0x40285b <MyCalendarLoader::load(BloombergLP::bdlt::PackedCalendar*, char const*)+0x1bb>
00000000000001ac: 02	jmp	0x40285b <MyCalendarLoader::load(BloombergLP::bdlt::PackedCalendar*, char const*)+0x1bb>
00000000000001ae: 02	jmp	0x40285b <MyCalendarLoader::load(BloombergLP::bdlt::PackedCalendar*, char const*)+0x1bb>
00000000000001b0: 02	jmp	0x40285b <MyCalendarLoader::load(BloombergLP::bdlt::PackedCalendar*, char const*)+0x1bb>
00000000000001b2: 02	jmp	0x40285b <MyCalendarLoader::load(BloombergLP::bdlt::PackedCalendar*, char const*)+0x1bb>
00000000000001b4: 02	jmp	0x40285b <MyCalendarLoader::load(BloombergLP::bdlt::PackedCalendar*, char const*)+0x1bb>
00000000000001b6: 03	movq	%rax, %rbx
00000000000001b9: 02	jmp	0x402873 <MyCalendarLoader::load(BloombergLP::bdlt::PackedCalendar*, char const*)+0x1d3>
00000000000001bb: 03	movq	%rax, %rbx
00000000000001be: 05	movq	32(%rsp), %rsi
00000000000001c3: 03	testq	%rsi, %rsi
00000000000001c6: 02	je	0x402873 <MyCalendarLoader::load(BloombergLP::bdlt::PackedCalendar*, char const*)+0x1d3>
00000000000001c8: 05	movq	56(%rsp), %rdi
00000000000001cd: 03	movq	(%rdi), %rax
00000000000001d0: 03	callq	*24(%rax)
00000000000001d3: 03	movq	%rbx, %rdi
00000000000001d6: 05	callq	0x402550 <_Unwind_Resume@plt>
00000000000001db: 03	movq	%rax, %rdi
00000000000001de: 05	callq	0x403380 <__clang_call_terminate>
