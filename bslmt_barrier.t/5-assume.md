...
0000000000000021: 02	je	0x408849 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case7_Driver>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case7_Driver const&, BloombergLP::bslma::Allocator*)+0x29>
0000000000000023: 04	movq	24(%r15), %rbp
0000000000000027: 02	jmp	0x40884d <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case7_Driver>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case7_Driver const&, BloombergLP::bslma::Allocator*)+0x2d>
...
000000000000003e: 07	movq	$4229488, (%rax)
...
0000000000000067: 07	movaps	158850(%rip), %xmm0  # 42f510 <__dso_handle+0x58>
000000000000006e: 04	movups	%xmm0, 56(%rbx)
0000000000000072: 05	movl	$4390179, %ecx
0000000000000077: 03	movq	%rbp, %rsi
000000000000007a: 03	movq	%r13, %rdx
000000000000007d: 05	callq	0x40bef0 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>
0000000000000082: 05	movl	$4231824, %edx
0000000000000087: 04	movq	(%rsp), %rdi
000000000000008b: 03	movq	%r15, %rsi
000000000000008e: 03	movq	%rbx, %rcx
0000000000000091: 05	callq	0x409ad0 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>
0000000000000096: 02	movl	%eax, %ebp
0000000000000098: 02	testl	%eax, %eax
000000000000009a: 02	je	0x4088e5 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case7_Driver>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case7_Driver const&, BloombergLP::bslma::Allocator*)+0xc5>
000000000000009c: 05	cmpq	$23, 64(%rbx)
00000000000000a1: 02	je	0x4088d1 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case7_Driver>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case7_Driver const&, BloombergLP::bslma::Allocator*)+0xb1>
...
00000000000000d9: 05	callq	0x408200 <__clang_call_terminate>
00000000000000de: 03	movq	%rax, %rdi
00000000000000e1: 05	callq	0x408200 <__clang_call_terminate>
00000000000000e6: 03	movq	%rax, %r15
00000000000000e9: 05	cmpq	$23, 64(%rbx)
00000000000000ee: 02	je	0x40891e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case7_Driver>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case7_Driver const&, BloombergLP::bslma::Allocator*)+0xfe>
...
0000000000000112: 02	jmp	0x40895b <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case7_Driver>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case7_Driver const&, BloombergLP::bslma::Allocator*)+0x13b>
0000000000000114: 03	movq	%rax, %rdi
0000000000000117: 05	callq	0x408200 <__clang_call_terminate>
000000000000011c: 03	movq	%rax, %rdi
000000000000011f: 05	callq	0x408200 <__clang_call_terminate>
...
000000000000013e: 05	callq	0x403870 <_Unwind_Resume@plt>
0000000000000143: 03	movq	%rax, %rdi
0000000000000146: 05	callq	0x408200 <__clang_call_terminate>
