...
000000000000001d: 02	je	0x408275 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case6_Waiter>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case6_Waiter const&, BloombergLP::bslma::Allocator*)+0x25>
000000000000001f: 04	movq	24(%r15), %r13
0000000000000023: 02	jmp	0x408279 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case6_Waiter>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case6_Waiter const&, BloombergLP::bslma::Allocator*)+0x29>
0000000000000025: 04	leaq	24(%r15), %r13
0000000000000029: 04	movq	48(%r15), %rbp
000000000000002d: 03	testq	%r14, %r14
0000000000000030: 02	jne	0x408296 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case6_Waiter>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case6_Waiter const&, BloombergLP::bslma::Allocator*)+0x46>
0000000000000032: 07	movq	2352543(%rip), %r14  # 646828 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000039: 03	testq	%r14, %r14
000000000000003c: 02	jne	0x408296 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case6_Waiter>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case6_Waiter const&, BloombergLP::bslma::Allocator*)+0x46>
000000000000003e: 05	callq	0x42ef70 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
0000000000000057: 07	movq	$4228032, (%rax)
...
0000000000000080: 07	movaps	160665(%rip), %xmm0  # 42f670 <__dso_handle+0x58>
0000000000000087: 04	movups	%xmm0, 56(%rbx)
000000000000008b: 05	movl	$4390527, %ecx
0000000000000090: 03	movq	%r13, %rsi
0000000000000093: 03	movq	%rbp, %rdx
0000000000000096: 05	callq	0x40c030 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>
000000000000009b: 05	movl	$4232112, %edx
00000000000000a0: 04	movq	(%rsp), %rdi
00000000000000a4: 03	movq	%r15, %rsi
00000000000000a7: 03	movq	%rbx, %rcx
00000000000000aa: 05	callq	0x409bf0 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>
00000000000000af: 02	movl	%eax, %ebp
00000000000000b1: 02	testl	%eax, %eax
00000000000000b3: 02	je	0x40832e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case6_Waiter>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case6_Waiter const&, BloombergLP::bslma::Allocator*)+0xde>
00000000000000b5: 05	cmpq	$23, 64(%rbx)
00000000000000ba: 02	je	0x40831a <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case6_Waiter>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case6_Waiter const&, BloombergLP::bslma::Allocator*)+0xca>
...
00000000000000f2: 05	callq	0x408240 <__clang_call_terminate>
00000000000000f7: 03	movq	%rax, %rdi
00000000000000fa: 05	callq	0x408240 <__clang_call_terminate>
00000000000000ff: 03	movq	%rax, %rbp
0000000000000102: 05	cmpq	$23, 64(%rbx)
0000000000000107: 02	je	0x408367 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case6_Waiter>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case6_Waiter const&, BloombergLP::bslma::Allocator*)+0x117>
...
000000000000012b: 02	jmp	0x4083a4 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<Case6_Waiter>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, Case6_Waiter const&, BloombergLP::bslma::Allocator*)+0x154>
000000000000012d: 03	movq	%rax, %rdi
0000000000000130: 05	callq	0x408240 <__clang_call_terminate>
0000000000000135: 03	movq	%rax, %rdi
0000000000000138: 05	callq	0x408240 <__clang_call_terminate>
...
0000000000000157: 05	callq	0x403870 <_Unwind_Resume@plt>
000000000000015c: 03	movq	%rax, %rdi
000000000000015f: 05	callq	0x408240 <__clang_call_terminate>
