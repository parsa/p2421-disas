...
0000000000000011: 03	cmpl	$17, %eax
0000000000000014: 06	je	0x46a253 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x103>
000000000000001a: 03	cmpl	$9, %eax
000000000000001d: 06	jne	0x46a32a <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>
...
0000000000000040: 07	movq	$4919576, (%rbx)
0000000000000047: 03	testq	%rax, %rax
000000000000004a: 02	jne	0x46a1ad <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x5d>
000000000000004c: 07	movq	2734725(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000053: 03	testq	%rax, %rax
0000000000000056: 02	jne	0x46a1ad <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x5d>
...
0000000000000082: 02	jne	0x46a1e8 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x98>
0000000000000084: 07	movq	2734669(%rip), %r12  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
000000000000008b: 03	testq	%r12, %r12
000000000000008e: 02	jne	0x46a1e8 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x98>
...
00000000000000b8: 07	movq	$4931048, (%rbx)
00000000000000bf: 03	testq	%r15, %r15
00000000000000c2: 02	jne	0x46a228 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0xd8>
00000000000000c4: 07	movq	2734605(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000000cb: 03	testq	%rax, %rax
00000000000000ce: 02	jne	0x46a225 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0xd5>
...
00000000000000f3: 06	je	0x46a32a <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>
00000000000000f9: 05	callq	0x47d740 <BloombergLP::bslma::SharedPtrRep::releaseRef()>
00000000000000fe: 05	jmp	0x46a32a <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>
...
0000000000000120: 07	movq	$4921472, (%rbx)
0000000000000127: 03	testq	%rax, %rax
000000000000012a: 02	jne	0x46a28d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x13d>
000000000000012c: 07	movq	2734501(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000133: 03	testq	%rax, %rax
0000000000000136: 02	jne	0x46a28d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x13d>
...
0000000000000162: 02	jne	0x46a2c8 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x178>
0000000000000164: 07	movq	2734445(%rip), %r12  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
000000000000016b: 03	testq	%r12, %r12
000000000000016e: 02	jne	0x46a2c8 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x178>
...
0000000000000198: 07	movq	$4931344, (%rbx)
000000000000019f: 03	testq	%r15, %r15
00000000000001a2: 02	jne	0x46a308 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1b8>
00000000000001a4: 07	movq	2734381(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000001ab: 03	testq	%rax, %rax
00000000000001ae: 02	jne	0x46a305 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1b5>
...
00000000000001d3: 02	je	0x46a32a <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>
...
00000000000001f4: 05	jmp	0x46a3cf <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x27f>
...
0000000000000204: 02	jmp	0x46a393 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x243>
...
0000000000000216: 05	jmp	0x46a3f7 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2a7>
...
0000000000000226: 02	jmp	0x46a3b5 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x265>
...
0000000000000250: 02	jmp	0x46a412 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2c2>
...
0000000000000272: 02	jmp	0x46a412 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2c2>
...
000000000000029a: 02	jmp	0x46a412 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Time const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2c2>
