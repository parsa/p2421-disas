...
0000000000000011: 03	cmpl	$15, %eax
0000000000000014: 06	je	0x469ad3 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x103>
000000000000001a: 03	cmpl	$7, %eax
000000000000001d: 06	jne	0x469baa <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>
...
0000000000000040: 07	movq	$4919088, (%rbx)
0000000000000047: 03	testq	%rax, %rax
000000000000004a: 02	jne	0x469a2d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x5d>
000000000000004c: 07	movq	2736645(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000053: 03	testq	%rax, %rax
0000000000000056: 02	jne	0x469a2d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x5d>
...
0000000000000082: 02	jne	0x469a68 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x98>
0000000000000084: 07	movq	2736589(%rip), %r12  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
000000000000008b: 03	testq	%r12, %r12
000000000000008e: 02	jne	0x469a68 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x98>
...
00000000000000b8: 07	movq	$4929864, (%rbx)
00000000000000bf: 03	testq	%r15, %r15
00000000000000c2: 02	jne	0x469aa8 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0xd8>
00000000000000c4: 07	movq	2736525(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000000cb: 03	testq	%rax, %rax
00000000000000ce: 02	jne	0x469aa5 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0xd5>
...
00000000000000f3: 06	je	0x469baa <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>
00000000000000f9: 05	callq	0x47d740 <BloombergLP::bslma::SharedPtrRep::releaseRef()>
00000000000000fe: 05	jmp	0x469baa <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>
...
0000000000000120: 07	movq	$4920984, (%rbx)
0000000000000127: 03	testq	%rax, %rax
000000000000012a: 02	jne	0x469b0d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x13d>
000000000000012c: 07	movq	2736421(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000133: 03	testq	%rax, %rax
0000000000000136: 02	jne	0x469b0d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x13d>
...
0000000000000162: 02	jne	0x469b48 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x178>
0000000000000164: 07	movq	2736365(%rip), %r12  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
000000000000016b: 03	testq	%r12, %r12
000000000000016e: 02	jne	0x469b48 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x178>
...
0000000000000198: 07	movq	$4930160, (%rbx)
000000000000019f: 03	testq	%r15, %r15
00000000000001a2: 02	jne	0x469b88 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1b8>
00000000000001a4: 07	movq	2736301(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000001ab: 03	testq	%rax, %rax
00000000000001ae: 02	jne	0x469b85 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1b5>
...
00000000000001d3: 02	je	0x469baa <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>
...
00000000000001f4: 05	jmp	0x469c4f <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x27f>
...
0000000000000204: 02	jmp	0x469c13 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x243>
...
0000000000000216: 05	jmp	0x469c77 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2a7>
...
0000000000000226: 02	jmp	0x469c35 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x265>
...
0000000000000250: 02	jmp	0x469c92 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2c2>
...
0000000000000272: 02	jmp	0x469c92 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2c2>
...
000000000000029a: 02	jmp	0x469c92 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2c2>
