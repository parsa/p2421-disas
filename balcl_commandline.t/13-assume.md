...
000000000000000f: 03	cmpl	$7, (%rdi)
0000000000000012: 06	jne	0x46a098 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0xf8>
...
0000000000000035: 07	movq	$4918032, (%rbx)
000000000000003c: 03	testq	%rax, %rax
000000000000003f: 02	jne	0x469ff2 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x52>
0000000000000041: 07	movq	2731072(%rip), %rax  # 704c28 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000048: 03	testq	%rax, %rax
000000000000004b: 02	jne	0x469ff2 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x52>
...
0000000000000077: 02	jne	0x46a02d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x8d>
0000000000000079: 07	movq	2731016(%rip), %r12  # 704c28 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000080: 03	testq	%r12, %r12
0000000000000083: 02	jne	0x46a02d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x8d>
...
00000000000000ad: 07	movq	$4928808, (%rbx)
00000000000000b4: 03	testq	%r15, %r15
00000000000000b7: 02	jne	0x46a06d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0xcd>
00000000000000b9: 07	movq	2730952(%rip), %rax  # 704c28 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000000c0: 03	testq	%rax, %rax
00000000000000c3: 02	jne	0x46a06a <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0xca>
...
00000000000000e8: 06	je	0x46a16f <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1cf>
00000000000000ee: 05	callq	0x47d3f0 <BloombergLP::bslma::SharedPtrRep::releaseRef()>
00000000000000f3: 05	jmp	0x46a16f <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1cf>
...
0000000000000115: 07	movq	$4919928, (%rbx)
000000000000011c: 03	testq	%rax, %rax
000000000000011f: 02	jne	0x46a0d2 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x132>
0000000000000121: 07	movq	2730848(%rip), %rax  # 704c28 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000128: 03	testq	%rax, %rax
000000000000012b: 02	jne	0x46a0d2 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x132>
...
0000000000000157: 02	jne	0x46a10d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x16d>
0000000000000159: 07	movq	2730792(%rip), %r12  # 704c28 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000160: 03	testq	%r12, %r12
0000000000000163: 02	jne	0x46a10d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x16d>
...
000000000000018d: 07	movq	$4929104, (%rbx)
0000000000000194: 03	testq	%r15, %r15
0000000000000197: 02	jne	0x46a14d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1ad>
0000000000000199: 07	movq	2730728(%rip), %rax  # 704c28 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000001a0: 03	testq	%rax, %rax
00000000000001a3: 02	jne	0x46a14a <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1aa>
...
00000000000001c8: 02	je	0x46a16f <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1cf>
...
00000000000001e9: 05	jmp	0x46a214 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x274>
...
00000000000001f9: 02	jmp	0x46a1d8 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x238>
...
000000000000020b: 05	jmp	0x46a23c <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x29c>
...
000000000000021b: 02	jmp	0x46a1fa <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x25a>
...
0000000000000245: 02	jmp	0x46a257 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2b7>
...
0000000000000267: 02	jmp	0x46a257 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2b7>
...
000000000000028f: 02	jmp	0x46a257 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (BloombergLP::bdlt::Datetime const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2b7>
