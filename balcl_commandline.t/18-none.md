# `BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)` - Ignored

```nasm
0000000000468ad0 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)>:
...
M0000000000000011:	cmpl	$11, %eax	;  3 bytes
M0000000000000014:	je	0x468bd3 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x103>	;  6 bytes
M000000000000001a:	cmpl	$3, %eax	;  3 bytes
M000000000000001d:	jne	0x468caa <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>	;  6 bytes
...
M0000000000000040:	movq	$4918144, (%rbx)	;  7 bytes
M0000000000000047:	testq	%rax, %rax	;  3 bytes
M000000000000004a:	jne	0x468b2d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x5d>	;  2 bytes
M000000000000004c:	movq	2740485(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000053:	testq	%rax, %rax	;  3 bytes
M0000000000000056:	jne	0x468b2d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x5d>	;  2 bytes
...
M0000000000000082:	jne	0x468b68 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x98>	;  2 bytes
M0000000000000084:	movq	2740429(%rip), %r12  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M000000000000008b:	testq	%r12, %r12	;  3 bytes
M000000000000008e:	jne	0x468b68 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x98>	;  2 bytes
...
M00000000000000b8:	movq	$4927544, (%rbx)	;  7 bytes
M00000000000000bf:	testq	%r15, %r15	;  3 bytes
M00000000000000c2:	jne	0x468ba8 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0xd8>	;  2 bytes
M00000000000000c4:	movq	2740365(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M00000000000000cb:	testq	%rax, %rax	;  3 bytes
M00000000000000ce:	jne	0x468ba5 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0xd5>	;  2 bytes
...
M00000000000000f3:	je	0x468caa <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>	;  6 bytes
M00000000000000f9:	callq	0x47d740 <BloombergLP::bslma::SharedPtrRep::releaseRef()>	;  5 bytes
M00000000000000fe:	jmp	0x468caa <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>	;  5 bytes
...
M0000000000000120:	movq	$4920040, (%rbx)	;  7 bytes
M0000000000000127:	testq	%rax, %rax	;  3 bytes
M000000000000012a:	jne	0x468c0d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x13d>	;  2 bytes
M000000000000012c:	movq	2740261(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000133:	testq	%rax, %rax	;  3 bytes
M0000000000000136:	jne	0x468c0d <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x13d>	;  2 bytes
...
M0000000000000162:	jne	0x468c48 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x178>	;  2 bytes
M0000000000000164:	movq	2740205(%rip), %r12  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M000000000000016b:	testq	%r12, %r12	;  3 bytes
M000000000000016e:	jne	0x468c48 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x178>	;  2 bytes
...
M0000000000000198:	movq	$4927824, (%rbx)	;  7 bytes
M000000000000019f:	testq	%r15, %r15	;  3 bytes
M00000000000001a2:	jne	0x468c88 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1b8>	;  2 bytes
M00000000000001a4:	movq	2740141(%rip), %rax  # 705c28 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M00000000000001ab:	testq	%rax, %rax	;  3 bytes
M00000000000001ae:	jne	0x468c85 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1b5>	;  2 bytes
...
M00000000000001d3:	je	0x468caa <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x1da>	;  2 bytes
...
M00000000000001f4:	jmp	0x468d4f <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x27f>	;  5 bytes
...
M0000000000000204:	jmp	0x468d13 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x243>	;  2 bytes
...
M0000000000000216:	jmp	0x468d77 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2a7>	;  5 bytes
...
M0000000000000226:	jmp	0x468d35 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x265>	;  2 bytes
...
M0000000000000250:	jmp	0x468d92 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2c2>	;  2 bytes
...
M0000000000000272:	jmp	0x468d92 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2c2>	;  2 bytes
...
M000000000000029a:	jmp	0x468d92 <BloombergLP::balcl::TypeInfo::setConstraint(bsl::function<bool (int const*, std::__1::basic_ostream<char, std::__1::char_traits<char> >&)> const&)+0x2c2>	;  2 bytes
