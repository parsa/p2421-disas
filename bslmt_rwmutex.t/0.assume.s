...
M0000000000000024:	movq	$4227792, (%rax)	;  7 bytes
...
M000000000000004b:	movaps	174606(%rip), %xmm0  # 432bb0 <__dso_handle+0x18>	;  7 bytes
M0000000000000052:	movups	%xmm0, 56(%rbx)	;  4 bytes
M0000000000000056:	movl	$4403401, %ecx	;  5 bytes
M000000000000005b:	xorl	%esi, %esi	;  2 bytes
M000000000000005d:	xorl	%edx, %edx	;  2 bytes
M000000000000005f:	callq	0x40f220 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M0000000000000064:	movq	%rsp, %rdi	;  3 bytes
M0000000000000067:	callq	0x40ccc0 <BloombergLP::bslmt::ThreadAttributes::ThreadAttributes()>	;  5 bytes
M000000000000006c:	movq	%rsp, %rsi	;  3 bytes
M000000000000006f:	movl	$4243936, %edx	;  5 bytes
M0000000000000074:	movq	%r15, %rdi	;  3 bytes
M0000000000000077:	movq	%rbx, %rcx	;  3 bytes
M000000000000007a:	callq	0x40d1b0 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>	;  5 bytes
M000000000000007f:	movl	%eax, %ebp	;  2 bytes
M0000000000000081:	cmpq	$23, 56(%rsp)	;  6 bytes
M0000000000000087:	je	0x4081e9 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0x99>	;  2 bytes
...
M000000000000009b:	je	0x408216 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0xc6>	;  2 bytes
M000000000000009d:	cmpq	$23, 64(%rbx)	;  5 bytes
M00000000000000a2:	je	0x408202 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0xb2>	;  2 bytes
...
M00000000000000d6:	callq	0x408140 <__clang_call_terminate>	;  5 bytes
...
M00000000000000f4:	je	0x408263 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0x113>	;  2 bytes
...
M0000000000000106:	jmp	0x408263 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0x113>	;  2 bytes
M0000000000000108:	movq	%rax, %rdi	;  3 bytes
M000000000000010b:	callq	0x408140 <__clang_call_terminate>	;  5 bytes
M0000000000000110:	movq	%rax, %r15	;  3 bytes
M0000000000000113:	cmpq	$23, 64(%rbx)	;  5 bytes
M0000000000000118:	je	0x408278 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0x128>	;  2 bytes
...
M000000000000013c:	jmp	0x4082b5 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0x165>	;  2 bytes
M000000000000013e:	movq	%rax, %rdi	;  3 bytes
M0000000000000141:	callq	0x408140 <__clang_call_terminate>	;  5 bytes
...
M0000000000000168:	callq	0x403ce0 <_Unwind_Resume@plt>	;  5 bytes
M000000000000016d:	movq	%rax, %rdi	;  3 bytes
M0000000000000170:	callq	0x408140 <__clang_call_terminate>	;  5 bytes
