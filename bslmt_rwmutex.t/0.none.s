...
M0000000000000016:	jne	0x40817c <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0x2c>	;  2 bytes
M0000000000000018:	movq	2369537(%rip), %r14  # 64a970 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M000000000000001f:	testq	%r14, %r14	;  3 bytes
M0000000000000022:	jne	0x40817c <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0x2c>	;  2 bytes
...
M000000000000003d:	movq	$4227808, (%rax)	;  7 bytes
...
M0000000000000064:	movaps	175109(%rip), %xmm0  # 432dc0 <__dso_handle+0x18>	;  7 bytes
M000000000000006b:	movups	%xmm0, 56(%rbx)	;  4 bytes
M000000000000006f:	movl	$4403925, %ecx	;  5 bytes
M0000000000000074:	xorl	%esi, %esi	;  2 bytes
M0000000000000076:	xorl	%edx, %edx	;  2 bytes
M0000000000000078:	callq	0x40f410 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M000000000000007d:	movq	%rsp, %rdi	;  3 bytes
M0000000000000080:	callq	0x40ce90 <BloombergLP::bslmt::ThreadAttributes::ThreadAttributes()>	;  5 bytes
M0000000000000085:	movq	%rsp, %rsi	;  3 bytes
M0000000000000088:	movl	$4244400, %edx	;  5 bytes
M000000000000008d:	movq	%r15, %rdi	;  3 bytes
M0000000000000090:	movq	%rbx, %rcx	;  3 bytes
M0000000000000093:	callq	0x40d380 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>	;  5 bytes
M0000000000000098:	movl	%eax, %ebp	;  2 bytes
M000000000000009a:	cmpq	$23, 56(%rsp)	;  6 bytes
M00000000000000a0:	je	0x408202 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0xb2>	;  2 bytes
...
M00000000000000b4:	je	0x40822f <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0xdf>	;  2 bytes
M00000000000000b6:	cmpq	$23, 64(%rbx)	;  5 bytes
M00000000000000bb:	je	0x40821b <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0xcb>	;  2 bytes
...
M00000000000000ef:	callq	0x408140 <__clang_call_terminate>	;  5 bytes
...
M000000000000010d:	je	0x40827c <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0x12c>	;  2 bytes
...
M000000000000011f:	jmp	0x40827c <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0x12c>	;  2 bytes
M0000000000000121:	movq	%rax, %rdi	;  3 bytes
M0000000000000124:	callq	0x408140 <__clang_call_terminate>	;  5 bytes
M0000000000000129:	movq	%rax, %r15	;  3 bytes
M000000000000012c:	cmpq	$23, 64(%rbx)	;  5 bytes
M0000000000000131:	je	0x408291 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0x141>	;  2 bytes
...
M0000000000000155:	jmp	0x4082ce <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<ReaderThread>(unsigned long*, ReaderThread const&, BloombergLP::bslma::Allocator*)+0x17e>	;  2 bytes
M0000000000000157:	movq	%rax, %rdi	;  3 bytes
M000000000000015a:	callq	0x408140 <__clang_call_terminate>	;  5 bytes
...
M0000000000000181:	callq	0x403ce0 <_Unwind_Resume@plt>	;  5 bytes
M0000000000000186:	movq	%rax, %rdi	;  3 bytes
M0000000000000189:	callq	0x408140 <__clang_call_terminate>	;  5 bytes
