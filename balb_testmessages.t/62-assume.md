# `BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)` - Assumed

```nasm
000000000040b450 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)>:
M0000000000000000:	pushq	%r14	;  2 bytes
M0000000000000002:	pushq	%rbx	;  1 bytes
M0000000000000003:	pushq	%rax	;  1 bytes
M0000000000000004:	incl	%esi	;  2 bytes
M0000000000000006:	cmpl	$4, %esi	;  3 bytes
M0000000000000009:	ja	0x40b4af <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x5f>	;  2 bytes
M000000000000000b:	movq	%rdi, %r14	;  3 bytes
M000000000000000e:	jmpq	*4482280(,%rsi,8)	;  7 bytes
M0000000000000015:	movl	368(%r14), %eax	;  7 bytes
M000000000000001c:	cmpq	$3, %rax	;  4 bytes
M0000000000000020:	ja	0x40b618 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1c8>	;  6 bytes
M0000000000000026:	jmpq	*4482320(,%rax,8)	;  7 bytes
M000000000000002d:	movq	%r14, %rdi	;  3 bytes
M0000000000000030:	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>	;  5 bytes
M0000000000000035:	jmp	0x40b618 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1c8>	;  5 bytes
M000000000000003a:	movl	368(%r14), %eax	;  7 bytes
M0000000000000041:	cmpq	$3, %rax	;  4 bytes
M0000000000000045:	ja	0x40b58e <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x13e>	;  6 bytes
M000000000000004b:	jmpq	*4482352(,%rax,8)	;  7 bytes
M0000000000000052:	movq	%r14, %rdi	;  3 bytes
M0000000000000055:	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>	;  5 bytes
M000000000000005a:	jmp	0x40b58e <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x13e>	;  5 bytes
M000000000000005f:	movl	$4294967295, %ebx	;  5 bytes
M0000000000000064:	jmp	0x40b668 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x218>	;  5 bytes
M0000000000000069:	movl	368(%r14), %eax	;  7 bytes
M0000000000000070:	cmpq	$3, %rax	;  4 bytes
M0000000000000074:	ja	0x40b641 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1f1>	;  6 bytes
M000000000000007a:	jmpq	*4482448(,%rax,8)	;  7 bytes
M0000000000000081:	movq	%r14, %rdi	;  3 bytes
M0000000000000084:	callq	0x409860 <BloombergLP::balb::Sequence6::reset()>	;  5 bytes
M0000000000000089:	jmp	0x40b666 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  5 bytes
M000000000000008e:	movl	368(%r14), %eax	;  7 bytes
M0000000000000095:	cmpq	$3, %rax	;  4 bytes
M0000000000000099:	ja	0x40b5d6 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x186>	;  6 bytes
M000000000000009f:	jmpq	*4482416(,%rax,8)	;  7 bytes
M00000000000000a6:	movq	%r14, %rdi	;  3 bytes
M00000000000000a9:	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>	;  5 bytes
M00000000000000ae:	jmp	0x40b5d6 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x186>	;  5 bytes
M00000000000000b3:	movl	368(%r14), %eax	;  7 bytes
M00000000000000ba:	cmpq	$3, %rax	;  4 bytes
M00000000000000be:	ja	0x40b51f <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0xcf>	;  2 bytes
M00000000000000c0:	jmpq	*4482384(,%rax,8)	;  7 bytes
...
M00000000000000e4:	jne	0x40b547 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0xf7>	;  2 bytes
M00000000000000e6:	movq	2573843(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M00000000000000ed:	testq	%rax, %rax	;  3 bytes
M00000000000000f0:	jne	0x40b547 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0xf7>	;  2 bytes
...
M00000000000000fe:	movaps	240043(%rip), %xmm0  # 445f00 <__dso_handle+0x8>	;  7 bytes
...
M000000000000011d:	jmp	0x40b666 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  5 bytes
M0000000000000122:	cmpq	$23, 32(%r14)	;  5 bytes
M0000000000000127:	je	0x40b586 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x136>	;  2 bytes
...
M0000000000000150:	jmp	0x40b666 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  5 bytes
M0000000000000155:	movl	$0, (%r14)	;  7 bytes
M000000000000015c:	jmp	0x40b666 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  5 bytes
M0000000000000161:	movb	$0, (%r14)	;  4 bytes
M0000000000000165:	jmp	0x40b666 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  5 bytes
M000000000000016a:	cmpq	$23, 32(%r14)	;  5 bytes
M000000000000016f:	je	0x40b5ce <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x17e>	;  2 bytes
...
M0000000000000195:	jmp	0x40b666 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  2 bytes
...
M00000000000001aa:	jmp	0x40b668 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x218>	;  2 bytes
M00000000000001ac:	cmpq	$23, 32(%r14)	;  5 bytes
M00000000000001b1:	je	0x40b610 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1c0>	;  2 bytes
...
M00000000000001d3:	jmp	0x40b666 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  2 bytes
M00000000000001d5:	cmpq	$23, 32(%r14)	;  5 bytes
M00000000000001da:	je	0x40b639 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1e9>	;  2 bytes
