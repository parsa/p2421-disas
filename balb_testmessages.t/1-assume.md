...
000000000000002a: 06	je	0x40d541 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x1a1>
...
000000000000019c: 05	jmp	0x40d758 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x3b8>
00000000000001a1: 07	movq	2565640(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000001a8: 03	testq	%rax, %rax
00000000000001ab: 02	jne	0x40d552 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x1b2>
00000000000001ad: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
00000000000001ce: 07	movq	2565595(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000001d5: 03	testq	%rax, %rax
00000000000001d8: 02	jne	0x40d57f <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x1df>
00000000000001da: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
00000000000001fa: 07	movq	2565551(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000201: 03	testq	%rax, %rax
0000000000000204: 05	movq	%r15, 112(%rsp)
0000000000000209: 05	movq	%r12, 104(%rsp)
000000000000020e: 02	jne	0x40d5b5 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x215>
0000000000000210: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
0000000000000236: 07	movq	2565491(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
000000000000023d: 03	testq	%rax, %rax
0000000000000240: 05	movq	%r13, 96(%rsp)
0000000000000245: 02	jne	0x40d5ec <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x24c>
0000000000000247: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
0000000000000276: 07	movq	2565427(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
000000000000027d: 03	testq	%rax, %rax
0000000000000280: 02	jne	0x40d627 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x287>
0000000000000282: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
00000000000002b4: 07	movq	2565365(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000002bb: 03	testq	%rax, %rax
00000000000002be: 02	jne	0x40d665 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x2c5>
00000000000002c0: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
00000000000002f2: 07	movq	2565303(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000002f9: 03	testq	%rax, %rax
00000000000002fc: 02	jne	0x40d6a3 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x303>
00000000000002fe: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
0000000000000330: 07	movq	2565241(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000337: 03	testq	%rax, %rax
000000000000033a: 02	jne	0x40d6e1 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x341>
000000000000033c: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
000000000000036b: 07	movq	2565182(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000372: 03	testq	%rax, %rax
0000000000000375: 02	jne	0x40d71c <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x37c>
0000000000000377: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
00000000000003a2: 07	movq	2565127(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000003a9: 03	testq	%rax, %rax
00000000000003ac: 05	movq	8(%rsp), %rbp
00000000000003b1: 02	jne	0x40d758 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x3b8>
00000000000003b3: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
00000000000003b8: 11	movq	$0, 296(%rbx)
00000000000003c3: 07	movaps	231318(%rip), %xmm0  # 445f00 <__dso_handle+0x8>
...
00000000000003e2: 02	je	0x40d7a2 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x402>
...
0000000000000400: 02	jmp	0x40d7e3 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x443>
0000000000000402: 07	movq	2565031(%rip), %rax  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000409: 03	testq	%rax, %rax
000000000000040c: 02	jne	0x40d7b3 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x413>
000000000000040e: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
000000000000042f: 07	movq	2564986(%rip), %r14  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000436: 03	testq	%r14, %r14
0000000000000439: 02	jne	0x40d7e3 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x443>
000000000000043b: 05	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
...
00000000000004a9: 02	je	0x40d897 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x4f7>
00000000000004ab: 07	movb	$0, 376(%rbx)
00000000000004b2: 07	movq	344(%rbx), %rsi
00000000000004b9: 03	testq	%rsi, %rsi
00000000000004bc: 02	je	0x40d897 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x4f7>
00000000000004be: 07	movq	368(%rbx), %rdi
00000000000004c5: 03	movq	(%rdi), %rax
00000000000004c8: 03	callq	*24(%rax)
00000000000004cb: 02	jmp	0x40d897 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x4f7>
00000000000004cd: 03	movq	%rax, %rdi
00000000000004d0: 05	callq	0x4043c0 <__clang_call_terminate>
00000000000004d5: 03	movq	%rax, %r14
00000000000004d8: 02	jmp	0x40d8c0 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x520>
00000000000004da: 03	movq	%rax, %r14
00000000000004dd: 02	jmp	0x40d8f3 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x553>
00000000000004df: 03	movq	%rax, %r14
00000000000004e2: 05	jmp	0x40d943 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x5a3>
00000000000004e7: 03	movq	%rax, %r14
00000000000004ea: 05	jmp	0x40d98b <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x5eb>
00000000000004ef: 05	movq	%rbp, 8(%rsp)
00000000000004f4: 03	movq	%rax, %r14
00000000000004f7: 08	cmpq	$23, 328(%rbx)
00000000000004ff: 02	je	0x40d8b5 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x515>
...
0000000000000527: 02	je	0x40d8f3 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x553>
...
0000000000000541: 05	callq	0x419cc0 <void BloombergLP::bslalg::ArrayDestructionPrimitives::destroy<BloombergLP::balb::Choice1, bsl::allocator<BloombergLP::balb::Choice1> >(BloombergLP::balb::Choice1*, BloombergLP::balb::Choice1*, bsl::allocator<BloombergLP::balb::Choice1>, bsl::integral_constant<bool, false>)>
...
000000000000055a: 02	je	0x40d943 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x5a3>
000000000000055c: 04	movq	8(%r13), %r15
0000000000000560: 03	cmpq	%r15, %rbx
0000000000000563: 02	jne	0x40d918 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x578>
0000000000000565: 02	jmp	0x40d932 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x592>
0000000000000567: 08	movq	$-1, 24(%rbx)
000000000000056f: 04	addq	$48, %rbx
0000000000000573: 03	cmpq	%rbx, %r15
0000000000000576: 02	je	0x40d92e <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x58e>
0000000000000578: 05	cmpq	$23, 32(%rbx)
000000000000057d: 02	je	0x40d907 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x567>
...
000000000000058c: 02	jmp	0x40d907 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x567>
...
00000000000005ae: 02	je	0x40d98b <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x5eb>
00000000000005b0: 05	movq	16(%rsp), %rax
00000000000005b5: 04	movq	8(%rax), %r15
00000000000005b9: 03	cmpq	%r15, %rbx
00000000000005bc: 02	je	0x40d97a <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x5da>
00000000000005be: 03	movq	%rbx, %rdi
00000000000005c1: 05	callq	0x406b80 <BloombergLP::balb::Sequence3::~Sequence3()>
00000000000005c6: 07	addq	$184, %rbx
00000000000005cd: 03	cmpq	%rbx, %r15
00000000000005d0: 02	jne	0x40d95e <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x5be>
...
00000000000005f6: 02	je	0x40d9db <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x63b>
...
0000000000000606: 02	jmp	0x40d9db <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x63b>
0000000000000608: 03	movq	%rax, %rdi
000000000000060b: 05	callq	0x4043c0 <__clang_call_terminate>
0000000000000610: 03	movq	%rax, %rdi
0000000000000613: 05	callq	0x4043c0 <__clang_call_terminate>
0000000000000618: 03	movq	%rax, %rdi
000000000000061b: 05	callq	0x4043c0 <__clang_call_terminate>
0000000000000620: 03	movq	%rax, %rdi
0000000000000623: 05	callq	0x4043c0 <__clang_call_terminate>
0000000000000628: 03	movq	%rax, %rdi
000000000000062b: 05	callq	0x4043c0 <__clang_call_terminate>
0000000000000630: 03	movq	%rax, %rdi
0000000000000633: 05	callq	0x4043c0 <__clang_call_terminate>
...
0000000000000646: 02	je	0x40da03 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x663>
...
0000000000000656: 02	jmp	0x40da03 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x663>
...
000000000000066e: 02	je	0x40da6b <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x6cb>
0000000000000670: 05	movq	24(%rsp), %rax
0000000000000675: 04	movq	8(%rax), %rbp
0000000000000679: 03	cmpq	%rbp, %rbx
000000000000067c: 02	jne	0x40da29 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x689>
000000000000067e: 02	jmp	0x40da45 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x6a5>
0000000000000680: 04	addq	$32, %rbx
0000000000000684: 03	cmpq	%rbx, %rbp
0000000000000687: 02	je	0x40da3d <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x69d>
0000000000000689: 03	movq	(%rbx), %rsi
000000000000068c: 03	testq	%rsi, %rsi
000000000000068f: 02	je	0x40da20 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x680>
0000000000000691: 04	movq	24(%rbx), %rdi
0000000000000695: 03	movq	(%rdi), %rax
0000000000000698: 03	callq	*24(%rax)
000000000000069b: 02	jmp	0x40da20 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x680>
...
00000000000006b6: 02	jmp	0x40da6b <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x6cb>
00000000000006b8: 03	movq	%rax, %rdi
00000000000006bb: 05	callq	0x4043c0 <__clang_call_terminate>
00000000000006c0: 03	movq	%rax, %rdi
00000000000006c3: 05	callq	0x4043c0 <__clang_call_terminate>
...
00000000000006d6: 02	je	0x40da93 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x6f3>
...
00000000000006e6: 02	jmp	0x40da93 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x6f3>
...
00000000000006fe: 02	je	0x40dabb <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x71b>
...
000000000000070e: 02	jmp	0x40dabb <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x71b>
...
0000000000000726: 02	je	0x40dad6 <BloombergLP::balb::Sequence4::Sequence4(BloombergLP::bslma::Allocator*)+0x736>
