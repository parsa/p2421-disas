...
0000000000000015: 02	ja	0x40a566 <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)+0x26>
0000000000000017: 07	jmpq	*4481472(,%rax,8)
...
000000000000003a: 02	jne	0x40a590 <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)+0x50>
000000000000003c: 07	movq	2577869(%rip), %rdi  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000043: 03	testq	%rdi, %rdi
0000000000000046: 02	jne	0x40a590 <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)+0x50>
...
0000000000000070: 02	je	0x40a60c <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)+0xcc>
...
0000000000000096: 02	jb	0x40a5eb <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)+0xab>
...
00000000000000a9: 02	jne	0x40a5ee <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)+0xae>
00000000000000ab: 03	movq	%rbx, %rax
00000000000000ae: 04	movq	24(%rbx), %rdx
00000000000000b2: 03	incq	%rdx
00000000000000b5: 02	je	0x40a60c <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)+0xcc>
00000000000000b7: 05	cmpq	$23, 32(%r14)
00000000000000bc: 02	je	0x40a601 <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)+0xc1>
...
00000000000000e2: 02	je	0x40a616 <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)+0xd6>
00000000000000e4: 04	movq	24(%r14), %rdx
00000000000000e8: 05	cmpq	$23, 32(%r14)
00000000000000ed: 02	je	0x40a632 <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)+0xf2>
...
000000000000010e: 02	jmp	0x40a616 <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)+0xd6>
