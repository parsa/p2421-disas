...
M0000000000000013:	je	0x40e386 <BloombergLP::balb::Sequence4::~Sequence4()+0x46>	;  2 bytes
M0000000000000015:	movb	$0, 464(%r14)	;  8 bytes
M000000000000001d:	cmpq	$23, 448(%r14)	;  8 bytes
M0000000000000025:	je	0x40e37b <BloombergLP::balb::Sequence4::~Sequence4()+0x3b>	;  2 bytes
...
M000000000000004e:	je	0x40e3b1 <BloombergLP::balb::Sequence4::~Sequence4()+0x71>	;  2 bytes
...
M0000000000000062:	je	0x40e3b1 <BloombergLP::balb::Sequence4::~Sequence4()+0x71>	;  2 bytes
...
M0000000000000079:	je	0x40e3cf <BloombergLP::balb::Sequence4::~Sequence4()+0x8f>	;  2 bytes
...
M00000000000000a4:	je	0x40e417 <BloombergLP::balb::Sequence4::~Sequence4()+0xd7>	;  2 bytes
...
M00000000000000be:	callq	0x419cc0 <void BloombergLP::bslalg::ArrayDestructionPrimitives::destroy<BloombergLP::balb::Choice1, bsl::allocator<BloombergLP::balb::Choice1> >(BloombergLP::balb::Choice1*, BloombergLP::balb::Choice1*, bsl::allocator<BloombergLP::balb::Choice1>, bsl::integral_constant<bool, false>)>	;  5 bytes
...
M00000000000000e1:	je	0x40e47e <BloombergLP::balb::Sequence4::~Sequence4()+0x13e>	;  2 bytes
M00000000000000e3:	movq	240(%r14), %r15	;  7 bytes
M00000000000000ea:	cmpq	%r15, %rbx	;  3 bytes
M00000000000000ed:	jne	0x40e451 <BloombergLP::balb::Sequence4::~Sequence4()+0x111>	;  2 bytes
M00000000000000ef:	jmp	0x40e46e <BloombergLP::balb::Sequence4::~Sequence4()+0x12e>	;  2 bytes
...
M000000000000010f:	je	0x40e467 <BloombergLP::balb::Sequence4::~Sequence4()+0x127>	;  2 bytes
M0000000000000111:	cmpq	$23, 32(%rbx)	;  5 bytes
M0000000000000116:	je	0x40e440 <BloombergLP::balb::Sequence4::~Sequence4()+0x100>	;  2 bytes
...
M0000000000000125:	jmp	0x40e440 <BloombergLP::balb::Sequence4::~Sequence4()+0x100>	;  2 bytes
...
M0000000000000148:	je	0x40e4cb <BloombergLP::balb::Sequence4::~Sequence4()+0x18b>	;  2 bytes
M000000000000014a:	movq	208(%r14), %r15	;  7 bytes
M0000000000000151:	cmpq	%r15, %rbx	;  3 bytes
M0000000000000154:	je	0x40e4bb <BloombergLP::balb::Sequence4::~Sequence4()+0x17b>	;  2 bytes
M0000000000000156:	nopw	%cs:(%rax,%rax)	; 10 bytes
M0000000000000160:	movq	%rbx, %rdi	;  3 bytes
M0000000000000163:	callq	0x406b80 <BloombergLP::balb::Sequence3::~Sequence3()>	;  5 bytes
M0000000000000168:	addq	$184, %rbx	;  7 bytes
M000000000000016f:	cmpq	%rbx, %r15	;  3 bytes
M0000000000000172:	jne	0x40e4a0 <BloombergLP::balb::Sequence4::~Sequence4()+0x160>	;  2 bytes
...
M0000000000000195:	je	0x40e4e4 <BloombergLP::balb::Sequence4::~Sequence4()+0x1a4>	;  2 bytes
...
M00000000000001ae:	je	0x40e4fd <BloombergLP::balb::Sequence4::~Sequence4()+0x1bd>	;  2 bytes
...
M00000000000001c4:	je	0x40e551 <BloombergLP::balb::Sequence4::~Sequence4()+0x211>	;  2 bytes
M00000000000001c6:	movq	112(%r14), %r15	;  4 bytes
M00000000000001ca:	cmpq	%r15, %rbx	;  3 bytes
M00000000000001cd:	jne	0x40e529 <BloombergLP::balb::Sequence4::~Sequence4()+0x1e9>	;  2 bytes
M00000000000001cf:	jmp	0x40e541 <BloombergLP::balb::Sequence4::~Sequence4()+0x201>	;  2 bytes
...
M00000000000001e7:	je	0x40e53d <BloombergLP::balb::Sequence4::~Sequence4()+0x1fd>	;  2 bytes
M00000000000001e9:	movq	(%rbx), %rsi	;  3 bytes
M00000000000001ec:	testq	%rsi, %rsi	;  3 bytes
M00000000000001ef:	je	0x40e520 <BloombergLP::balb::Sequence4::~Sequence4()+0x1e0>	;  2 bytes
M00000000000001f1:	movq	24(%rbx), %rdi	;  4 bytes
M00000000000001f5:	movq	(%rdi), %rax	;  3 bytes
M00000000000001f8:	callq	*24(%rax)	;  3 bytes
M00000000000001fb:	jmp	0x40e520 <BloombergLP::balb::Sequence4::~Sequence4()+0x1e0>	;  2 bytes
...
M0000000000000218:	je	0x40e564 <BloombergLP::balb::Sequence4::~Sequence4()+0x224>	;  2 bytes
...
M000000000000022b:	je	0x40e577 <BloombergLP::balb::Sequence4::~Sequence4()+0x237>	;  2 bytes
...
M000000000000023e:	je	0x40e58a <BloombergLP::balb::Sequence4::~Sequence4()+0x24a>	;  2 bytes
...
M0000000000000257:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M000000000000025c:	movq	%rax, %rdi	;  3 bytes
M000000000000025f:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M0000000000000264:	movq	%rax, %rdi	;  3 bytes
M0000000000000267:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M000000000000026c:	movq	%rax, %rdi	;  3 bytes
M000000000000026f:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M0000000000000274:	movq	%rax, %rdi	;  3 bytes
M0000000000000277:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M000000000000027c:	movq	%rax, %rdi	;  3 bytes
M000000000000027f:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M0000000000000284:	movq	%rax, %rdi	;  3 bytes
M0000000000000287:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
...
M000000000000029f:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M00000000000002a4:	movq	%rax, %rdi	;  3 bytes
M00000000000002a7:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M00000000000002ac:	movq	%rax, %rdi	;  3 bytes
M00000000000002af:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M00000000000002b4:	movq	%rax, %rdi	;  3 bytes
M00000000000002b7:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M00000000000002bc:	movq	%rax, %rdi	;  3 bytes
M00000000000002bf:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
