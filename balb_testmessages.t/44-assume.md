# `BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection2(unsigned char)` - Assumed
...
M0000000000000012:	ja	0x40b226 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection2(unsigned char)+0x46>	;  2 bytes
M0000000000000014:	jmpq	*4482152(,%rax,8)	;  7 bytes
M000000000000001b:	movq	%rbx, %rdi	;  3 bytes
M000000000000001e:	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>	;  5 bytes
M0000000000000023:	jmp	0x40b226 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection2(unsigned char)+0x46>	;  2 bytes
M0000000000000025:	movb	%bpl, (%rbx)	;  3 bytes
M0000000000000028:	jmp	0x40b233 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection2(unsigned char)+0x53>	;  2 bytes
M000000000000002a:	cmpq	$23, 32(%rbx)	;  5 bytes
M000000000000002f:	je	0x40b21e <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection2(unsigned char)+0x3e>	;  2 bytes
...
M0000000000000060:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
