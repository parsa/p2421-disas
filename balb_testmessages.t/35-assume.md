# `BloombergLP::balb::Choice3::makeSelection1()` - Assumed

```nasm
000000000040a990 <BloombergLP::balb::Choice3::makeSelection1()>:
...
M000000000000000e:	ja	0x40a9cd <BloombergLP::balb::Choice3::makeSelection1()+0x3d>	;  2 bytes
M0000000000000010:	jmpq	*4481768(,%rax,8)	;  7 bytes
M0000000000000017:	movq	%rbx, %rdi	;  3 bytes
M000000000000001a:	callq	0x409860 <BloombergLP::balb::Sequence6::reset()>	;  5 bytes
M000000000000001f:	jmp	0x40a9f0 <BloombergLP::balb::Choice3::makeSelection1()+0x60>	;  2 bytes
M0000000000000021:	cmpq	$23, 32(%rbx)	;  5 bytes
M0000000000000026:	je	0x40a9c5 <BloombergLP::balb::Choice3::makeSelection1()+0x35>	;  2 bytes
