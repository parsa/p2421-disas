...
M0000000000000013:	je	0x40fd89 <BloombergLP::balb::Sequence1::reset()+0x69>	;  2 bytes
M0000000000000015:	movb	$0, 488(%r14)	;  8 bytes
M000000000000001d:	movl	472(%r14), %eax	;  7 bytes
M0000000000000024:	cmpl	$2, %eax	;  3 bytes
M0000000000000027:	je	0x40fd58 <BloombergLP::balb::Sequence1::reset()+0x38>	;  2 bytes
M0000000000000029:	testl	%eax, %eax	;  2 bytes
M000000000000002b:	jne	0x40fd7e <BloombergLP::balb::Sequence1::reset()+0x5e>	;  2 bytes
M000000000000002d:	leaq	104(%r14), %rdi	;  4 bytes
M0000000000000031:	callq	0x4093b0 <BloombergLP::balb::Sequence6::~Sequence6()>	;  5 bytes
M0000000000000036:	jmp	0x40fd7e <BloombergLP::balb::Sequence1::reset()+0x5e>	;  2 bytes
M0000000000000038:	cmpq	$23, 136(%r14)	;  8 bytes
M0000000000000040:	je	0x40fd73 <BloombergLP::balb::Sequence1::reset()+0x53>	;  2 bytes
...
M0000000000000074:	je	0x40fdb1 <BloombergLP::balb::Sequence1::reset()+0x91>	;  2 bytes
...
M0000000000000084:	callq	0x419d40 <void BloombergLP::bslalg::ArrayDestructionPrimitives::destroy<BloombergLP::balb::Choice1, bsl::allocator<BloombergLP::balb::Choice1> >(BloombergLP::balb::Choice1*, BloombergLP::balb::Choice1*, bsl::allocator<BloombergLP::balb::Choice1>)>	;  5 bytes
...
M0000000000000098:	callq	0x40cc40 <BloombergLP::balb::Choice2::reset()>	;  5 bytes
M000000000000009d:	movq	8(%r14), %rbx	;  4 bytes
M00000000000000a1:	movq	16(%r14), %r15	;  4 bytes
M00000000000000a5:	cmpq	%rbx, %r15	;  3 bytes
M00000000000000a8:	je	0x40fde9 <BloombergLP::balb::Sequence1::reset()+0xc9>	;  2 bytes
M00000000000000aa:	nopw	(%rax,%rax)	;  6 bytes
M00000000000000b0:	movq	%rbx, %rdi	;  3 bytes
M00000000000000b3:	callq	0x415580 <BloombergLP::bslstl::Optional_DataImp<BloombergLP::balb::Choice1>::reset()>	;  5 bytes
M00000000000000b8:	addq	$40, %rbx	;  4 bytes
M00000000000000bc:	cmpq	%rbx, %r15	;  3 bytes
M00000000000000bf:	jne	0x40fdd0 <BloombergLP::balb::Sequence1::reset()+0xb0>	;  2 bytes
...
M00000000000000d4:	jne	0x40fe1e <BloombergLP::balb::Sequence1::reset()+0xfe>	;  2 bytes
M00000000000000d6:	jmp	0x40fe5e <BloombergLP::balb::Sequence1::reset()+0x13e>	;  2 bytes
...
M00000000000000fc:	je	0x40fe56 <BloombergLP::balb::Sequence1::reset()+0x136>	;  2 bytes
M00000000000000fe:	movl	368(%rbx), %eax	;  6 bytes
M0000000000000104:	cmpl	$2, %eax	;  3 bytes
M0000000000000107:	je	0x40fe40 <BloombergLP::balb::Sequence1::reset()+0x120>	;  2 bytes
M0000000000000109:	testl	%eax, %eax	;  2 bytes
M000000000000010b:	jne	0x40fe08 <BloombergLP::balb::Sequence1::reset()+0xe8>	;  2 bytes
M000000000000010d:	movq	%rbx, %rdi	;  3 bytes
M0000000000000110:	callq	0x4093b0 <BloombergLP::balb::Sequence6::~Sequence6()>	;  5 bytes
M0000000000000115:	jmp	0x40fe08 <BloombergLP::balb::Sequence1::reset()+0xe8>	;  2 bytes
M0000000000000117:	nopw	(%rax,%rax)	;  9 bytes
M0000000000000120:	cmpq	$23, 32(%rbx)	;  5 bytes
M0000000000000125:	je	0x40fe00 <BloombergLP::balb::Sequence1::reset()+0xe0>	;  2 bytes
...
M0000000000000134:	jmp	0x40fe00 <BloombergLP::balb::Sequence1::reset()+0xe0>	;  2 bytes
...
M000000000000014b:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
