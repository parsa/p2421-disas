# `BloombergLP::balb::Sequence1::~Sequence1()` - Assumed

```nasm
000000000040f990 <BloombergLP::balb::Sequence1::~Sequence1()>:
...
M000000000000001a:	je	0x40fa11 <BloombergLP::balb::Sequence1::~Sequence1()+0x81>	;  2 bytes
M000000000000001c:	movq	(%r14), %r15	;  3 bytes
M000000000000001f:	movl	48(%rbx), %eax	;  3 bytes
M0000000000000022:	cmpq	$3, %rax	;  4 bytes
M0000000000000026:	ja	0x40f9fe <BloombergLP::balb::Sequence1::~Sequence1()+0x6e>	;  2 bytes
M0000000000000028:	jmpq	*4483168(,%rax,8)	;  7 bytes
M000000000000002f:	cmpq	$23, 32(%rbx)	;  5 bytes
M0000000000000034:	je	0x40f9d3 <BloombergLP::balb::Sequence1::~Sequence1()+0x43>	;  2 bytes
...
M000000000000004b:	jmp	0x40f9fe <BloombergLP::balb::Sequence1::~Sequence1()+0x6e>	;  2 bytes
M000000000000004d:	movq	(%rbx), %r12	;  3 bytes
M0000000000000050:	testq	%r12, %r12	;  3 bytes
M0000000000000053:	je	0x40f9fe <BloombergLP::balb::Sequence1::~Sequence1()+0x6e>	;  2 bytes
M0000000000000055:	movq	56(%rbx), %r13	;  4 bytes
M0000000000000059:	movq	%r12, %rdi	;  3 bytes
M000000000000005c:	callq	0x4155f0 <BloombergLP::balb::Choice1::~Choice1()>	;  5 bytes
...
M0000000000000089:	je	0x40fa73 <BloombergLP::balb::Sequence1::~Sequence1()+0xe3>	;  2 bytes
M000000000000008b:	movb	$0, 488(%r14)	;  8 bytes
M0000000000000093:	movl	472(%r14), %eax	;  7 bytes
M000000000000009a:	cmpq	$3, %rax	;  4 bytes
M000000000000009e:	ja	0x40fa68 <BloombergLP::balb::Sequence1::~Sequence1()+0xd8>	;  2 bytes
M00000000000000a0:	jmpq	*4483200(,%rax,8)	;  7 bytes
M00000000000000a7:	leaq	104(%r14), %rdi	;  4 bytes
M00000000000000ab:	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>	;  5 bytes
M00000000000000b0:	jmp	0x40fa68 <BloombergLP::balb::Sequence1::~Sequence1()+0xd8>	;  2 bytes
M00000000000000b2:	cmpq	$23, 136(%r14)	;  8 bytes
M00000000000000ba:	je	0x40fa5d <BloombergLP::balb::Sequence1::~Sequence1()+0xcd>	;  2 bytes
...
M00000000000000ea:	je	0x40faa1 <BloombergLP::balb::Sequence1::~Sequence1()+0x111>	;  2 bytes
...
M00000000000000fe:	callq	0x419cc0 <void BloombergLP::bslalg::ArrayDestructionPrimitives::destroy<BloombergLP::balb::Choice1, bsl::allocator<BloombergLP::balb::Choice1> >(BloombergLP::balb::Choice1*, BloombergLP::balb::Choice1*, bsl::allocator<BloombergLP::balb::Choice1>, bsl::integral_constant<bool, false>)>	;  5 bytes
...
M0000000000000118:	je	0x40fb20 <BloombergLP::balb::Sequence1::~Sequence1()+0x190>	;  2 bytes
M000000000000011a:	movq	48(%r14), %r15	;  4 bytes
M000000000000011e:	cmpq	%r15, %rbx	;  3 bytes
M0000000000000121:	jne	0x40fade <BloombergLP::balb::Sequence1::~Sequence1()+0x14e>	;  2 bytes
M0000000000000123:	jmp	0x40fb13 <BloombergLP::balb::Sequence1::~Sequence1()+0x183>	;  2 bytes
M0000000000000125:	nopw	%cs:(%rax,%rax)	; 10 bytes
M000000000000012f:	nop		;  1 bytes
M0000000000000130:	movq	%rbx, %rdi	;  3 bytes
M0000000000000133:	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>	;  5 bytes
...
M000000000000014c:	je	0x40fb0f <BloombergLP::balb::Sequence1::~Sequence1()+0x17f>	;  2 bytes
M000000000000014e:	movl	368(%rbx), %eax	;  6 bytes
M0000000000000154:	cmpq	$3, %rax	;  4 bytes
M0000000000000158:	ja	0x40fac8 <BloombergLP::balb::Sequence1::~Sequence1()+0x138>	;  2 bytes
M000000000000015a:	jmpq	*4483232(,%rax,8)	;  7 bytes
M0000000000000161:	cmpq	$23, 32(%rbx)	;  5 bytes
M0000000000000166:	je	0x40fb05 <BloombergLP::balb::Sequence1::~Sequence1()+0x175>	;  2 bytes
...
M000000000000017d:	jmp	0x40fac8 <BloombergLP::balb::Sequence1::~Sequence1()+0x138>	;  2 bytes
...
M0000000000000197:	je	0x40fb62 <BloombergLP::balb::Sequence1::~Sequence1()+0x1d2>	;  2 bytes
M0000000000000199:	movq	16(%r14), %r15	;  4 bytes
M000000000000019d:	cmpq	%r15, %rbx	;  3 bytes
M00000000000001a0:	je	0x40fb55 <BloombergLP::balb::Sequence1::~Sequence1()+0x1c5>	;  2 bytes
M00000000000001a2:	nopw	%cs:(%rax,%rax)	; 10 bytes
M00000000000001ac:	nopl	(%rax)	;  4 bytes
M00000000000001b0:	movq	%rbx, %rdi	;  3 bytes
M00000000000001b3:	callq	0x4154f0 <BloombergLP::bslstl::Optional_DataImp<BloombergLP::balb::Choice1>::reset()>	;  5 bytes
M00000000000001b8:	addq	$40, %rbx	;  4 bytes
M00000000000001bc:	cmpq	%rbx, %r15	;  3 bytes
M00000000000001bf:	jne	0x40fb40 <BloombergLP::balb::Sequence1::~Sequence1()+0x1b0>	;  2 bytes
...
M00000000000001e3:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M00000000000001e8:	movq	%rax, %rdi	;  3 bytes
M00000000000001eb:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M00000000000001f0:	movq	%rax, %rdi	;  3 bytes
M00000000000001f3:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
M00000000000001f8:	movq	%rax, %rdi	;  3 bytes
M00000000000001fb:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
...
M000000000000020f:	callq	0x415230 <bsl::optional<BloombergLP::balb::Choice3, true>::~optional()>	;  5 bytes
M0000000000000214:	leaq	72(%r14), %rdi	;  4 bytes
M0000000000000218:	callq	0x414cf0 <bsl::vector<BloombergLP::balb::Choice1, bsl::allocator<BloombergLP::balb::Choice1> >::~vector()>	;  5 bytes
M000000000000021d:	leaq	40(%r14), %rdi	;  4 bytes
M0000000000000221:	callq	0x4152a0 <bsl::vector<BloombergLP::balb::Choice3, bsl::allocator<BloombergLP::balb::Choice3> >::~vector()>	;  5 bytes
M0000000000000226:	addq	$8, %r14	;  4 bytes
M000000000000022a:	movq	%r14, %rdi	;  3 bytes
M000000000000022d:	callq	0x415340 <bsl::vector<BloombergLP::bdlb::NullableValue<BloombergLP::balb::Choice1>, bsl::allocator<BloombergLP::bdlb::NullableValue<BloombergLP::balb::Choice1> > >::~vector()>	;  5 bytes
...
M0000000000000245:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
