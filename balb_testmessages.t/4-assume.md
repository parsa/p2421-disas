...
000000000000001a: 02	je	0x40fa11 <BloombergLP::balb::Sequence1::~Sequence1()+0x81>
000000000000001c: 03	movq	(%r14), %r15
000000000000001f: 03	movl	48(%rbx), %eax
0000000000000022: 04	cmpq	$3, %rax
0000000000000026: 02	ja	0x40f9fe <BloombergLP::balb::Sequence1::~Sequence1()+0x6e>
0000000000000028: 07	jmpq	*4483168(,%rax,8)
000000000000002f: 05	cmpq	$23, 32(%rbx)
0000000000000034: 02	je	0x40f9d3 <BloombergLP::balb::Sequence1::~Sequence1()+0x43>
...
000000000000004b: 02	jmp	0x40f9fe <BloombergLP::balb::Sequence1::~Sequence1()+0x6e>
000000000000004d: 03	movq	(%rbx), %r12
0000000000000050: 03	testq	%r12, %r12
0000000000000053: 02	je	0x40f9fe <BloombergLP::balb::Sequence1::~Sequence1()+0x6e>
0000000000000055: 04	movq	56(%rbx), %r13
0000000000000059: 03	movq	%r12, %rdi
000000000000005c: 05	callq	0x4155f0 <BloombergLP::balb::Choice1::~Choice1()>
...
0000000000000089: 02	je	0x40fa73 <BloombergLP::balb::Sequence1::~Sequence1()+0xe3>
000000000000008b: 08	movb	$0, 488(%r14)
0000000000000093: 07	movl	472(%r14), %eax
000000000000009a: 04	cmpq	$3, %rax
000000000000009e: 02	ja	0x40fa68 <BloombergLP::balb::Sequence1::~Sequence1()+0xd8>
00000000000000a0: 07	jmpq	*4483200(,%rax,8)
00000000000000a7: 04	leaq	104(%r14), %rdi
00000000000000ab: 05	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>
00000000000000b0: 02	jmp	0x40fa68 <BloombergLP::balb::Sequence1::~Sequence1()+0xd8>
00000000000000b2: 08	cmpq	$23, 136(%r14)
00000000000000ba: 02	je	0x40fa5d <BloombergLP::balb::Sequence1::~Sequence1()+0xcd>
...
00000000000000ea: 02	je	0x40faa1 <BloombergLP::balb::Sequence1::~Sequence1()+0x111>
...
00000000000000fe: 05	callq	0x419cc0 <void BloombergLP::bslalg::ArrayDestructionPrimitives::destroy<BloombergLP::balb::Choice1, bsl::allocator<BloombergLP::balb::Choice1> >(BloombergLP::balb::Choice1*, BloombergLP::balb::Choice1*, bsl::allocator<BloombergLP::balb::Choice1>, bsl::integral_constant<bool, false>)>
...
0000000000000118: 02	je	0x40fb20 <BloombergLP::balb::Sequence1::~Sequence1()+0x190>
000000000000011a: 04	movq	48(%r14), %r15
000000000000011e: 03	cmpq	%r15, %rbx
0000000000000121: 02	jne	0x40fade <BloombergLP::balb::Sequence1::~Sequence1()+0x14e>
0000000000000123: 02	jmp	0x40fb13 <BloombergLP::balb::Sequence1::~Sequence1()+0x183>
0000000000000125: 10	nopw	%cs:(%rax,%rax)
000000000000012f: 01	nop	
0000000000000130: 03	movq	%rbx, %rdi
0000000000000133: 05	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>
0000000000000138: 10	movl	$4294967295, 368(%rbx)
0000000000000142: 07	addq	$384, %rbx
0000000000000149: 03	cmpq	%rbx, %r15
000000000000014c: 02	je	0x40fb0f <BloombergLP::balb::Sequence1::~Sequence1()+0x17f>
000000000000014e: 06	movl	368(%rbx), %eax
0000000000000154: 04	cmpq	$3, %rax
0000000000000158: 02	ja	0x40fac8 <BloombergLP::balb::Sequence1::~Sequence1()+0x138>
000000000000015a: 07	jmpq	*4483232(,%rax,8)
0000000000000161: 05	cmpq	$23, 32(%rbx)
0000000000000166: 02	je	0x40fb05 <BloombergLP::balb::Sequence1::~Sequence1()+0x175>
...
000000000000017d: 02	jmp	0x40fac8 <BloombergLP::balb::Sequence1::~Sequence1()+0x138>
...
0000000000000197: 02	je	0x40fb62 <BloombergLP::balb::Sequence1::~Sequence1()+0x1d2>
0000000000000199: 04	movq	16(%r14), %r15
000000000000019d: 03	cmpq	%r15, %rbx
00000000000001a0: 02	je	0x40fb55 <BloombergLP::balb::Sequence1::~Sequence1()+0x1c5>
00000000000001a2: 10	nopw	%cs:(%rax,%rax)
00000000000001ac: 04	nopl	(%rax)
00000000000001b0: 03	movq	%rbx, %rdi
00000000000001b3: 05	callq	0x4154f0 <BloombergLP::bslstl::Optional_DataImp<BloombergLP::balb::Choice1>::reset()>
00000000000001b8: 04	addq	$40, %rbx
00000000000001bc: 03	cmpq	%rbx, %r15
00000000000001bf: 02	jne	0x40fb40 <BloombergLP::balb::Sequence1::~Sequence1()+0x1b0>
...
00000000000001e3: 05	callq	0x4043c0 <__clang_call_terminate>
00000000000001e8: 03	movq	%rax, %rdi
00000000000001eb: 05	callq	0x4043c0 <__clang_call_terminate>
00000000000001f0: 03	movq	%rax, %rdi
00000000000001f3: 05	callq	0x4043c0 <__clang_call_terminate>
00000000000001f8: 03	movq	%rax, %rdi
00000000000001fb: 05	callq	0x4043c0 <__clang_call_terminate>
...
000000000000020f: 05	callq	0x415230 <bsl::optional<BloombergLP::balb::Choice3, true>::~optional()>
0000000000000214: 04	leaq	72(%r14), %rdi
0000000000000218: 05	callq	0x414cf0 <bsl::vector<BloombergLP::balb::Choice1, bsl::allocator<BloombergLP::balb::Choice1> >::~vector()>
000000000000021d: 04	leaq	40(%r14), %rdi
0000000000000221: 05	callq	0x4152a0 <bsl::vector<BloombergLP::balb::Choice3, bsl::allocator<BloombergLP::balb::Choice3> >::~vector()>
0000000000000226: 04	addq	$8, %r14
000000000000022a: 03	movq	%r14, %rdi
000000000000022d: 05	callq	0x415340 <bsl::vector<BloombergLP::bdlb::NullableValue<BloombergLP::balb::Choice1>, bsl::allocator<BloombergLP::bdlb::NullableValue<BloombergLP::balb::Choice1> > >::~vector()>
...
0000000000000245: 05	callq	0x4043c0 <__clang_call_terminate>
