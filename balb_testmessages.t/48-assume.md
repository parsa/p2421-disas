# `BloombergLP::balb::Choice3::makeSelection4()` - Assumed

```nasm
000000000040aaf0 <BloombergLP::balb::Choice3::makeSelection4()>:
0000000000000000: 01	pushq	%rbx
0000000000000001: 03	movq	%rdi, %rbx
0000000000000004: 06	movl	368(%rdi), %eax
000000000000000a: 04	cmpq	$3, %rax
000000000000000e: 02	ja	0x40ab2d <BloombergLP::balb::Choice3::makeSelection4()+0x3d>
0000000000000010: 07	jmpq	*4481864(,%rax,8)
0000000000000017: 03	movq	%rbx, %rdi
000000000000001a: 05	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>
000000000000001f: 02	jmp	0x40ab2d <BloombergLP::balb::Choice3::makeSelection4()+0x3d>
0000000000000021: 05	cmpq	$23, 32(%rbx)
0000000000000026: 02	je	0x40ab25 <BloombergLP::balb::Choice3::makeSelection4()+0x35>
...
000000000000004d: 02	jmp	0x40ab45 <BloombergLP::balb::Choice3::makeSelection4()+0x55>
