...
0000000000000013: 02	je	0x40e386 <BloombergLP::balb::Sequence4::~Sequence4()+0x46>
0000000000000015: 08	movb	$0, 464(%r14)
000000000000001d: 08	cmpq	$23, 448(%r14)
0000000000000025: 02	je	0x40e37b <BloombergLP::balb::Sequence4::~Sequence4()+0x3b>
...
000000000000004e: 02	je	0x40e3b1 <BloombergLP::balb::Sequence4::~Sequence4()+0x71>
0000000000000050: 08	movb	$0, 376(%r14)
0000000000000058: 07	movq	344(%r14), %rsi
000000000000005f: 03	testq	%rsi, %rsi
0000000000000062: 02	je	0x40e3b1 <BloombergLP::balb::Sequence4::~Sequence4()+0x71>
...
0000000000000079: 02	je	0x40e3cf <BloombergLP::balb::Sequence4::~Sequence4()+0x8f>
...
00000000000000a4: 02	je	0x40e417 <BloombergLP::balb::Sequence4::~Sequence4()+0xd7>
...
00000000000000be: 05	callq	0x419cc0 <void BloombergLP::bslalg::ArrayDestructionPrimitives::destroy<BloombergLP::balb::Choice1, bsl::allocator<BloombergLP::balb::Choice1> >(BloombergLP::balb::Choice1*, BloombergLP::balb::Choice1*, bsl::allocator<BloombergLP::balb::Choice1>, bsl::integral_constant<bool, false>)>
...
00000000000000e1: 02	je	0x40e47e <BloombergLP::balb::Sequence4::~Sequence4()+0x13e>
00000000000000e3: 07	movq	240(%r14), %r15
00000000000000ea: 03	cmpq	%r15, %rbx
00000000000000ed: 02	jne	0x40e451 <BloombergLP::balb::Sequence4::~Sequence4()+0x111>
00000000000000ef: 02	jmp	0x40e46e <BloombergLP::balb::Sequence4::~Sequence4()+0x12e>
...
000000000000010f: 02	je	0x40e467 <BloombergLP::balb::Sequence4::~Sequence4()+0x127>
0000000000000111: 05	cmpq	$23, 32(%rbx)
0000000000000116: 02	je	0x40e440 <BloombergLP::balb::Sequence4::~Sequence4()+0x100>
...
0000000000000125: 02	jmp	0x40e440 <BloombergLP::balb::Sequence4::~Sequence4()+0x100>
...
0000000000000148: 02	je	0x40e4cb <BloombergLP::balb::Sequence4::~Sequence4()+0x18b>
000000000000014a: 07	movq	208(%r14), %r15
0000000000000151: 03	cmpq	%r15, %rbx
0000000000000154: 02	je	0x40e4bb <BloombergLP::balb::Sequence4::~Sequence4()+0x17b>
0000000000000156: 10	nopw	%cs:(%rax,%rax)
0000000000000160: 03	movq	%rbx, %rdi
0000000000000163: 05	callq	0x406b80 <BloombergLP::balb::Sequence3::~Sequence3()>
0000000000000168: 07	addq	$184, %rbx
000000000000016f: 03	cmpq	%rbx, %r15
0000000000000172: 02	jne	0x40e4a0 <BloombergLP::balb::Sequence4::~Sequence4()+0x160>
...
0000000000000195: 02	je	0x40e4e4 <BloombergLP::balb::Sequence4::~Sequence4()+0x1a4>
...
00000000000001ae: 02	je	0x40e4fd <BloombergLP::balb::Sequence4::~Sequence4()+0x1bd>
...
00000000000001c4: 02	je	0x40e551 <BloombergLP::balb::Sequence4::~Sequence4()+0x211>
00000000000001c6: 04	movq	112(%r14), %r15
00000000000001ca: 03	cmpq	%r15, %rbx
00000000000001cd: 02	jne	0x40e529 <BloombergLP::balb::Sequence4::~Sequence4()+0x1e9>
00000000000001cf: 02	jmp	0x40e541 <BloombergLP::balb::Sequence4::~Sequence4()+0x201>
...
00000000000001e7: 02	je	0x40e53d <BloombergLP::balb::Sequence4::~Sequence4()+0x1fd>
00000000000001e9: 03	movq	(%rbx), %rsi
00000000000001ec: 03	testq	%rsi, %rsi
00000000000001ef: 02	je	0x40e520 <BloombergLP::balb::Sequence4::~Sequence4()+0x1e0>
00000000000001f1: 04	movq	24(%rbx), %rdi
00000000000001f5: 03	movq	(%rdi), %rax
00000000000001f8: 03	callq	*24(%rax)
00000000000001fb: 02	jmp	0x40e520 <BloombergLP::balb::Sequence4::~Sequence4()+0x1e0>
...
0000000000000218: 02	je	0x40e564 <BloombergLP::balb::Sequence4::~Sequence4()+0x224>
...
000000000000022b: 02	je	0x40e577 <BloombergLP::balb::Sequence4::~Sequence4()+0x237>
...
000000000000023e: 02	je	0x40e58a <BloombergLP::balb::Sequence4::~Sequence4()+0x24a>
...
0000000000000257: 05	callq	0x4043c0 <__clang_call_terminate>
000000000000025c: 03	movq	%rax, %rdi
000000000000025f: 05	callq	0x4043c0 <__clang_call_terminate>
0000000000000264: 03	movq	%rax, %rdi
0000000000000267: 05	callq	0x4043c0 <__clang_call_terminate>
000000000000026c: 03	movq	%rax, %rdi
000000000000026f: 05	callq	0x4043c0 <__clang_call_terminate>
0000000000000274: 03	movq	%rax, %rdi
0000000000000277: 05	callq	0x4043c0 <__clang_call_terminate>
000000000000027c: 03	movq	%rax, %rdi
000000000000027f: 05	callq	0x4043c0 <__clang_call_terminate>
0000000000000284: 03	movq	%rax, %rdi
0000000000000287: 05	callq	0x4043c0 <__clang_call_terminate>
...
000000000000029f: 05	callq	0x4043c0 <__clang_call_terminate>
00000000000002a4: 03	movq	%rax, %rdi
00000000000002a7: 05	callq	0x4043c0 <__clang_call_terminate>
00000000000002ac: 03	movq	%rax, %rdi
00000000000002af: 05	callq	0x4043c0 <__clang_call_terminate>
00000000000002b4: 03	movq	%rax, %rdi
00000000000002b7: 05	callq	0x4043c0 <__clang_call_terminate>
00000000000002bc: 03	movq	%rax, %rdi
00000000000002bf: 05	callq	0x4043c0 <__clang_call_terminate>
