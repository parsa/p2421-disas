...
M0000000000000010:	je	0x40b1a1 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection2(unsigned char)+0x21>	;  2 bytes
M0000000000000012:	cmpl	$2, %eax	;  3 bytes
M0000000000000015:	je	0x40b1ab <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection2(unsigned char)+0x2b>	;  2 bytes
M0000000000000017:	cmpl	$1, %eax	;  3 bytes
M000000000000001a:	jne	0x40b1c7 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection2(unsigned char)+0x47>	;  2 bytes
M000000000000001c:	movb	%bpl, (%rbx)	;  3 bytes
M000000000000001f:	jmp	0x40b1d4 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection2(unsigned char)+0x54>	;  2 bytes
M0000000000000021:	movq	%rbx, %rdi	;  3 bytes
M0000000000000024:	callq	0x4093b0 <BloombergLP::balb::Sequence6::~Sequence6()>	;  5 bytes
M0000000000000029:	jmp	0x40b1c7 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection2(unsigned char)+0x47>	;  2 bytes
M000000000000002b:	cmpq	$23, 32(%rbx)	;  5 bytes
M0000000000000030:	je	0x40b1bf <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection2(unsigned char)+0x3f>	;  2 bytes
...
M0000000000000061:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
