...
M000000000000000b:	je	0x41531f <bsl::vector<BloombergLP::balb::Choice3, bsl::allocator<BloombergLP::balb::Choice3> >::~vector()+0x7f>	;  2 bytes
M000000000000000d:	movq	%rdi, %r14	;  3 bytes
M0000000000000010:	movq	8(%rdi), %r15	;  4 bytes
M0000000000000014:	cmpq	%r15, %rbx	;  3 bytes
M0000000000000017:	jne	0x4152de <bsl::vector<BloombergLP::balb::Choice3, bsl::allocator<BloombergLP::balb::Choice3> >::~vector()+0x3e>	;  2 bytes
M0000000000000019:	jmp	0x415312 <bsl::vector<BloombergLP::balb::Choice3, bsl::allocator<BloombergLP::balb::Choice3> >::~vector()+0x72>	;  2 bytes
M000000000000001b:	nopl	(%rax,%rax)	;  5 bytes
M0000000000000020:	movq	%rbx, %rdi	;  3 bytes
M0000000000000023:	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>	;  5 bytes
...
M000000000000003c:	je	0x41530f <bsl::vector<BloombergLP::balb::Choice3, bsl::allocator<BloombergLP::balb::Choice3> >::~vector()+0x6f>	;  2 bytes
M000000000000003e:	movl	368(%rbx), %eax	;  6 bytes
M0000000000000044:	cmpq	$3, %rax	;  4 bytes
M0000000000000048:	ja	0x4152c8 <bsl::vector<BloombergLP::balb::Choice3, bsl::allocator<BloombergLP::balb::Choice3> >::~vector()+0x28>	;  2 bytes
M000000000000004a:	jmpq	*4489752(,%rax,8)	;  7 bytes
M0000000000000051:	cmpq	$23, 32(%rbx)	;  5 bytes
M0000000000000056:	je	0x415305 <bsl::vector<BloombergLP::balb::Choice3, bsl::allocator<BloombergLP::balb::Choice3> >::~vector()+0x65>	;  2 bytes
...
M000000000000006d:	jmp	0x4152c8 <bsl::vector<BloombergLP::balb::Choice3, bsl::allocator<BloombergLP::balb::Choice3> >::~vector()+0x28>	;  2 bytes
