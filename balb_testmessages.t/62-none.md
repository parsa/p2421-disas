# `BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)` - Ignored
...
0000000000000009: 02	ja	0x40b447 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x67>
000000000000000b: 03	movq	%rdi, %r14
000000000000000e: 07	jmpq	*4481688(,%rsi,8)
0000000000000015: 07	movl	368(%r14), %eax
000000000000001c: 03	cmpl	$2, %eax
000000000000001f: 06	je	0x40b4d0 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0xf0>
0000000000000025: 02	testl	%eax, %eax
0000000000000027: 06	jne	0x40b4ec <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x10c>
000000000000002d: 03	movq	%r14, %rdi
0000000000000030: 05	callq	0x4093b0 <BloombergLP::balb::Sequence6::~Sequence6()>
0000000000000035: 05	jmp	0x40b4ec <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x10c>
000000000000003a: 07	movl	368(%r14), %eax
0000000000000041: 02	testl	%eax, %eax
0000000000000043: 06	je	0x40b59a <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1ba>
0000000000000049: 03	cmpl	$2, %eax
000000000000004c: 06	je	0x40b5a4 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1c4>
0000000000000052: 03	cmpl	$3, %eax
0000000000000055: 06	jne	0x40b5c0 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1e0>
000000000000005b: 07	movl	$0, (%r14)
0000000000000062: 05	jmp	0x40b609 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x229>
0000000000000067: 05	movl	$4294967295, %ebx
000000000000006c: 05	jmp	0x40b60b <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x22b>
0000000000000071: 07	movl	368(%r14), %eax
0000000000000078: 03	cmpl	$2, %eax
000000000000007b: 06	je	0x40b4fc <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x11c>
0000000000000081: 02	testl	%eax, %eax
0000000000000083: 06	jne	0x40b518 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x138>
0000000000000089: 03	movq	%r14, %rdi
000000000000008c: 05	callq	0x409810 <BloombergLP::balb::Sequence6::reset()>
0000000000000091: 05	jmp	0x40b609 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x229>
0000000000000096: 07	movl	368(%r14), %eax
000000000000009d: 02	testl	%eax, %eax
000000000000009f: 06	je	0x40b5d4 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1f4>
00000000000000a5: 03	cmpl	$2, %eax
00000000000000a8: 06	je	0x40b5de <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1fe>
00000000000000ae: 03	cmpl	$1, %eax
00000000000000b1: 06	jne	0x40b5fa <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x21a>
00000000000000b7: 04	movb	$0, (%r14)
00000000000000bb: 05	jmp	0x40b609 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x229>
00000000000000c0: 07	movl	368(%r14), %eax
00000000000000c7: 02	testl	%eax, %eax
00000000000000c9: 06	je	0x40b542 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x162>
00000000000000cf: 03	cmpl	$2, %eax
00000000000000d2: 06	jne	0x40b54a <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x16a>
...
00000000000000eb: 05	jmp	0x40b60b <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x22b>
00000000000000f0: 05	cmpq	$23, 32(%r14)
00000000000000f5: 02	je	0x40b4e4 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x104>
...
0000000000000117: 05	jmp	0x40b609 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x229>
000000000000011c: 05	cmpq	$23, 32(%r14)
0000000000000121: 02	je	0x40b510 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x130>
...
000000000000015d: 05	jmp	0x40b609 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x229>
...
000000000000017f: 02	jne	0x40b572 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x192>
0000000000000181: 07	movq	2569704(%rip), %rax  # 67eb50 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000188: 03	testq	%rax, %rax
000000000000018b: 02	jne	0x40b572 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x192>
...
0000000000000199: 07	movaps	240288(%rip), %xmm0  # 446020 <__dso_handle+0x8>
...
00000000000001b8: 02	jmp	0x40b609 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x229>
00000000000001ba: 03	movq	%r14, %rdi
00000000000001bd: 05	callq	0x4093b0 <BloombergLP::balb::Sequence6::~Sequence6()>
00000000000001c2: 02	jmp	0x40b5c0 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1e0>
00000000000001c4: 05	cmpq	$23, 32(%r14)
00000000000001c9: 02	je	0x40b5b8 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x1d8>
...
00000000000001f2: 02	jmp	0x40b609 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x229>
00000000000001f4: 03	movq	%r14, %rdi
00000000000001f7: 05	callq	0x4093b0 <BloombergLP::balb::Sequence6::~Sequence6()>
00000000000001fc: 02	jmp	0x40b5fa <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x21a>
00000000000001fe: 05	cmpq	$23, 32(%r14)
0000000000000203: 02	je	0x40b5f2 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection(int)+0x212>
