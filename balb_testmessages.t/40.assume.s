...
M0000000000000015:	ja	0x40b276 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection3(BloombergLP::balb::CustomString const&)+0x26>	;  2 bytes
M0000000000000017:	jmpq	*4482184(,%rax,8)	;  7 bytes
M000000000000001e:	movq	%rbx, %rdi	;  3 bytes
M0000000000000021:	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>	;  5 bytes
...
M000000000000003a:	jne	0x40b2a0 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection3(BloombergLP::balb::CustomString const&)+0x50>	;  2 bytes
M000000000000003c:	movq	2574525(%rip), %rdi  # 67fb50 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000043:	testq	%rdi, %rdi	;  3 bytes
M0000000000000046:	jne	0x40b2a0 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection3(BloombergLP::balb::CustomString const&)+0x50>	;  2 bytes
M0000000000000048:	callq	0x4206c0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
...
M0000000000000070:	je	0x40b31c <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection3(BloombergLP::balb::CustomString const&)+0xcc>	;  2 bytes
...
M0000000000000096:	jb	0x40b2fb <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection3(BloombergLP::balb::CustomString const&)+0xab>	;  2 bytes
...
M00000000000000a9:	jne	0x40b2fe <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection3(BloombergLP::balb::CustomString const&)+0xae>	;  2 bytes
M00000000000000ab:	movq	%rbx, %rax	;  3 bytes
M00000000000000ae:	movq	24(%rbx), %rdx	;  4 bytes
M00000000000000b2:	incq	%rdx	;  3 bytes
M00000000000000b5:	je	0x40b31c <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection3(BloombergLP::balb::CustomString const&)+0xcc>	;  2 bytes
M00000000000000b7:	cmpq	$23, 32(%r14)	;  5 bytes
M00000000000000bc:	je	0x40b311 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection3(BloombergLP::balb::CustomString const&)+0xc1>	;  2 bytes
M00000000000000be:	movq	(%r14), %r14	;  3 bytes
M00000000000000c1:	movq	%rax, %rdi	;  3 bytes
M00000000000000c4:	movq	%r14, %rsi	;  3 bytes
M00000000000000c7:	callq	0x403a30 <memcpy@plt>	;  5 bytes
...
M00000000000000e2:	je	0x40b326 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection3(BloombergLP::balb::CustomString const&)+0xd6>	;  2 bytes
M00000000000000e4:	movq	24(%r14), %rdx	;  4 bytes
M00000000000000e8:	cmpq	$23, 32(%r14)	;  5 bytes
M00000000000000ed:	je	0x40b342 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection3(BloombergLP::balb::CustomString const&)+0xf2>	;  2 bytes
M00000000000000ef:	movq	(%r14), %r14	;  3 bytes
M00000000000000f2:	movq	24(%rbx), %r15	;  4 bytes
M00000000000000f6:	movq	$0, 24(%rbx)	;  8 bytes
M00000000000000fe:	movl	$4490739, %ecx	;  5 bytes
M0000000000000103:	movq	%rbx, %rdi	;  3 bytes
M0000000000000106:	movq	%r14, %rsi	;  3 bytes
M0000000000000109:	callq	0x422b80 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M000000000000010e:	jmp	0x40b326 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection3(BloombergLP::balb::CustomString const&)+0xd6>	;  2 bytes
M0000000000000110:	movq	%r15, 24(%rbx)	;  4 bytes
M0000000000000114:	movq	%rax, %rdi	;  3 bytes
M0000000000000117:	callq	0x4039f0 <_Unwind_Resume@plt>	;  5 bytes
