# `BloombergLP::balb::Response::selectionName() const` - Ignored

```nasm
00000000004142d0 <BloombergLP::balb::Response::selectionName() const>:
M0000000000000000:	movl	872(%rdi), %eax	;  6 bytes
M0000000000000006:	cmpl	$1, %eax	;  3 bytes
M0000000000000009:	movl	$4488648, %ecx	;  5 bytes
...
M0000000000000019:	movl	$4488635, %eax	;  5 bytes
