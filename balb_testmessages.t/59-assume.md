...
000000000000000a: 06	je	0x40a417 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x1b7>
0000000000000010: 03	movq	%rsi, %rbx
0000000000000013: 06	movl	368(%rsi), %eax
0000000000000019: 04	cmpq	$3, %rax
000000000000001d: 06	ja	0x40a30e <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0xae>
0000000000000023: 07	jmpq	*4481248(,%rax,8)
000000000000002a: 07	movl	368(%r14), %eax
0000000000000031: 04	cmpq	$3, %rax
0000000000000035: 06	ja	0x40a34f <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0xef>
000000000000003b: 07	jmpq	*4481344(,%rax,8)
...
000000000000004d: 05	jmp	0x40a417 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x1b7>
0000000000000052: 02	movb	(%rbx), %bl
0000000000000054: 07	movl	368(%r14), %eax
000000000000005b: 04	cmpq	$3, %rax
000000000000005f: 06	ja	0x40a3a0 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x140>
0000000000000065: 07	jmpq	*4481312(,%rax,8)
000000000000006c: 03	movq	%r14, %rdi
000000000000006f: 05	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>
0000000000000074: 05	jmp	0x40a3a0 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x140>
0000000000000079: 03	movq	%r14, %rdi
000000000000007c: 03	movq	%rbx, %rsi
000000000000007f: 05	callq	0x40a540 <BloombergLP::balb::Choice3::makeSelection3(BloombergLP::balb::CustomString const&)>
0000000000000084: 05	jmp	0x40a417 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x1b7>
0000000000000089: 07	movl	368(%r14), %eax
0000000000000090: 04	cmpq	$3, %rax
0000000000000094: 06	ja	0x40a3cc <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x16c>
000000000000009a: 07	jmpq	*4481280(,%rax,8)
00000000000000a1: 03	movq	%r14, %rdi
00000000000000a4: 05	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>
00000000000000a9: 05	jmp	0x40a3cc <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x16c>
00000000000000ae: 07	movl	368(%r14), %eax
00000000000000b5: 04	cmpq	$3, %rax
00000000000000b9: 06	ja	0x40a40c <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x1ac>
00000000000000bf: 07	jmpq	*4481376(,%rax,8)
00000000000000c6: 03	movq	%r14, %rdi
00000000000000c9: 05	callq	0x409400 <BloombergLP::balb::Sequence6::~Sequence6()>
00000000000000ce: 05	jmp	0x40a40c <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x1ac>
00000000000000d3: 05	cmpq	$23, 32(%r14)
00000000000000d8: 02	je	0x40a347 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0xe7>
...
0000000000000117: 05	jmp	0x40a417 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x1b7>
000000000000011c: 03	movb	%bl, (%r14)
000000000000011f: 05	jmp	0x40a417 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x1b7>
0000000000000124: 05	cmpq	$23, 32(%r14)
0000000000000129: 02	je	0x40a398 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x138>
...
000000000000014e: 02	jmp	0x40a417 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x1b7>
0000000000000150: 05	cmpq	$23, 32(%r14)
0000000000000155: 02	je	0x40a3c4 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x164>
...
0000000000000187: 02	jmp	0x40a417 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x1b7>
0000000000000189: 02	movl	(%rbx), %eax
000000000000018b: 03	movl	%eax, (%r14)
000000000000018e: 02	jmp	0x40a417 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x1b7>
0000000000000190: 05	cmpq	$23, 32(%r14)
0000000000000195: 02	je	0x40a404 <BloombergLP::balb::Choice3::operator=(BloombergLP::balb::Choice3 const&)+0x1a4>
