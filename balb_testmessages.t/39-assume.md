# `BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection1(BloombergLP::balb::Sequence6 const&)` - Assumed

```nasm
000000000040b160 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection1(BloombergLP::balb::Sequence6 const&)>:
...
M0000000000000014:	ja	0x40b1a6 <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection1(BloombergLP::balb::Sequence6 const&)+0x46>	;  2 bytes
M0000000000000016:	jmpq	*4482120(,%rax,8)	;  7 bytes
...
M0000000000000028:	jmp	0x40b1cc <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection1(BloombergLP::balb::Sequence6 const&)+0x6c>	;  2 bytes
M000000000000002a:	cmpq	$23, 32(%rbx)	;  5 bytes
M000000000000002f:	je	0x40b19e <BloombergLP::balb::SequenceWithAnonymityChoice::makeSelection1(BloombergLP::balb::Sequence6 const&)+0x3e>	;  2 bytes
