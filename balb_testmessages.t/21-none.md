# `BloombergLP::balb::SequenceWithAnonymityChoice1::reset()` - Ignored

```nasm
0000000000405330 <BloombergLP::balb::SequenceWithAnonymityChoice1::reset()>:
M0000000000000000:	pushq	%rbx	;  1 bytes
M0000000000000001:	movq	%rdi, %rbx	;  3 bytes
M0000000000000004:	cmpl	$1, 48(%rdi)	;  4 bytes
M0000000000000008:	jne	0x405356 <BloombergLP::balb::SequenceWithAnonymityChoice1::reset()+0x26>	;  2 bytes
M000000000000000a:	cmpq	$23, 32(%rbx)	;  5 bytes
M000000000000000f:	je	0x40534e <BloombergLP::balb::SequenceWithAnonymityChoice1::reset()+0x1e>	;  2 bytes
...
M0000000000000032:	callq	0x4043c0 <__clang_call_terminate>	;  5 bytes
