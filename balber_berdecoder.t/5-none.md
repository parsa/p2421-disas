...
000000000000000a: 02	je	0x45b1be <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x5e>
000000000000000c: 03	cmpl	$1, %esi
000000000000000f: 02	je	0x45b19f <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x3f>
0000000000000011: 05	movl	$4294967295, %ebx
0000000000000016: 02	testl	%esi, %esi
0000000000000018: 06	jne	0x45b25f <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xff>
000000000000001e: 04	movl	48(%r14), %eax
0000000000000022: 03	cmpl	$1, %eax
0000000000000025: 06	je	0x45b232 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xd2>
000000000000002b: 02	testl	%eax, %eax
000000000000002d: 06	jne	0x45b24e <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xee>
0000000000000033: 07	movl	$0, (%r14)
000000000000003a: 05	jmp	0x45b25d <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xfd>
000000000000003f: 05	cmpl	$1, 48(%r14)
0000000000000044: 02	jne	0x45b1eb <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x8b>
...
0000000000000059: 05	jmp	0x45b25f <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xff>
000000000000005e: 05	cmpl	$1, 48(%r14)
0000000000000063: 02	jne	0x45b1e1 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x81>
0000000000000065: 05	cmpq	$23, 32(%r14)
000000000000006a: 02	je	0x45b1d9 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x79>
...
0000000000000089: 02	jmp	0x45b25d <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xfd>
000000000000008b: 08	movl	$4294967295, 48(%r14)
0000000000000093: 04	movq	56(%r14), %rax
0000000000000097: 03	testq	%rax, %rax
000000000000009a: 02	jne	0x45b20d <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xad>
000000000000009c: 07	movq	2736621(%rip), %rax  # 6f73f0 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000000a3: 03	testq	%rax, %rax
00000000000000a6: 02	jne	0x45b20d <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xad>
...
00000000000000b4: 07	movaps	236213(%rip), %xmm0  # 494cd0 <__dso_handle+0x8>
...
00000000000000d0: 02	jmp	0x45b25d <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xfd>
00000000000000d2: 05	cmpq	$23, 32(%r14)
00000000000000d7: 02	je	0x45b246 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xe6>
