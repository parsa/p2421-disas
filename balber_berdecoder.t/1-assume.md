# `int BloombergLP::balber::BerEncoder::encode<unsigned long long>(std::__1::basic_streambuf<char, std::__1::char_traits<char> >*, unsigned long long const&)` - Assumed
...
M0000000000000030:	je	0x44357f <int BloombergLP::balber::BerEncoder::encode<unsigned long long>(std::__1::basic_streambuf<char, std::__1::char_traits<char> >*, unsigned long long const&)+0x4f>	;  2 bytes
...
M000000000000005d:	je	0x4435da <int BloombergLP::balber::BerEncoder::encode<unsigned long long>(std::__1::basic_streambuf<char, std::__1::char_traits<char> >*, unsigned long long const&)+0xaa>	;  2 bytes
...
M000000000000007c:	callq	0x44e2e0 <int BloombergLP::balber::BerEncoder::encodeImpl<unsigned long long>(unsigned long long const&, BloombergLP::balber::BerConstants::TagClass, int, int, BloombergLP::bdlat_TypeCategory::Simple)>	;  5 bytes
M0000000000000081:	testl	%eax, %eax	;  2 bytes
M0000000000000083:	je	0x4435d2 <int BloombergLP::balber::BerEncoder::encode<unsigned long long>(std::__1::basic_streambuf<char, std::__1::char_traits<char> >*, unsigned long long const&)+0xa2>	;  2 bytes
...
M00000000000000a8:	jmp	0x44363c <int BloombergLP::balber::BerEncoder::encode<unsigned long long>(std::__1::basic_streambuf<char, std::__1::char_traits<char> >*, unsigned long long const&)+0x10c>	;  2 bytes
...
M00000000000000d1:	callq	0x44e2e0 <int BloombergLP::balber::BerEncoder::encodeImpl<unsigned long long>(unsigned long long const&, BloombergLP::balber::BerConstants::TagClass, int, int, BloombergLP::bdlat_TypeCategory::Simple)>	;  5 bytes
M00000000000000d6:	testl	%eax, %eax	;  2 bytes
M00000000000000d8:	je	0x443627 <int BloombergLP::balber::BerEncoder::encode<unsigned long long>(std::__1::basic_streambuf<char, std::__1::char_traits<char> >*, unsigned long long const&)+0xf7>	;  2 bytes
