...
0000000000000009: 02	je	0x45ae13 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x83>
000000000000000b: 03	movl	48(%rsi), %eax
000000000000000e: 03	cmpl	$1, %eax
0000000000000011: 02	je	0x45adb9 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x29>
0000000000000013: 02	testl	%eax, %eax
0000000000000015: 02	jne	0x45adc3 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x33>
0000000000000017: 02	movl	(%rsi), %ebp
0000000000000019: 03	movl	48(%rbx), %eax
000000000000001c: 03	cmpl	$1, %eax
000000000000001f: 02	je	0x45adee <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x5e>
0000000000000021: 02	testl	%eax, %eax
0000000000000023: 02	jne	0x45ae0a <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x7a>
0000000000000025: 02	movl	%ebp, (%rbx)
0000000000000027: 02	jmp	0x45ae13 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x83>
0000000000000029: 03	movq	%rbx, %rdi
000000000000002c: 05	callq	0x45ae80 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)>
0000000000000031: 02	jmp	0x45ae13 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x83>
0000000000000033: 04	cmpl	$1, 48(%rbx)
0000000000000037: 02	jne	0x45ade5 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x55>
0000000000000039: 05	cmpq	$23, 32(%rbx)
000000000000003e: 02	je	0x45addd <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x4d>
...
000000000000005c: 02	jmp	0x45ae13 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x83>
000000000000005e: 05	cmpq	$23, 32(%rbx)
0000000000000063: 02	je	0x45ae02 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x72>
