...
M0000000000000009:	je	0x45ae13 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x83>	;  2 bytes
M000000000000000b:	movl	48(%rsi), %eax	;  3 bytes
M000000000000000e:	cmpl	$1, %eax	;  3 bytes
M0000000000000011:	je	0x45adb9 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x29>	;  2 bytes
M0000000000000013:	testl	%eax, %eax	;  2 bytes
M0000000000000015:	jne	0x45adc3 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x33>	;  2 bytes
M0000000000000017:	movl	(%rsi), %ebp	;  2 bytes
M0000000000000019:	movl	48(%rbx), %eax	;  3 bytes
M000000000000001c:	cmpl	$1, %eax	;  3 bytes
M000000000000001f:	je	0x45adee <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x5e>	;  2 bytes
M0000000000000021:	testl	%eax, %eax	;  2 bytes
M0000000000000023:	jne	0x45ae0a <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x7a>	;  2 bytes
M0000000000000025:	movl	%ebp, (%rbx)	;  2 bytes
M0000000000000027:	jmp	0x45ae13 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x83>	;  2 bytes
M0000000000000029:	movq	%rbx, %rdi	;  3 bytes
M000000000000002c:	callq	0x45ae80 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)>	;  5 bytes
M0000000000000031:	jmp	0x45ae13 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x83>	;  2 bytes
M0000000000000033:	cmpl	$1, 48(%rbx)	;  4 bytes
M0000000000000037:	jne	0x45ade5 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x55>	;  2 bytes
M0000000000000039:	cmpq	$23, 32(%rbx)	;  5 bytes
M000000000000003e:	je	0x45addd <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x4d>	;  2 bytes
...
M000000000000005c:	jmp	0x45ae13 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x83>	;  2 bytes
M000000000000005e:	cmpq	$23, 32(%rbx)	;  5 bytes
M0000000000000063:	je	0x45ae02 <BloombergLP::s_baltst::MyChoice::operator=(BloombergLP::s_baltst::MyChoice const&)+0x72>	;  2 bytes
