...
000000000000000e: 02	jne	0x45b090 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >&&)+0x20>
...
000000000000001b: 05	jmp	0x45b152 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >&&)+0xe2>
0000000000000020: 07	movl	$4294967295, 48(%rbx)
0000000000000027: 04	movq	56(%rbx), %rdi
000000000000002b: 03	testq	%rdi, %rdi
000000000000002e: 02	jne	0x45b0b4 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >&&)+0x44>
0000000000000030: 07	movq	2736969(%rip), %rdi  # 6f73f0 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000037: 03	testq	%rdi, %rdi
000000000000003a: 02	jne	0x45b0b4 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >&&)+0x44>
...
0000000000000064: 02	je	0x45b14b <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >&&)+0xdb>
0000000000000066: 04	cmpq	40(%r14), %rdi
000000000000006a: 02	je	0x45b138 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >&&)+0xc8>
...
0000000000000090: 02	jb	0x45b115 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >&&)+0xa5>
...
00000000000000a3: 02	jne	0x45b118 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >&&)+0xa8>
00000000000000a5: 03	movq	%rbx, %rax
00000000000000a8: 04	movq	24(%rbx), %rdx
00000000000000ac: 03	incq	%rdx
00000000000000af: 02	je	0x45b14b <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >&&)+0xdb>
00000000000000b1: 05	cmpq	$23, 32(%r14)
00000000000000b6: 02	je	0x45b12b <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >&&)+0xbb>
...
00000000000000c6: 02	jmp	0x45b14b <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >&&)+0xdb>
00000000000000c8: 07	movq	$0, (%r14)
00000000000000cf: 07	movaps	236426(%rip), %xmm0  # 494cd0 <__dso_handle+0x8>
