# `BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeMyChoice2()` - Assumed

```nasm
000000000045cef0 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeMyChoice2()>:
...
M0000000000000009:	je	0x45cf13 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeMyChoice2()+0x23>	;  2 bytes
M000000000000000b:	cmpl	$1, %eax	;  3 bytes
M000000000000000e:	jne	0x45cf13 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeMyChoice2()+0x23>	;  2 bytes
...
M0000000000000021:	jmp	0x45cf54 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeMyChoice2()+0x64>	;  2 bytes
...
M0000000000000031:	jne	0x45cf34 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeMyChoice2()+0x44>	;  2 bytes
M0000000000000033:	movq	2729158(%rip), %rax  # 6f73f0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M000000000000003a:	testq	%rax, %rax	;  3 bytes
M000000000000003d:	jne	0x45cf34 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeMyChoice2()+0x44>	;  2 bytes
...
M000000000000004b:	movaps	239582(%rip), %xmm0  # 497720 <main::DATA+0x2f0>	;  7 bytes
