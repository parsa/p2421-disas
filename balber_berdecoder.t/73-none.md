# `BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)` - Ignored

```nasm
0000000000469050 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)>:
...
M000000000000002d:	callq	0x469380 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::DatetimeTz*, char const*, int)>	;  5 bytes
M0000000000000032:	testl	%eax, %eax	;  2 bytes
M0000000000000034:	jne	0x4691ae <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x15e>	;  6 bytes
...
M0000000000000058:	jle	0x4691bd <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x16d>	;  6 bytes
M000000000000005e:	movl	$1, %edi	;  5 bytes
M0000000000000063:	movl	$1, %esi	;  5 bytes
M0000000000000068:	movl	$1, %edx	;  5 bytes
M000000000000006d:	callq	0x46a220 <BloombergLP::bdlt::PosixDateImpUtil::ymdToSerial(int, int, int)>	;  5 bytes
...
M00000000000000ba:	jns	0x4692b2 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x262>	;  6 bytes
M00000000000000c0:	movl	$4294967295, %eax	;  5 bytes
M00000000000000c5:	cmpq	%rcx, %rbx	;  3 bytes
M00000000000000c8:	ja	0x4691ae <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x15e>	;  6 bytes
M00000000000000ce:	testq	%r15, %r15	;  3 bytes
M00000000000000d1:	jns	0x4691cf <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x17f>	;  6 bytes
M00000000000000d7:	testl	%ebp, %ebp	;  2 bytes
M00000000000000d9:	je	0x4691a9 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x159>	;  2 bytes
...
M000000000000016f:	js	0x469239 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x1e9>	;  2 bytes
M0000000000000171:	movq	40(%rsp), %r15	;  5 bytes
M0000000000000176:	testq	%r15, %r15	;  3 bytes
M0000000000000179:	js	0x469127 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0xd7>	;  6 bytes
M000000000000017f:	movl	$7304124, %edi	;  5 bytes
M0000000000000184:	callq	0x46f4e0 <BloombergLP::bsls::Review::updateCount(BloombergLP::bsls::Atomic_TypeTraits<BloombergLP::bsls::AtomicOperations_ALL_ALL_ClangIntrinsics>::Int*)>	;  5 bytes
M0000000000000189:	movq	$4827515, (%rsp)	;  8 bytes
M0000000000000191:	movq	$4827569, 8(%rsp)	;  9 bytes
M000000000000019a:	movl	$1126, 16(%rsp)	;  8 bytes
M00000000000001a2:	movq	$5036258, 24(%rsp)	;  9 bytes
M00000000000001ab:	movl	%eax, 32(%rsp)	;  4 bytes
M00000000000001af:	movq	%rsp, %rdi	;  3 bytes
M00000000000001b2:	callq	0x46f500 <BloombergLP::bsls::Review::invokeHandler(BloombergLP::bsls::ReviewViolation const&)>	;  5 bytes
...
M00000000000001de:	jne	0x46912b <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0xdb>	;  6 bytes
M00000000000001e4:	jmp	0x4691a9 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x159>	;  5 bytes
M00000000000001e9:	movl	$9999, %edi	;  5 bytes
M00000000000001ee:	movl	$12, %esi	;  5 bytes
M00000000000001f3:	movl	$31, %edx	;  5 bytes
M00000000000001f8:	callq	0x46a220 <BloombergLP::bdlt::PosixDateImpUtil::ymdToSerial(int, int, int)>	;  5 bytes
...
M000000000000024d:	jns	0x469317 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x2c7>	;  2 bytes
M000000000000024f:	movl	$4294967295, %eax	;  5 bytes
M0000000000000254:	cmpq	%rcx, %rbx	;  3 bytes
M0000000000000257:	jae	0x46911e <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0xce>	;  6 bytes
M000000000000025d:	jmp	0x4691ae <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x15e>	;  5 bytes
M0000000000000262:	movl	$7304124, %edi	;  5 bytes
M0000000000000267:	callq	0x46f4e0 <BloombergLP::bsls::Review::updateCount(BloombergLP::bsls::Atomic_TypeTraits<BloombergLP::bsls::AtomicOperations_ALL_ALL_ClangIntrinsics>::Int*)>	;  5 bytes
M000000000000026c:	movq	$4827515, (%rsp)	;  8 bytes
M0000000000000274:	movq	$4827569, 8(%rsp)	;  9 bytes
M000000000000027d:	movl	$1126, 16(%rsp)	;  8 bytes
M0000000000000285:	movq	$5036258, 24(%rsp)	;  9 bytes
M000000000000028e:	movl	%eax, 32(%rsp)	;  4 bytes
M0000000000000292:	movq	%rsp, %rdi	;  3 bytes
M0000000000000295:	callq	0x46f500 <BloombergLP::bsls::Review::invokeHandler(BloombergLP::bsls::ReviewViolation const&)>	;  5 bytes
...
M00000000000002c2:	jmp	0x469110 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0xc0>	;  5 bytes
M00000000000002c7:	movl	$7304124, %edi	;  5 bytes
M00000000000002cc:	callq	0x46f4e0 <BloombergLP::bsls::Review::updateCount(BloombergLP::bsls::Atomic_TypeTraits<BloombergLP::bsls::AtomicOperations_ALL_ALL_ClangIntrinsics>::Int*)>	;  5 bytes
M00000000000002d1:	movq	$4827515, (%rsp)	;  8 bytes
M00000000000002d9:	movq	$4827569, 8(%rsp)	;  9 bytes
M00000000000002e2:	movl	$1126, 16(%rsp)	;  8 bytes
M00000000000002ea:	movq	$5036258, 24(%rsp)	;  9 bytes
M00000000000002f3:	movl	%eax, 32(%rsp)	;  4 bytes
M00000000000002f7:	movq	%rsp, %rdi	;  3 bytes
M00000000000002fa:	callq	0x46f500 <BloombergLP::bsls::Review::invokeHandler(BloombergLP::bsls::ReviewViolation const&)>	;  5 bytes
...
M0000000000000327:	jmp	0x46929f <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x24f>	;  5 bytes
