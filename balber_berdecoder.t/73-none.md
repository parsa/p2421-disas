...
000000000000002d: 05	callq	0x469380 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::DatetimeTz*, char const*, int)>
0000000000000032: 02	testl	%eax, %eax
0000000000000034: 06	jne	0x4691ae <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x15e>
...
0000000000000058: 06	jle	0x4691bd <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x16d>
000000000000005e: 05	movl	$1, %edi
0000000000000063: 05	movl	$1, %esi
0000000000000068: 05	movl	$1, %edx
000000000000006d: 05	callq	0x46a220 <BloombergLP::bdlt::PosixDateImpUtil::ymdToSerial(int, int, int)>
...
00000000000000ba: 06	jns	0x4692b2 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x262>
00000000000000c0: 05	movl	$4294967295, %eax
00000000000000c5: 03	cmpq	%rcx, %rbx
00000000000000c8: 06	ja	0x4691ae <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x15e>
00000000000000ce: 03	testq	%r15, %r15
00000000000000d1: 06	jns	0x4691cf <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x17f>
00000000000000d7: 02	testl	%ebp, %ebp
00000000000000d9: 02	je	0x4691a9 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x159>
...
000000000000016f: 02	js	0x469239 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x1e9>
0000000000000171: 05	movq	40(%rsp), %r15
0000000000000176: 03	testq	%r15, %r15
0000000000000179: 06	js	0x469127 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0xd7>
000000000000017f: 05	movl	$7304124, %edi
0000000000000184: 05	callq	0x46f4e0 <BloombergLP::bsls::Review::updateCount(BloombergLP::bsls::Atomic_TypeTraits<BloombergLP::bsls::AtomicOperations_ALL_ALL_ClangIntrinsics>::Int*)>
0000000000000189: 08	movq	$4827515, (%rsp)
0000000000000191: 09	movq	$4827569, 8(%rsp)
000000000000019a: 08	movl	$1126, 16(%rsp)
00000000000001a2: 09	movq	$5036258, 24(%rsp)
00000000000001ab: 04	movl	%eax, 32(%rsp)
00000000000001af: 03	movq	%rsp, %rdi
00000000000001b2: 05	callq	0x46f500 <BloombergLP::bsls::Review::invokeHandler(BloombergLP::bsls::ReviewViolation const&)>
...
00000000000001de: 06	jne	0x46912b <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0xdb>
00000000000001e4: 05	jmp	0x4691a9 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x159>
00000000000001e9: 05	movl	$9999, %edi
00000000000001ee: 05	movl	$12, %esi
00000000000001f3: 05	movl	$31, %edx
00000000000001f8: 05	callq	0x46a220 <BloombergLP::bdlt::PosixDateImpUtil::ymdToSerial(int, int, int)>
...
000000000000024d: 02	jns	0x469317 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x2c7>
000000000000024f: 05	movl	$4294967295, %eax
0000000000000254: 03	cmpq	%rcx, %rbx
0000000000000257: 06	jae	0x46911e <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0xce>
000000000000025d: 05	jmp	0x4691ae <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x15e>
0000000000000262: 05	movl	$7304124, %edi
0000000000000267: 05	callq	0x46f4e0 <BloombergLP::bsls::Review::updateCount(BloombergLP::bsls::Atomic_TypeTraits<BloombergLP::bsls::AtomicOperations_ALL_ALL_ClangIntrinsics>::Int*)>
000000000000026c: 08	movq	$4827515, (%rsp)
0000000000000274: 09	movq	$4827569, 8(%rsp)
000000000000027d: 08	movl	$1126, 16(%rsp)
0000000000000285: 09	movq	$5036258, 24(%rsp)
000000000000028e: 04	movl	%eax, 32(%rsp)
0000000000000292: 03	movq	%rsp, %rdi
0000000000000295: 05	callq	0x46f500 <BloombergLP::bsls::Review::invokeHandler(BloombergLP::bsls::ReviewViolation const&)>
...
00000000000002c2: 05	jmp	0x469110 <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0xc0>
00000000000002c7: 05	movl	$7304124, %edi
00000000000002cc: 05	callq	0x46f4e0 <BloombergLP::bsls::Review::updateCount(BloombergLP::bsls::Atomic_TypeTraits<BloombergLP::bsls::AtomicOperations_ALL_ALL_ClangIntrinsics>::Int*)>
00000000000002d1: 08	movq	$4827515, (%rsp)
00000000000002d9: 09	movq	$4827569, 8(%rsp)
00000000000002e2: 08	movl	$1126, 16(%rsp)
00000000000002ea: 09	movq	$5036258, 24(%rsp)
00000000000002f3: 04	movl	%eax, 32(%rsp)
00000000000002f7: 03	movq	%rsp, %rdi
00000000000002fa: 05	callq	0x46f500 <BloombergLP::bsls::Review::invokeHandler(BloombergLP::bsls::ReviewViolation const&)>
...
0000000000000327: 05	jmp	0x46929f <BloombergLP::bdlt::Iso8601Util::parse(BloombergLP::bdlt::Datetime*, char const*, int)+0x24f>
