...
M000000000000000a:	je	0x45cdd4 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x64>	;  2 bytes
M000000000000000c:	cmpl	$1, %esi	;  3 bytes
M000000000000000f:	je	0x45cdaf <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x3f>	;  2 bytes
M0000000000000011:	movl	$4294967295, %ebx	;  5 bytes
M0000000000000016:	testl	%esi, %esi	;  2 bytes
M0000000000000018:	jne	0x45ce7b <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x10b>	;  6 bytes
M000000000000001e:	movl	48(%r14), %eax	;  4 bytes
M0000000000000022:	cmpl	$1, %eax	;  3 bytes
M0000000000000025:	je	0x45ce4e <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xde>	;  6 bytes
M000000000000002b:	testl	%eax, %eax	;  2 bytes
M000000000000002d:	jne	0x45ce6a <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xfa>	;  6 bytes
M0000000000000033:	movl	$0, (%r14)	;  7 bytes
M000000000000003a:	jmp	0x45ce79 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x109>	;  5 bytes
M000000000000003f:	movl	48(%r14), %eax	;  4 bytes
M0000000000000043:	testl	%eax, %eax	;  2 bytes
M0000000000000045:	je	0x45ce07 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x97>	;  2 bytes
M0000000000000047:	cmpl	$1, %eax	;  3 bytes
M000000000000004a:	jne	0x45ce07 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x97>	;  2 bytes
...
M000000000000005f:	jmp	0x45ce7b <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x10b>	;  5 bytes
M0000000000000064:	movl	48(%r14), %eax	;  4 bytes
M0000000000000068:	testl	%eax, %eax	;  2 bytes
M000000000000006a:	je	0x45cdfd <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x8d>	;  2 bytes
M000000000000006c:	cmpl	$1, %eax	;  3 bytes
M000000000000006f:	jne	0x45cdfd <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x8d>	;  2 bytes
M0000000000000071:	cmpq	$23, 32(%r14)	;  5 bytes
M0000000000000076:	je	0x45cdf5 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x85>	;  2 bytes
...
M0000000000000095:	jmp	0x45ce79 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x109>	;  2 bytes
...
M00000000000000a6:	jne	0x45ce29 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xb9>	;  2 bytes
M00000000000000a8:	movq	2729425(%rip), %rax  # 6f73f0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M00000000000000af:	testq	%rax, %rax	;  3 bytes
M00000000000000b2:	jne	0x45ce29 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xb9>	;  2 bytes
...
M00000000000000c0:	movaps	239849(%rip), %xmm0  # 497720 <main::DATA+0x2f0>	;  7 bytes
...
M00000000000000dc:	jmp	0x45ce79 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x109>	;  2 bytes
M00000000000000de:	cmpq	$23, 32(%r14)	;  5 bytes
M00000000000000e3:	je	0x45ce62 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xf2>	;  2 bytes
