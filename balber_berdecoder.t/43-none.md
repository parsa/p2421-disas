...
000000000000000f: 02	jne	0x45aec9 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)+0x49>
0000000000000011: 03	cmpq	%r14, %rbx
0000000000000014: 06	je	0x45af70 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)+0xf0>
000000000000001a: 04	movq	24(%r14), %rdx
000000000000001e: 05	cmpq	$23, 32(%r14)
0000000000000023: 02	je	0x45aea8 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)+0x28>
...
0000000000000044: 05	jmp	0x45af70 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)+0xf0>
0000000000000049: 07	movl	$4294967295, 48(%rbx)
0000000000000050: 04	movq	56(%rbx), %rdi
0000000000000054: 03	testq	%rdi, %rdi
0000000000000057: 02	jne	0x45aeed <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)+0x6d>
0000000000000059: 07	movq	2737424(%rip), %rdi  # 6f73f0 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000060: 03	testq	%rdi, %rdi
0000000000000063: 02	jne	0x45aeed <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)+0x6d>
...
000000000000008d: 02	je	0x45af69 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)+0xe9>
...
00000000000000b3: 02	jb	0x45af48 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)+0xc8>
...
00000000000000c6: 02	jne	0x45af4b <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)+0xcb>
00000000000000c8: 03	movq	%rbx, %rax
00000000000000cb: 04	movq	24(%rbx), %rdx
00000000000000cf: 03	incq	%rdx
00000000000000d2: 02	je	0x45af69 <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)+0xe9>
00000000000000d4: 05	cmpq	$23, 32(%r14)
00000000000000d9: 02	je	0x45af5e <BloombergLP::s_baltst::MyChoice::makeSelection2(bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > const&)+0xde>
