...
M000000000000000a:	je	0x45ccae <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x5e>	;  2 bytes
M000000000000000c:	cmpl	$1, %esi	;  3 bytes
M000000000000000f:	je	0x45cc8f <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x3f>	;  2 bytes
M0000000000000011:	movl	$4294967295, %ebx	;  5 bytes
M0000000000000016:	testl	%esi, %esi	;  2 bytes
M0000000000000018:	jne	0x45cd4f <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xff>	;  6 bytes
M000000000000001e:	movl	48(%r14), %eax	;  4 bytes
M0000000000000022:	cmpl	$1, %eax	;  3 bytes
M0000000000000025:	je	0x45cd22 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xd2>	;  6 bytes
M000000000000002b:	testl	%eax, %eax	;  2 bytes
M000000000000002d:	jne	0x45cd3e <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xee>	;  6 bytes
M0000000000000033:	movl	$0, (%r14)	;  7 bytes
M000000000000003a:	jmp	0x45cd4d <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xfd>	;  5 bytes
M000000000000003f:	cmpl	$1, 48(%r14)	;  5 bytes
M0000000000000044:	jne	0x45ccdb <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x8b>	;  2 bytes
...
M0000000000000059:	jmp	0x45cd4f <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xff>	;  5 bytes
M000000000000005e:	cmpl	$1, 48(%r14)	;  5 bytes
M0000000000000063:	jne	0x45ccd1 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x81>	;  2 bytes
M0000000000000065:	cmpq	$23, 32(%r14)	;  5 bytes
M000000000000006a:	je	0x45ccc9 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0x79>	;  2 bytes
...
M0000000000000089:	jmp	0x45cd4d <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xfd>	;  2 bytes
...
M000000000000009a:	jne	0x45ccfd <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xad>	;  2 bytes
M000000000000009c:	movq	2729725(%rip), %rax  # 6f73f0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M00000000000000a3:	testq	%rax, %rax	;  3 bytes
M00000000000000a6:	jne	0x45ccfd <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xad>	;  2 bytes
...
M00000000000000b4:	movaps	229317(%rip), %xmm0  # 494cd0 <__dso_handle+0x8>	;  7 bytes
...
M00000000000000d0:	jmp	0x45cd4d <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xfd>	;  2 bytes
M00000000000000d2:	cmpq	$23, 32(%r14)	;  5 bytes
M00000000000000d7:	je	0x45cd36 <BloombergLP::s_baltst::MySequenceWithAnonymousChoiceChoice::makeSelection(int)+0xe6>	;  2 bytes
