# `BloombergLP::s_baltst::MyChoice::makeSelection(int)` - Assumed
...
000000000000000a: 02	je	0x45b2a4 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x64>
000000000000000c: 03	cmpl	$1, %esi
000000000000000f: 02	je	0x45b27f <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x3f>
0000000000000011: 05	movl	$4294967295, %ebx
0000000000000016: 02	testl	%esi, %esi
0000000000000018: 06	jne	0x45b34b <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x10b>
000000000000001e: 04	movl	48(%r14), %eax
0000000000000022: 03	cmpl	$1, %eax
0000000000000025: 06	je	0x45b31e <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xde>
000000000000002b: 02	testl	%eax, %eax
000000000000002d: 06	jne	0x45b33a <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xfa>
0000000000000033: 07	movl	$0, (%r14)
000000000000003a: 05	jmp	0x45b349 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x109>
000000000000003f: 04	movl	48(%r14), %eax
0000000000000043: 02	testl	%eax, %eax
0000000000000045: 02	je	0x45b2d7 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x97>
0000000000000047: 03	cmpl	$1, %eax
000000000000004a: 02	jne	0x45b2d7 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x97>
...
000000000000005f: 05	jmp	0x45b34b <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x10b>
0000000000000064: 04	movl	48(%r14), %eax
0000000000000068: 02	testl	%eax, %eax
000000000000006a: 02	je	0x45b2cd <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x8d>
000000000000006c: 03	cmpl	$1, %eax
000000000000006f: 02	jne	0x45b2cd <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x8d>
0000000000000071: 05	cmpq	$23, 32(%r14)
0000000000000076: 02	je	0x45b2c5 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x85>
...
0000000000000095: 02	jmp	0x45b349 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x109>
0000000000000097: 08	movl	$4294967295, 48(%r14)
000000000000009f: 04	movq	56(%r14), %rax
00000000000000a3: 03	testq	%rax, %rax
00000000000000a6: 02	jne	0x45b2f9 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xb9>
00000000000000a8: 07	movq	2736385(%rip), %rax  # 6f73f0 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000000af: 03	testq	%rax, %rax
00000000000000b2: 02	jne	0x45b2f9 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xb9>
...
00000000000000c0: 07	movaps	246809(%rip), %xmm0  # 497720 <main::DATA+0x2f0>
...
00000000000000dc: 02	jmp	0x45b349 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0x109>
00000000000000de: 05	cmpq	$23, 32(%r14)
00000000000000e3: 02	je	0x45b332 <BloombergLP::s_baltst::MyChoice::makeSelection(int)+0xf2>
