...
M0000000000000024:	movq	$4455360, (%rax)	;  7 bytes
...
M0000000000000043:	movaps	615254(%rip), %xmm0  # 4d4370 <__dso_handle+0x8>	;  7 bytes
M000000000000004a:	movups	%xmm0, 40(%rbx)	;  4 bytes
M000000000000004e:	movl	$5080482, %ecx	;  5 bytes
M0000000000000053:	xorl	%esi, %esi	;  2 bytes
M0000000000000055:	xorl	%edx, %edx	;  2 bytes
M0000000000000057:	callq	0x451120 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M000000000000005c:	movq	%rsp, %rdi	;  3 bytes
M000000000000005f:	callq	0x44d1d0 <BloombergLP::bslmt::ThreadAttributes::ThreadAttributes()>	;  5 bytes
M0000000000000064:	movq	%rsp, %rsi	;  3 bytes
M0000000000000067:	movl	$4510144, %edx	;  5 bytes
M000000000000006c:	movq	%r15, %rdi	;  3 bytes
M000000000000006f:	movq	%rbx, %rcx	;  3 bytes
M0000000000000072:	callq	0x44d520 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>	;  5 bytes
M0000000000000077:	movl	%eax, %ebp	;  2 bytes
M0000000000000079:	cmpq	$23, 56(%rsp)	;  6 bytes
M000000000000007f:	je	0x43e061 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<void (*)()>(unsigned long*, void (* const&)(), BloombergLP::bslma::Allocator*)+0x91>	;  2 bytes
...
M0000000000000093:	je	0x43e08e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<void (*)()>(unsigned long*, void (* const&)(), BloombergLP::bslma::Allocator*)+0xbe>	;  2 bytes
M0000000000000095:	cmpq	$23, 48(%rbx)	;  5 bytes
M000000000000009a:	je	0x43e07a <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<void (*)()>(unsigned long*, void (* const&)(), BloombergLP::bslma::Allocator*)+0xaa>	;  2 bytes
...
M00000000000000ce:	callq	0x43e250 <__clang_call_terminate>	;  5 bytes
M00000000000000d3:	movq	%rax, %rdi	;  3 bytes
M00000000000000d6:	callq	0x43e250 <__clang_call_terminate>	;  5 bytes
M00000000000000db:	movq	%rax, %rdi	;  3 bytes
M00000000000000de:	callq	0x43e250 <__clang_call_terminate>	;  5 bytes
M00000000000000e3:	movq	%rax, %r15	;  3 bytes
M00000000000000e6:	cmpq	$23, 56(%rsp)	;  6 bytes
M00000000000000ec:	je	0x43e0db <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<void (*)()>(unsigned long*, void (* const&)(), BloombergLP::bslma::Allocator*)+0x10b>	;  2 bytes
...
M00000000000000fe:	jmp	0x43e0db <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<void (*)()>(unsigned long*, void (* const&)(), BloombergLP::bslma::Allocator*)+0x10b>	;  2 bytes
M0000000000000100:	movq	%rax, %rdi	;  3 bytes
M0000000000000103:	callq	0x43e250 <__clang_call_terminate>	;  5 bytes
M0000000000000108:	movq	%rax, %r15	;  3 bytes
M000000000000010b:	cmpq	$23, 48(%rbx)	;  5 bytes
M0000000000000110:	je	0x43e0f0 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<void (*)()>(unsigned long*, void (* const&)(), BloombergLP::bslma::Allocator*)+0x120>	;  2 bytes
...
M0000000000000134:	jmp	0x43e12d <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<void (*)()>(unsigned long*, void (* const&)(), BloombergLP::bslma::Allocator*)+0x15d>	;  2 bytes
M0000000000000136:	movq	%rax, %rdi	;  3 bytes
M0000000000000139:	callq	0x43e250 <__clang_call_terminate>	;  5 bytes
M000000000000013e:	movq	%rax, %rdi	;  3 bytes
M0000000000000141:	callq	0x43e250 <__clang_call_terminate>	;  5 bytes
...
M0000000000000160:	callq	0x405980 <_Unwind_Resume@plt>	;  5 bytes
M0000000000000165:	movq	%rax, %rdi	;  3 bytes
M0000000000000168:	callq	0x43e250 <__clang_call_terminate>	;  5 bytes
