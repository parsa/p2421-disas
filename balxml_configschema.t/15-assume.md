# `BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)` - Assumed
...
M000000000000002a:	je	0x419714 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xe4>	;  6 bytes
M0000000000000030:	cmpb	$0, 24(%rbx)	;  4 bytes
M0000000000000034:	je	0x41969d <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x6d>	;  2 bytes
...
M0000000000000042:	jne	0x41969d <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x6d>	;  2 bytes
M0000000000000044:	testq	%rax, %rax	;  3 bytes
M0000000000000047:	je	0x419714 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xe4>	;  6 bytes
M000000000000004d:	cmpq	$23, 64(%rbx)	;  5 bytes
M0000000000000052:	je	0x41968a <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x5a>	;  2 bytes
M0000000000000054:	movq	32(%rbx), %rdi	;  4 bytes
M0000000000000058:	jmp	0x41968e <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x5e>	;  2 bytes
...
M000000000000006b:	je	0x419714 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xe4>	;  2 bytes
...
M00000000000000df:	jmp	0x4198a3 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x273>	;  5 bytes
M00000000000000e4:	movb	$1, 8(%rbx)	;  4 bytes
M00000000000000e8:	movq	(%r14), %rax	;  3 bytes
M00000000000000eb:	cmpb	$0, 8(%rax)	;  4 bytes
M00000000000000ef:	je	0x419735 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x105>	;  2 bytes
M00000000000000f1:	movq	%r15, %rdi	;  3 bytes
M00000000000000f4:	movl	%r12d, %esi	;  3 bytes
M00000000000000f7:	callq	0x438770 <BloombergLP::s_baltst::BasicSchemaElementChoice::lookupSelectionInfo(char const*, int)>	;  5 bytes
M00000000000000fc:	testq	%rax, %rax	;  3 bytes
M00000000000000ff:	je	0x41982b <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x1fb>	;  6 bytes
M0000000000000105:	testb	%bpl, %bpl	;  3 bytes
M0000000000000108:	je	0x419781 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x151>	;  2 bytes
...
M0000000000000129:	je	0x41987c <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x24c>	;  6 bytes
M000000000000012f:	cmpl	$1, %eax	;  3 bytes
M0000000000000132:	je	0x419891 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x261>	;  6 bytes
M0000000000000138:	testl	%eax, %eax	;  2 bytes
M000000000000013a:	jne	0x41970a <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xda>	;  2 bytes
M000000000000013c:	movl	558558(%rip), %edx  # 4a1d50 <BloombergLP::s_baltst::BasicSchemaElementChoice::SELECTION_INFO_ARRAY+0x20>	;  6 bytes
...
M000000000000014c:	jmp	0x4198a1 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x271>	;  5 bytes
M0000000000000151:	movq	16(%rbx), %rdi	;  4 bytes
M0000000000000155:	movq	%r15, %rsi	;  3 bytes
M0000000000000158:	movl	%r12d, %edx	;  3 bytes
M000000000000015b:	callq	0x439400 <BloombergLP::s_baltst::BasicSchemaElementChoice::makeSelection(char const*, int)>	;  5 bytes
M0000000000000160:	testl	%eax, %eax	;  2 bytes
M0000000000000162:	je	0x4198b5 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x285>	;  6 bytes
...
M00000000000001f6:	jmp	0x419700 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xd0>	;  5 bytes
...
M000000000000024a:	jmp	0x4198a3 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x273>	;  2 bytes
M000000000000024c:	movq	(%rsi), %rsi	;  3 bytes
M000000000000024f:	movl	558363(%rip), %edx  # 4a1da0 <BloombergLP::s_baltst::BasicSchemaElementChoice::SELECTION_INFO_ARRAY+0x70>	;  6 bytes
...
M000000000000025f:	jmp	0x4198a1 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x271>	;  2 bytes
M0000000000000261:	movl	558305(%rip), %edx  # 4a1d78 <BloombergLP::s_baltst::BasicSchemaElementChoice::SELECTION_INFO_ARRAY+0x48>	;  6 bytes
...
M00000000000002ac:	jmp	0x41973d <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x10d>	;  5 bytes
M00000000000002b1:	jmp	0x4198fd <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x2cd>	;  2 bytes
M00000000000002b3:	jmp	0x41996b <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x33b>	;  5 bytes
...
M00000000000002fe:	jmp	0x419959 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x329>	;  2 bytes
M0000000000000300:	jmp	0x41996b <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x33b>	;  2 bytes
M0000000000000302:	jmp	0x41996b <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x33b>	;  2 bytes
