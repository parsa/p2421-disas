...
000000000000002a: 06	je	0x4203c4 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xe4>
0000000000000030: 04	cmpb	$0, 24(%rbx)
0000000000000034: 02	je	0x42034d <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x6d>
0000000000000036: 03	movq	%r15, %rdi
0000000000000039: 05	callq	0x404780 <strlen@plt>
000000000000003e: 04	cmpq	%rax, 56(%rbx)
0000000000000042: 02	jne	0x42034d <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x6d>
0000000000000044: 03	testq	%rax, %rax
0000000000000047: 06	je	0x4203c4 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xe4>
000000000000004d: 05	cmpq	$23, 64(%rbx)
0000000000000052: 02	je	0x42033a <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x5a>
0000000000000054: 04	movq	32(%rbx), %rdi
0000000000000058: 02	jmp	0x42033e <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x5e>
...
000000000000006b: 02	je	0x4203c4 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xe4>
...
00000000000000df: 05	jmp	0x42055c <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x27c>
00000000000000e4: 04	movb	$1, 8(%rbx)
00000000000000e8: 03	movq	(%r14), %rax
00000000000000eb: 04	cmpb	$0, 8(%rax)
00000000000000ef: 02	je	0x4203e5 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x105>
00000000000000f1: 03	movq	%r15, %rdi
00000000000000f4: 03	movl	%r12d, %esi
00000000000000f7: 05	callq	0x43a6e0 <BloombergLP::s_baltst::BasicSchemaChoice::lookupSelectionInfo(char const*, int)>
00000000000000fc: 03	testq	%rax, %rax
00000000000000ff: 06	je	0x4204e4 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x204>
0000000000000105: 03	testb	%bpl, %bpl
0000000000000108: 02	je	0x42043a <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x15a>
...
0000000000000129: 06	je	0x420535 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x255>
000000000000012f: 03	cmpl	$1, %eax
0000000000000132: 06	je	0x42054a <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x26a>
0000000000000138: 05	movl	$4294967295, %ebx
000000000000013d: 02	testl	%eax, %eax
000000000000013f: 06	jne	0x42055c <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x27c>
0000000000000145: 06	movl	531973(%rip), %edx  # 4a2230 <BloombergLP::s_baltst::BasicSchemaChoice::SELECTION_INFO_ARRAY+0x20>
...
0000000000000155: 05	jmp	0x42055a <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x27a>
000000000000015a: 04	movq	16(%rbx), %rdi
000000000000015e: 03	movq	%r15, %rsi
0000000000000161: 03	movl	%r12d, %edx
0000000000000164: 05	callq	0x43b370 <BloombergLP::s_baltst::BasicSchemaChoice::makeSelection(char const*, int)>
0000000000000169: 02	testl	%eax, %eax
000000000000016b: 06	je	0x42056e <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x28e>
...
00000000000001ff: 05	jmp	0x4203b0 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xd0>
...
0000000000000253: 02	jmp	0x42055c <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x27c>
0000000000000255: 03	movq	(%rsi), %rsi
0000000000000258: 06	movl	531778(%rip), %edx  # 4a2280 <BloombergLP::s_baltst::BasicSchemaChoice::SELECTION_INFO_ARRAY+0x70>
...
0000000000000268: 02	jmp	0x42055a <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x27a>
000000000000026a: 06	movl	531720(%rip), %edx  # 4a2258 <BloombergLP::s_baltst::BasicSchemaChoice::SELECTION_INFO_ARRAY+0x48>
...
00000000000002b5: 05	jmp	0x4203ed <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x10d>
00000000000002ba: 02	jmp	0x4205b6 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x2d6>
00000000000002bc: 05	jmp	0x420624 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x344>
...
0000000000000307: 02	jmp	0x420612 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x332>
0000000000000309: 02	jmp	0x420624 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x344>
000000000000030b: 02	jmp	0x420624 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x344>
