...
M000000000000002a:	je	0x416134 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xe4>	;  6 bytes
M0000000000000030:	cmpb	$0, 24(%rbx)	;  4 bytes
M0000000000000034:	je	0x4160bd <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x6d>	;  2 bytes
...
M0000000000000042:	jne	0x4160bd <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x6d>	;  2 bytes
M0000000000000044:	testq	%rax, %rax	;  3 bytes
M0000000000000047:	je	0x416134 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xe4>	;  6 bytes
M000000000000004d:	cmpq	$23, 64(%rbx)	;  5 bytes
M0000000000000052:	je	0x4160aa <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x5a>	;  2 bytes
M0000000000000054:	movq	32(%rbx), %rdi	;  4 bytes
M0000000000000058:	jmp	0x4160ae <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x5e>	;  2 bytes
...
M000000000000006b:	je	0x416134 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xe4>	;  2 bytes
...
M00000000000000df:	jmp	0x4162a2 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x252>	;  5 bytes
M00000000000000e4:	movb	$1, 8(%rbx)	;  4 bytes
M00000000000000e8:	movq	(%r14), %rax	;  3 bytes
M00000000000000eb:	cmpb	$0, 8(%rax)	;  4 bytes
M00000000000000ef:	je	0x416155 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x105>	;  2 bytes
M00000000000000f1:	movq	%r15, %rdi	;  3 bytes
M00000000000000f4:	movl	%r12d, %esi	;  3 bytes
M00000000000000f7:	callq	0x431e70 <BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice::lookupSelectionInfo(char const*, int)>	;  5 bytes
M00000000000000fc:	testq	%rax, %rax	;  3 bytes
M00000000000000ff:	je	0x41623f <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x1ef>	;  6 bytes
M0000000000000105:	testb	%bpl, %bpl	;  3 bytes
M0000000000000108:	je	0x416195 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x145>	;  2 bytes
...
M0000000000000126:	je	0x416290 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x240>	;  6 bytes
M000000000000012c:	testl	%eax, %eax	;  2 bytes
M000000000000012e:	jne	0x41612a <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xda>	;  2 bytes
M0000000000000130:	movl	571178(%rip), %edx  # 4a18b0 <BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice::SELECTION_INFO_ARRAY+0x20>	;  6 bytes
...
M0000000000000140:	jmp	0x4162a0 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x250>	;  5 bytes
M0000000000000145:	movq	16(%rbx), %rdi	;  4 bytes
M0000000000000149:	movq	%r15, %rsi	;  3 bytes
M000000000000014c:	movl	%r12d, %edx	;  3 bytes
M000000000000014f:	callq	0x432810 <BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice::makeSelection(char const*, int)>	;  5 bytes
M0000000000000154:	testl	%eax, %eax	;  2 bytes
M0000000000000156:	je	0x4162b4 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x264>	;  6 bytes
...
M00000000000001ea:	jmp	0x416120 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0xd0>	;  5 bytes
...
M000000000000023e:	jmp	0x4162a2 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x252>	;  2 bytes
M0000000000000240:	movl	570946(%rip), %edx  # 4a18d8 <BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice::SELECTION_INFO_ARRAY+0x48>	;  6 bytes
M0000000000000246:	leaq	8(%rsp), %rdi	;  5 bytes
M000000000000024b:	callq	0x411be0 <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaRestrictionElement>(BloombergLP::s_baltst::BasicSchemaRestrictionElement*, int, BloombergLP::bdlat_TypeCategory::Sequence)>	;  5 bytes
...
M000000000000028b:	jmp	0x41615d <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x10d>	;  5 bytes
M0000000000000290:	jmp	0x4162fc <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x2ac>	;  2 bytes
M0000000000000292:	jmp	0x41636a <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x31a>	;  5 bytes
...
M00000000000002dd:	jmp	0x416358 <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x308>	;  2 bytes
M00000000000002df:	jmp	0x41636a <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x31a>	;  2 bytes
M00000000000002e1:	jmp	0x41636a <BloombergLP::balxml::Decoder_ChoiceContext<BloombergLP::s_baltst::BasicSchemaSimpleTypeElementChoice>::parseSubElement(char const*, BloombergLP::balxml::Decoder*)+0x31a>	;  2 bytes
