...
0000000000000017: 02	jne	0x410ac5 <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x65>
0000000000000019: 09	movq	$4836304, 8(%rsp)
...
000000000000003a: 07	movaps	562031(%rip), %xmm0  # 499e10 <__dso_handle+0x8>
0000000000000041: 05	movups	%xmm0, 64(%rsp)
0000000000000046: 07	movq	2946643(%rip), %rax  # 6e0100 <BloombergLP::bslma::Default::s_defaultAllocator>
000000000000004d: 03	testq	%rax, %rax
0000000000000050: 06	je	0x410ba6 <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x146>
0000000000000056: 05	movq	%rax, 80(%rsp)
000000000000005b: 05	leaq	40(%rsp), %rcx
0000000000000060: 05	jmp	0x410c2b <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x1cb>
0000000000000065: 03	movq	(%rbx), %rax
0000000000000068: 03	movq	(%rax), %rax
000000000000006b: 04	cmpb	$0, 8(%rax)
000000000000006f: 02	je	0x410ae6 <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x86>
0000000000000071: 04	movq	8(%rbx), %rdi
0000000000000075: 03	movl	16(%rbx), %esi
0000000000000078: 05	callq	0x43a6e0 <BloombergLP::s_baltst::BasicSchemaChoice::lookupSelectionInfo(char const*, int)>
000000000000007d: 03	testq	%rax, %rax
0000000000000080: 06	je	0x410c01 <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x1a1>
0000000000000086: 04	movq	8(%rbx), %rsi
000000000000008a: 03	movl	16(%rbx), %edx
000000000000008d: 03	movq	%r14, %rdi
0000000000000090: 05	callq	0x43b370 <BloombergLP::s_baltst::BasicSchemaChoice::makeSelection(char const*, int)>
0000000000000095: 02	testl	%eax, %eax
0000000000000097: 06	je	0x410bbf <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x15f>
...
0000000000000141: 05	jmp	0x410c71 <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x211>
...
0000000000000156: 02	jne	0x410c26 <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x1c6>
0000000000000158: 05	leaq	40(%rsp), %rcx
000000000000015d: 02	jmp	0x410c2b <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x1cb>
000000000000015f: 07	movl	160(%r14), %eax
0000000000000166: 03	cmpl	$2, %eax
0000000000000169: 06	je	0x410c7f <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x21f>
000000000000016f: 03	cmpl	$1, %eax
0000000000000172: 06	je	0x410c9b <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x23b>
0000000000000178: 05	movl	$4294967295, %ebp
000000000000017d: 02	testl	%eax, %eax
000000000000017f: 06	jne	0x410c71 <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x211>
0000000000000185: 06	movl	595525(%rip), %edx  # 4a2230 <BloombergLP::s_baltst::BasicSchemaChoice::SELECTION_INFO_ARRAY+0x20>
...
00000000000001c4: 02	jmp	0x410c67 <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x207>
...
00000000000001dd: 09	movq	$4836304, 8(%rsp)
00000000000001e6: 06	cmpq	$23, 72(%rsp)
00000000000001ec: 02	je	0x410c5e <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x1fe>
...
0000000000000222: 06	movl	595448(%rip), %edx  # 4a2280 <BloombergLP::s_baltst::BasicSchemaChoice::SELECTION_INFO_ARRAY+0x70>
...
000000000000023b: 06	movl	595383(%rip), %edx  # 4a2258 <BloombergLP::s_baltst::BasicSchemaChoice::SELECTION_INFO_ARRAY+0x48>
...
000000000000025a: 02	jmp	0x410cfe <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x29e>
000000000000025c: 03	movq	%rax, %rdi
000000000000025f: 05	callq	0x40be00 <__clang_call_terminate>
0000000000000264: 05	jmp	0x410d4f <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x2ef>
...
0000000000000274: 09	movq	$4836304, 8(%rsp)
000000000000027d: 06	cmpq	$23, 72(%rsp)
0000000000000283: 02	je	0x410cf5 <int BloombergLP::balxml::Decoder_ParseObject::executeImp<BloombergLP::s_baltst::BasicSchemaChoice>(BloombergLP::s_baltst::BasicSchemaChoice*, int, BloombergLP::bdlat_TypeCategory::Choice)+0x295>
