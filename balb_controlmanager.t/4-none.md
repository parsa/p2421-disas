...
0000000000000004: 07	movq	170741(%rip), %r8  # 437310 <BloombergLP::bdlb::CharType::s_toUpper_p>
...
0000000000000025: 02	je	0x40d851 <BloombergLP::bdlb::String::upperCaseCmp(char const*, char const*, int)+0x41>
0000000000000027: 03	cmpb	%r10b, %r11b
000000000000002a: 02	jne	0x40d851 <BloombergLP::bdlb::String::upperCaseCmp(char const*, char const*, int)+0x41>
000000000000002c: 03	incq	%rax
000000000000002f: 03	cmpq	%rax, %r9
0000000000000032: 02	jne	0x40d820 <BloombergLP::bdlb::String::upperCaseCmp(char const*, char const*, int)+0x10>
