...
0000000000000002: 02	je	0x40d8d4 <BloombergLP::bdlb::String::upperCaseCmp(char const*, char const*, int)+0x34>
0000000000000004: 07	movq	170693(%rip), %r9  # 437370 <BloombergLP::bdlb::CharType::s_toUpper_p>
...
0000000000000024: 02	je	0x40d8e2 <BloombergLP::bdlb::String::upperCaseCmp(char const*, char const*, int)+0x42>
0000000000000026: 02	cmpb	%al, %cl
0000000000000028: 02	jne	0x40d8e2 <BloombergLP::bdlb::String::upperCaseCmp(char const*, char const*, int)+0x42>
000000000000002a: 03	incq	%rdx
000000000000002d: 03	cmpq	%rdx, %r8
0000000000000030: 02	jne	0x40d8b0 <BloombergLP::bdlb::String::upperCaseCmp(char const*, char const*, int)+0x10>
0000000000000032: 02	jmp	0x40d8d7 <BloombergLP::bdlb::String::upperCaseCmp(char const*, char const*, int)+0x37>
