...
M0000000000000033:	callq	0x4790a0 <int BloombergLP::bdlde::Base64Decoder::convert<std::__1::back_insert_iterator<bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > >, char const*>(std::__1::back_insert_iterator<bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > >, int*, int*, char const*, char const*, int)>	;  5 bytes
M0000000000000038:	movl	%eax, %ebp	;  2 bytes
M000000000000003a:	testl	%eax, %eax	;  2 bytes
M000000000000003c:	jns	0x478f8a <BloombergLP::balxml::Decoder_PushParserContext<bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >, BloombergLP::balxml::Base64Parser<bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> > > >::addCharacters(char const*, unsigned long, BloombergLP::balxml::Decoder*)+0xca>	;  6 bytes
