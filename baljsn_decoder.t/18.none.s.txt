...
0000000000000017: 06	ja	0x458384 <int BloombergLP::balb::SequenceWithAnonymityChoice::manipulateSelection<BloombergLP::baljsn::Decoder_ElementVisitor>(BloombergLP::baljsn::Decoder_ElementVisitor&)+0xc4>
000000000000001d: 03	movq	%rdi, %rbx
0000000000000020: 07	jmpq	*5203912(,%rax,8)
0000000000000027: 03	movq	(%rsi), %rdi
000000000000002a: 06	movl	1845600(%rip), %edx  # 61ac50 <BloombergLP::balb::SequenceWithAnonymityChoice::SELECTION_INFO_ARRAY+0x20>
...
000000000000004b: 02	jne	0x458372 <int BloombergLP::balb::SequenceWithAnonymityChoice::manipulateSelection<BloombergLP::baljsn::Decoder_ElementVisitor>(BloombergLP::baljsn::Decoder_ElementVisitor&)+0xb2>
...
0000000000000065: 02	je	0x45838f <int BloombergLP::balb::SequenceWithAnonymityChoice::manipulateSelection<BloombergLP::baljsn::Decoder_ElementVisitor>(BloombergLP::baljsn::Decoder_ElementVisitor&)+0xcf>
...
000000000000007e: 02	jmp	0x458384 <int BloombergLP::balb::SequenceWithAnonymityChoice::manipulateSelection<BloombergLP::baljsn::Decoder_ElementVisitor>(BloombergLP::baljsn::Decoder_ElementVisitor&)+0xc4>
0000000000000080: 03	movq	(%rsi), %rdi
0000000000000083: 06	movl	1845591(%rip), %edx  # 61aca0 <BloombergLP::balb::SequenceWithAnonymityChoice::SELECTION_INFO_ARRAY+0x70>
...
000000000000009c: 06	movl	1845606(%rip), %edx  # 61acc8 <BloombergLP::balb::SequenceWithAnonymityChoice::SELECTION_INFO_ARRAY+0x98>
...
00000000000000d5: 02	je	0x4583c0 <int BloombergLP::balb::SequenceWithAnonymityChoice::manipulateSelection<BloombergLP::baljsn::Decoder_ElementVisitor>(BloombergLP::baljsn::Decoder_ElementVisitor&)+0x100>
...
00000000000000eb: 02	jne	0x458384 <int BloombergLP::balb::SequenceWithAnonymityChoice::manipulateSelection<BloombergLP::baljsn::Decoder_ElementVisitor>(BloombergLP::baljsn::Decoder_ElementVisitor&)+0xc4>
00000000000000ed: 05	movq	24(%rsp), %rax
00000000000000f2: 06	cmpq	$255, %rax
00000000000000f8: 02	ja	0x458384 <int BloombergLP::balb::SequenceWithAnonymityChoice::manipulateSelection<BloombergLP::baljsn::Decoder_ElementVisitor>(BloombergLP::baljsn::Decoder_ElementVisitor&)+0xc4>
00000000000000fa: 02	movb	%al, (%rbx)
00000000000000fc: 02	xorl	%ebp, %ebp
00000000000000fe: 02	jmp	0x458384 <int BloombergLP::balb::SequenceWithAnonymityChoice::manipulateSelection<BloombergLP::baljsn::Decoder_ElementVisitor>(BloombergLP::baljsn::Decoder_ElementVisitor&)+0xc4>
0000000000000100: 05	movl	$4294967295, %ebp
0000000000000105: 02	jmp	0x458384 <int BloombergLP::balb::SequenceWithAnonymityChoice::manipulateSelection<BloombergLP::baljsn::Decoder_ElementVisitor>(BloombergLP::baljsn::Decoder_ElementVisitor&)+0xc4>
