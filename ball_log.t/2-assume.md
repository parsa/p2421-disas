...
M000000000000001d:	je	0x49d4f5 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor const&, BloombergLP::bslma::Allocator*)+0x25>	;  2 bytes
M000000000000001f:	movq	24(%r15), %rbp	;  4 bytes
M0000000000000023:	jmp	0x49d4f9 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor const&, BloombergLP::bslma::Allocator*)+0x29>	;  2 bytes
...
M000000000000003a:	movq	$4838928, (%rax)	;  7 bytes
...
M0000000000000051:	movaps	409912(%rip), %xmm0  # 501660 <__dso_handle+0x18>	;  7 bytes
M0000000000000058:	movups	%xmm0, 40(%rax)	;  4 bytes
M000000000000005c:	movl	$5288010, %ecx	;  5 bytes
M0000000000000061:	movq	%rbp, %rsi	;  3 bytes
M0000000000000064:	movq	%r13, %rdx	;  3 bytes
M0000000000000067:	callq	0x4e01c0 <bsl::basic_string<char, std::__1::char_traits<char>, bsl::allocator<char> >::privateAppend(char const*, unsigned long, char const*)>	;  5 bytes
M000000000000006c:	movl	$5091072, %edx	;  5 bytes
M0000000000000071:	movq	%r12, %rdi	;  3 bytes
M0000000000000074:	movq	%r15, %rsi	;  3 bytes
M0000000000000077:	movq	%rbx, %rcx	;  3 bytes
M000000000000007a:	callq	0x4dc520 <BloombergLP::bslmt::ThreadUtilImpl<BloombergLP::bslmt::Platform::PosixThreads>::create(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, void* (*)(void*), void*)>	;  5 bytes
M000000000000007f:	movl	%eax, %ebp	;  2 bytes
M0000000000000081:	testl	%eax, %eax	;  2 bytes
M0000000000000083:	je	0x49d57e <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor const&, BloombergLP::bslma::Allocator*)+0xae>	;  2 bytes
M0000000000000085:	cmpq	$23, 48(%rbx)	;  5 bytes
M000000000000008a:	je	0x49d56a <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor const&, BloombergLP::bslma::Allocator*)+0x9a>	;  2 bytes
...
M00000000000000c2:	callq	0x450070 <__clang_call_terminate>	;  5 bytes
M00000000000000c7:	movq	%rax, %rdi	;  3 bytes
M00000000000000ca:	callq	0x450070 <__clang_call_terminate>	;  5 bytes
M00000000000000cf:	movq	%rax, %r15	;  3 bytes
M00000000000000d2:	cmpq	$23, 48(%rbx)	;  5 bytes
M00000000000000d7:	je	0x49d5b7 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor const&, BloombergLP::bslma::Allocator*)+0xe7>	;  2 bytes
...
M00000000000000fb:	jmp	0x49d5f4 <int BloombergLP::bslmt::ThreadUtil::createWithAllocator<BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor>(unsigned long*, BloombergLP::bslmt::ThreadAttributes const&, BALL_LOG_TEST_CASE_MINUS_1::ThreadFunctor const&, BloombergLP::bslma::Allocator*)+0x124>	;  2 bytes
M00000000000000fd:	movq	%rax, %rdi	;  3 bytes
M0000000000000100:	callq	0x450070 <__clang_call_terminate>	;  5 bytes
M0000000000000105:	movq	%rax, %rdi	;  3 bytes
M0000000000000108:	callq	0x450070 <__clang_call_terminate>	;  5 bytes
...
M0000000000000127:	callq	0x407a80 <_Unwind_Resume@plt>	;  5 bytes
M000000000000012c:	movq	%rax, %rdi	;  3 bytes
M000000000000012f:	callq	0x450070 <__clang_call_terminate>	;  5 bytes
