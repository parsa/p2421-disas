# `void testCopyConstructWithIterators<int const*>(bool, bool, bool)` - Assumed

```nasm
00000000004ca2a0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)>:
...
M0000000000000016:	cmpb	$0, 2418393(%rip)  # 718996 <verbose>	;  7 bytes
M000000000000001d:	je	0x4ca2c9 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x29>	;  2 bytes
...
M000000000000002b:	jmp	0x4ca2fc <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x5c>	;  2 bytes
M000000000000002d:	nopl	(%rax)	;  3 bytes
M0000000000000030:	movl	$7665888, %edi	;  5 bytes
M0000000000000035:	movq	%rbp, %rsi	;  3 bytes
M0000000000000038:	callq	0x4e2e60 <void verify<int const*>(int const**, char const*)>	;  5 bytes
M000000000000003d:	movl	$7665888, %edi	;  5 bytes
M0000000000000042:	movq	%rbp, %rsi	;  3 bytes
M0000000000000045:	callq	0x4e30a0 <void cleanup<int const*>(int const**, char const*)>	;  5 bytes
M000000000000004a:	movq	24(%rsp), %rax	;  5 bytes
M000000000000004f:	incq	%rax	;  3 bytes
M0000000000000052:	cmpq	$30, %rax	;  4 bytes
M0000000000000056:	je	0x4ca839 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x599>	;  6 bytes
...
M000000000000007c:	jl	0x4ca347 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xa7>	;  2 bytes
...
M0000000000000094:	movl	2418270(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
M000000000000009a:	cmpl	$100, %eax	;  3 bytes
M000000000000009d:	ja	0x4ca347 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xa7>	;  2 bytes
M000000000000009f:	incl	%eax	;  2 bytes
M00000000000000a1:	movl	%eax, 2418257(%rip)  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
...
M00000000000000ce:	cmpb	$0, 2418203(%rip)  # 718990 <veryVerbose>	;  7 bytes
M00000000000000d5:	je	0x4ca396 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xf6>	;  2 bytes
...
M00000000000000fb:	movl	$7665888, %edi	;  5 bytes
M0000000000000100:	movq	%r12, %rsi	;  3 bytes
M0000000000000103:	callq	0x4e2d80 <int const*& gg<int const*>(int const**, char const*)>	;  5 bytes
M0000000000000108:	movl	$7665888, %edi	;  5 bytes
M000000000000010d:	movq	%r12, %rsi	;  3 bytes
M0000000000000110:	callq	0x4e2e60 <void verify<int const*>(int const**, char const*)>	;  5 bytes
M0000000000000115:	movl	2418152(%rip), %r12d  # 7189a4 <numCopyCtorCalls>	;  7 bytes
M000000000000011c:	movl	2418154(%rip), %eax  # 7189ac <numCharCtorCalls>	;  6 bytes
M0000000000000122:	movl	%eax, 20(%rsp)	;  4 bytes
M0000000000000126:	cmpb	$0, 84(%rsp)	;  5 bytes
M000000000000012b:	je	0x4ca4b0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x210>	;  6 bytes
M0000000000000131:	cmpb	$0, 2418104(%rip)  # 718990 <veryVerbose>	;  7 bytes
M0000000000000138:	movl	%r13d, %ebx	;  3 bytes
M000000000000013b:	je	0x4ca3f0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x150>	;  2 bytes
M000000000000013d:	cmpl	$0, 2417084(%rip)  # 7185a0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)::firstTime>	;  7 bytes
M0000000000000144:	je	0x4ca3f0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x150>	;  2 bytes
M0000000000000146:	movl	$5194330, %edi	;  5 bytes
M000000000000014b:	callq	0x401710 <puts@plt>	;  5 bytes
M0000000000000150:	movl	$0, 2417062(%rip)  # 7185a0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)::firstTime>	; 10 bytes
M000000000000015a:	cmpb	$0, 2418068(%rip)  # 718995 <veryVeryVerbose>	;  7 bytes
M0000000000000161:	je	0x4ca40d <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x16d>	;  2 bytes
M0000000000000163:	movl	$5194369, %edi	;  5 bytes
M0000000000000168:	callq	0x401710 <puts@plt>	;  5 bytes
M000000000000016d:	movq	2417676(%rip), %rax  # 718820 <Z>	;  7 bytes
...
M000000000000018d:	je	0x4ca519 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x279>	;  6 bytes
M0000000000000193:	leaq	7665888(,%r15,8), %rsi	;  8 bytes
M000000000000019b:	movq	72(%rsp), %rax	;  5 bytes
M00000000000001a0:	addl	%r15d, %eax	;  3 bytes
M00000000000001a3:	cltq		;  2 bytes
M00000000000001a5:	leaq	7665888(,%rax,8), %rdx	;  8 bytes
M00000000000001ad:	subq	%rsi, %rdx	;  3 bytes
M00000000000001b0:	je	0x4ca45f <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x1bf>	;  2 bytes
M00000000000001b2:	leaq	7665888(,%r14,8), %rdi	;  8 bytes
...
M00000000000001d3:	cmpb	$0, 2417947(%rip)  # 718995 <veryVeryVerbose>	;  7 bytes
M00000000000001da:	je	0x4ca486 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x1e6>	;  2 bytes
M00000000000001dc:	movl	$5194721, %edi	;  5 bytes
M00000000000001e1:	callq	0x401710 <puts@plt>	;  5 bytes
M00000000000001e6:	cmpb	$0, 2417923(%rip)  # 718990 <veryVerbose>	;  7 bytes
M00000000000001ed:	je	0x4ca75b <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x4bb>	;  6 bytes
M00000000000001f3:	movl	$10, %edi	;  5 bytes
M00000000000001f8:	callq	0x401720 <putchar@plt>	;  5 bytes
M00000000000001fd:	jmp	0x4ca731 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x491>	;  5 bytes
M0000000000000202:	nopw	%cs:(%rax,%rax)	; 10 bytes
M000000000000020c:	nopl	(%rax)	;  4 bytes
M0000000000000210:	cmpq	$0, 2417512(%rip)  # 718820 <Z>	;  8 bytes
M0000000000000218:	movl	%r13d, %ebx	;  3 bytes
M000000000000021b:	jne	0x4ca4cd <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x22d>	;  2 bytes
M000000000000021d:	movq	2649588(%rip), %rax  # 7512b8 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000224:	testq	%rax, %rax	;  3 bytes
M0000000000000227:	je	0x4ca5d3 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x333>	;  6 bytes
M000000000000022d:	cmpq	$6, 24(%rsp)	;  6 bytes
M0000000000000233:	jb	0x4ca731 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x491>	;  6 bytes
M0000000000000239:	leaq	7665888(,%r15,8), %rax	;  8 bytes
M0000000000000241:	leaq	7665888(,%r14,8), %rcx	;  8 bytes
...
M000000000000026f:	jae	0x4ca58d <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x2ed>	;  2 bytes
M0000000000000271:	movl	%r13d, %ebx	;  3 bytes
M0000000000000274:	jmp	0x4ca710 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x470>	;  5 bytes
M0000000000000279:	movl	$1, %r13d	;  6 bytes
M000000000000027f:	movq	2649490(%rip), %rax  # 7512b8 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000286:	testq	%rax, %rax	;  3 bytes
M0000000000000289:	jne	0x4ca433 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x193>	;  6 bytes
M000000000000028f:	callq	0x4eec50 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
M0000000000000294:	jmp	0x4ca433 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x193>	;  5 bytes
M0000000000000299:	cmpl	$1, %edx	;  3 bytes
M000000000000029c:	jne	0x4caede <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xc3e>	;  6 bytes
M00000000000002a2:	movq	%rax, %rdi	;  3 bytes
M00000000000002a5:	callq	0x4016b0 <__cxa_begin_catch@plt>	;  5 bytes
M00000000000002aa:	cmpb	$0, 2417732(%rip)  # 718995 <veryVeryVerbose>	;  7 bytes
M00000000000002b1:	je	0x4ca566 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x2c6>	;  2 bytes
...
M00000000000002de:	cmpq	$0, 2417306(%rip)  # 718820 <Z>	;  8 bytes
M00000000000002e6:	je	0x4ca51f <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x27f>	;  2 bytes
M00000000000002e8:	jmp	0x4ca433 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x193>	;  5 bytes
M00000000000002ed:	movq	%rbp, %r11	;  3 bytes
M00000000000002f0:	leaq	7665888(,%r14,8), %rsi	;  8 bytes
M00000000000002f8:	leal	(%rbx,%r15), %edx	;  4 bytes
M00000000000002fc:	movslq	%edx, %rdx	;  3 bytes
M00000000000002ff:	leaq	7665888(,%rdx,8), %rbp	;  8 bytes
M0000000000000307:	cmpq	%rbp, %rsi	;  3 bytes
M000000000000030a:	jae	0x4ca5e9 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x349>	;  2 bytes
M000000000000030c:	shlq	$3, %rdx	;  4 bytes
M0000000000000310:	subq	%rdi, %rdx	;  3 bytes
M0000000000000313:	leaq	7665888(%rdx,%r14,8), %rdx	;  8 bytes
M000000000000031b:	leaq	7665888(,%r15,8), %rsi	;  8 bytes
M0000000000000323:	cmpq	%rdx, %rsi	;  3 bytes
M0000000000000326:	jae	0x4ca5e9 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x349>	;  2 bytes
M0000000000000328:	movq	%r11, %rbp	;  3 bytes
M000000000000032b:	movl	%r13d, %ebx	;  3 bytes
M000000000000032e:	jmp	0x4ca710 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x470>	;  5 bytes
...
M000000000000033e:	jae	0x4ca4d9 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x239>	;  6 bytes
M0000000000000344:	jmp	0x4ca731 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x491>	;  5 bytes
...
M000000000000036e:	jae	0x4ca617 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x377>	;  2 bytes
M0000000000000370:	xorl	%ebx, %ebx	;  2 bytes
M0000000000000372:	jmp	0x4ca6a0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x400>	;  5 bytes
M0000000000000377:	andq	$-4, %rbp	;  4 bytes
M000000000000037b:	negq	%rbp	;  3 bytes
M000000000000037e:	movl	$7665888, %esi	;  5 bytes
...
M00000000000003fe:	jne	0x4ca630 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x390>	;  2 bytes
M0000000000000400:	testq	%rdx, %rdx	;  3 bytes
M0000000000000403:	je	0x4ca6f3 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x453>	;  2 bytes
M0000000000000405:	shlq	$3, %r14	;  4 bytes
M0000000000000409:	leaq	7665888(,%rbx,8), %rsi	;  8 bytes
M0000000000000411:	negq	%rdx	;  3 bytes
M0000000000000414:	nopw	%cs:(%rax,%rax)	; 10 bytes
M000000000000041e:	nop		;  2 bytes
M0000000000000420:	movdqu	7665888(%rdi,%rbx,8), %xmm0	;  9 bytes
M0000000000000429:	movdqu	7665904(%rdi,%rbx,8), %xmm1	;  9 bytes
M0000000000000432:	movdqu	%xmm0, 7665888(%r14,%rbx,8)	; 10 bytes
M000000000000043c:	movdqu	%xmm1, 7665904(%r14,%rbx,8)	; 10 bytes
M0000000000000446:	addq	$4, %rbx	;  4 bytes
M000000000000044a:	addq	$32, %rsi	;  4 bytes
M000000000000044e:	incq	%rdx	;  3 bytes
M0000000000000451:	jne	0x4ca6c0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x420>	;  2 bytes
M0000000000000453:	cmpq	%r8, %r10	;  3 bytes
M0000000000000456:	movq	%r11, %rbp	;  3 bytes
M0000000000000459:	movl	%r13d, %ebx	;  3 bytes
M000000000000045c:	je	0x4ca731 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x491>	;  2 bytes
...
M0000000000000473:	leaq	7665888(%r9), %rdx	;  7 bytes
...
M000000000000048f:	jne	0x4ca720 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x480>	;  2 bytes
M0000000000000491:	cmpb	$0, 2417240(%rip)  # 718990 <veryVerbose>	;  7 bytes
M0000000000000498:	je	0x4ca75b <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x4bb>	;  2 bytes
M000000000000049a:	movl	2417252(%rip), %edx  # 7189a4 <numCopyCtorCalls>	;  6 bytes
M00000000000004a0:	subl	%r12d, %edx	;  3 bytes
M00000000000004a3:	movl	2417251(%rip), %ecx  # 7189ac <numCharCtorCalls>	;  6 bytes
...
M00000000000004c0:	je	0x4ca7c0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x520>	;  2 bytes
M00000000000004c2:	cmpl	2417211(%rip), %r12d  # 7189a4 <numCopyCtorCalls>	;  7 bytes
M00000000000004c9:	je	0x4ca794 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x4f4>	;  2 bytes
...
M00000000000004e1:	movl	2417169(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
M00000000000004e7:	cmpl	$100, %eax	;  3 bytes
M00000000000004ea:	ja	0x4ca794 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x4f4>	;  2 bytes
M00000000000004ec:	incl	%eax	;  2 bytes
M00000000000004ee:	movl	%eax, 2417156(%rip)  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
M00000000000004f4:	movl	20(%rsp), %eax	;  4 bytes
M00000000000004f8:	cmpl	2417166(%rip), %eax  # 7189ac <numCharCtorCalls>	;  6 bytes
M00000000000004fe:	je	0x4ca2d0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x30>	;  6 bytes
...
M0000000000000513:	jmp	0x4ca816 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x576>	;  2 bytes
M0000000000000515:	nopw	%cs:(%rax,%rax)	; 10 bytes
M000000000000051f:	nop		;  1 bytes
M0000000000000520:	addl	72(%rsp), %r12d	;  5 bytes
M0000000000000525:	cmpl	2417112(%rip), %r12d  # 7189a4 <numCopyCtorCalls>	;  7 bytes
M000000000000052c:	jle	0x4ca7f7 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x557>	;  2 bytes
...
M0000000000000544:	movl	2417070(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
M000000000000054a:	cmpl	$100, %eax	;  3 bytes
M000000000000054d:	ja	0x4ca7f7 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x557>	;  2 bytes
M000000000000054f:	incl	%eax	;  2 bytes
M0000000000000551:	movl	%eax, 2417057(%rip)  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
M0000000000000557:	movl	20(%rsp), %eax	;  4 bytes
M000000000000055b:	cmpl	2417067(%rip), %eax  # 7189ac <numCharCtorCalls>	;  6 bytes
M0000000000000561:	je	0x4ca2d0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x30>	;  6 bytes
...
M000000000000057d:	movl	2417013(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
M0000000000000583:	cmpl	$100, %eax	;  3 bytes
M0000000000000586:	ja	0x4ca2d0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x30>	;  6 bytes
M000000000000058c:	incl	%eax	;  2 bytes
M000000000000058e:	movl	%eax, 2416996(%rip)  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
M0000000000000594:	jmp	0x4ca2d0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x30>	;  5 bytes
M0000000000000599:	cmpb	$0, 2416982(%rip)  # 718996 <verbose>	;  7 bytes
M00000000000005a0:	je	0x4ca84c <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x5ac>	;  2 bytes
...
M00000000000005af:	jmp	0x4ca887 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x5e7>	;  2 bytes
...
M00000000000005c8:	callq	0x4e2e60 <void verify<int const*>(int const**, char const*)>	;  5 bytes
M00000000000005cd:	movl	$7665888, %edi	;  5 bytes
M00000000000005d2:	movq	%rbx, %rsi	;  3 bytes
M00000000000005d5:	callq	0x4e30a0 <void cleanup<int const*>(int const**, char const*)>	;  5 bytes
M00000000000005da:	incq	%r12	;  3 bytes
M00000000000005dd:	cmpq	$30, %r12	;  4 bytes
M00000000000005e1:	je	0x4caead <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xc0d>	;  6 bytes
...
M0000000000000602:	jl	0x4ca8cd <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x62d>	;  2 bytes
...
M000000000000061a:	movl	2416856(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
M0000000000000620:	cmpl	$100, %eax	;  3 bytes
M0000000000000623:	ja	0x4ca8cd <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x62d>	;  2 bytes
M0000000000000625:	incl	%eax	;  2 bytes
M0000000000000627:	movl	%eax, 2416843(%rip)  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
...
M0000000000000639:	jb	0x4ca904 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x664>	;  2 bytes
...
M0000000000000651:	movl	2416801(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
M0000000000000657:	cmpl	$100, %eax	;  3 bytes
M000000000000065a:	ja	0x4ca904 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x664>	;  2 bytes
M000000000000065c:	incl	%eax	;  2 bytes
M000000000000065e:	movl	%eax, 2416788(%rip)  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
...
M0000000000000680:	je	0x4ca940 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x6a0>	;  2 bytes
...
M000000000000069e:	jne	0x4ca930 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x690>	;  2 bytes
...
M00000000000006c8:	cmpb	$0, 2416673(%rip)  # 718990 <veryVerbose>	;  7 bytes
M00000000000006cf:	je	0x4ca990 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x6f0>	;  2 bytes
...
M00000000000006f8:	callq	0x4e2d80 <int const*& gg<int const*>(int const**, char const*)>	;  5 bytes
M00000000000006fd:	movl	$7665888, %edi	;  5 bytes
M0000000000000702:	movq	%rbp, %rsi	;  3 bytes
M0000000000000705:	callq	0x4e2e60 <void verify<int const*>(int const**, char const*)>	;  5 bytes
M000000000000070a:	movl	2416628(%rip), %eax  # 7189a4 <numCopyCtorCalls>	;  6 bytes
M0000000000000710:	movl	%eax, 20(%rsp)	;  4 bytes
M0000000000000714:	movl	2416626(%rip), %eax  # 7189ac <numCharCtorCalls>	;  6 bytes
M000000000000071a:	movl	%eax, 72(%rsp)	;  4 bytes
M000000000000071e:	cmpb	$0, 84(%rsp)	;  5 bytes
M0000000000000723:	je	0x4caa90 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x7f0>	;  6 bytes
M0000000000000729:	cmpb	$0, 2416576(%rip)  # 718990 <veryVerbose>	;  7 bytes
M0000000000000730:	movl	%r14d, %ebp	;  3 bytes
M0000000000000733:	je	0x4ca9e8 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x748>	;  2 bytes
M0000000000000735:	cmpl	$0, 2415560(%rip)  # 7185a4 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)::firstTime>	;  7 bytes
M000000000000073c:	je	0x4ca9e8 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x748>	;  2 bytes
M000000000000073e:	movl	$5194330, %edi	;  5 bytes
M0000000000000743:	callq	0x401710 <puts@plt>	;  5 bytes
M0000000000000748:	movl	$0, 2415538(%rip)  # 7185a4 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)::firstTime>	; 10 bytes
M0000000000000752:	cmpb	$0, 2416540(%rip)  # 718995 <veryVeryVerbose>	;  7 bytes
M0000000000000759:	je	0x4caa05 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x765>	;  2 bytes
M000000000000075b:	movl	$5194369, %edi	;  5 bytes
M0000000000000760:	callq	0x401710 <puts@plt>	;  5 bytes
M0000000000000765:	movq	2416148(%rip), %rax  # 718820 <Z>	;  7 bytes
...
M0000000000000785:	je	0x4cab1d <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x87d>	;  6 bytes
M000000000000078b:	cmpq	$6, 24(%rsp)	;  6 bytes
M0000000000000791:	jb	0x4cae01 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xb61>	;  6 bytes
...
M00000000000007b6:	jb	0x4cade6 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xb46>	;  6 bytes
...
M00000000000007dd:	jae	0x4cacd6 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xa36>	;  6 bytes
M00000000000007e3:	xorl	%ebx, %ebx	;  2 bytes
M00000000000007e5:	jmp	0x4cad85 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xae5>	;  5 bytes
M00000000000007ea:	nopw	(%rax,%rax)	;  6 bytes
M00000000000007f0:	cmpq	$0, 2416008(%rip)  # 718820 <Z>	;  8 bytes
M00000000000007f8:	movl	%r14d, %ebp	;  3 bytes
M00000000000007fb:	movq	%r12, %r11	;  3 bytes
M00000000000007fe:	jne	0x4caac0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x820>	;  2 bytes
M0000000000000800:	movq	2648081(%rip), %rax  # 7512b8 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000807:	testq	%rax, %rax	;  3 bytes
M000000000000080a:	jne	0x4caac0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x820>	;  2 bytes
...
M0000000000000829:	jb	0x4cae40 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xba0>	;  6 bytes
...
M0000000000000849:	jb	0x4cacaa <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xa0a>	;  6 bytes
...
M0000000000000870:	jae	0x4cab9d <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x8fd>	;  6 bytes
M0000000000000876:	xorl	%ebx, %ebx	;  2 bytes
M0000000000000878:	jmp	0x4cac45 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x9a5>	;  5 bytes
M000000000000087d:	movl	$1, %eax	;  5 bytes
M0000000000000882:	movq	%rax, 64(%rsp)	;  5 bytes
M0000000000000887:	movq	2647946(%rip), %rax  # 7512b8 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M000000000000088e:	testq	%rax, %rax	;  3 bytes
M0000000000000891:	jne	0x4caa2b <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x78b>	;  6 bytes
M0000000000000897:	callq	0x4eec50 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
M000000000000089c:	jmp	0x4caa2b <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x78b>	;  5 bytes
M00000000000008a1:	cmpl	$1, %edx	;  3 bytes
M00000000000008a4:	jne	0x4caede <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xc3e>	;  6 bytes
M00000000000008aa:	movq	%rax, %rdi	;  3 bytes
M00000000000008ad:	callq	0x4016b0 <__cxa_begin_catch@plt>	;  5 bytes
M00000000000008b2:	cmpb	$0, 2416188(%rip)  # 718995 <veryVeryVerbose>	;  7 bytes
M00000000000008b9:	je	0x4cab72 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x8d2>	;  2 bytes
...
M00000000000008ee:	cmpq	$0, 2415754(%rip)  # 718820 <Z>	;  8 bytes
M00000000000008f6:	je	0x4cab27 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x887>	;  2 bytes
M00000000000008f8:	jmp	0x4caa2b <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x78b>	;  5 bytes
...
M000000000000099f:	jne	0x4cabb0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x910>	;  6 bytes
M00000000000009a5:	testq	%rbp, %rbp	;  3 bytes
M00000000000009a8:	je	0x4cac94 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x9f4>	;  2 bytes
...
M00000000000009f2:	jne	0x4cac70 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x9d0>	;  2 bytes
M00000000000009f4:	cmpq	%r8, %r9	;  3 bytes
M00000000000009f7:	movq	%r10, %rbx	;  3 bytes
M00000000000009fa:	movl	%r14d, %ebp	;  3 bytes
M00000000000009fd:	je	0x4cae40 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xba0>	;  6 bytes
...
M0000000000000a2f:	jne	0x4cacc0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xa20>	;  2 bytes
M0000000000000a31:	jmp	0x4cae40 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xba0>	;  5 bytes
...
M0000000000000adf:	jne	0x4cacf0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xa50>	;  6 bytes
M0000000000000ae5:	testq	%rdi, %rdi	;  3 bytes
M0000000000000ae8:	je	0x4cadd4 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xb34>	;  2 bytes
...
M0000000000000b32:	jne	0x4cadb0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xb10>	;  2 bytes
M0000000000000b34:	cmpq	%r8, %r10	;  3 bytes
M0000000000000b37:	movq	%r11, %rbx	;  3 bytes
M0000000000000b3a:	movl	%r14d, %ebp	;  3 bytes
M0000000000000b3d:	je	0x4cae01 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xb61>	;  2 bytes
...
M0000000000000b5f:	jne	0x4cadf0 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xb50>	;  2 bytes
...
M0000000000000b75:	cmpb	$0, 2415481(%rip)  # 718995 <veryVeryVerbose>	;  7 bytes
M0000000000000b7c:	movq	24(%rsp), %r12	;  5 bytes
M0000000000000b81:	je	0x4cae2d <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xb8d>	;  2 bytes
M0000000000000b83:	movl	$5194721, %edi	;  5 bytes
M0000000000000b88:	callq	0x401710 <puts@plt>	;  5 bytes
M0000000000000b8d:	cmpb	$0, 2415452(%rip)  # 718990 <veryVerbose>	;  7 bytes
M0000000000000b94:	je	0x4cae6b <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xbcb>	;  2 bytes
M0000000000000b96:	movl	$10, %edi	;  5 bytes
M0000000000000b9b:	callq	0x401720 <putchar@plt>	;  5 bytes
M0000000000000ba0:	cmpb	$0, 2415433(%rip)  # 718990 <veryVerbose>	;  7 bytes
M0000000000000ba7:	je	0x4cae6b <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xbcb>	;  2 bytes
M0000000000000ba9:	movl	2415445(%rip), %edx  # 7189a4 <numCopyCtorCalls>	;  6 bytes
M0000000000000baf:	subl	20(%rsp), %edx	;  4 bytes
M0000000000000bb3:	movl	2415443(%rip), %ecx  # 7189ac <numCharCtorCalls>	;  6 bytes
...
M0000000000000bcf:	cmpl	2415407(%rip), %eax  # 7189a4 <numCopyCtorCalls>	;  6 bytes
M0000000000000bd5:	je	0x4ca860 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x5c0>	;  6 bytes
...
M0000000000000bf1:	movl	2415361(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
M0000000000000bf7:	cmpl	$100, %eax	;  3 bytes
M0000000000000bfa:	ja	0x4ca860 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x5c0>	;  6 bytes
M0000000000000c00:	incl	%eax	;  2 bytes
M0000000000000c02:	movl	%eax, 2415344(%rip)  # 718998 <(anonymous namespace)::testStatus>	;  6 bytes
M0000000000000c08:	jmp	0x4ca860 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0x5c0>	;  5 bytes
...
M0000000000000c1c:	jmp	0x4caede <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xc3e>	;  2 bytes
M0000000000000c1e:	movq	%rax, %rbx	;  3 bytes
M0000000000000c21:	callq	0x401850 <__cxa_end_catch@plt>	;  5 bytes
M0000000000000c26:	jmp	0x4caee1 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xc41>	;  2 bytes
M0000000000000c28:	jmp	0x4caede <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xc3e>	;  2 bytes
M0000000000000c2a:	movq	%rax, %rbx	;  3 bytes
M0000000000000c2d:	callq	0x401850 <__cxa_end_catch@plt>	;  5 bytes
M0000000000000c32:	jmp	0x4caee1 <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xc41>	;  2 bytes
M0000000000000c34:	movq	%rax, %rdi	;  3 bytes
M0000000000000c37:	callq	0x40bf90 <__clang_call_terminate>	;  5 bytes
M0000000000000c3c:	jmp	0x4caede <void testCopyConstructWithIterators<int const*>(bool, bool, bool)+0xc3e>	;  2 bytes
