...
0000000000000016: 07	cmpb	$0, 2412089(%rip)  # 718996 <verbose>
000000000000001d: 02	je	0x4cbb69 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x29>
000000000000001f: 05	movl	$5203945, %edi
0000000000000024: 05	callq	0x401710 <puts@plt>
0000000000000029: 02	xorl	%eax, %eax
000000000000002b: 02	jmp	0x4cbb9c <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x5c>
000000000000002d: 03	nopl	(%rax)
0000000000000030: 05	movl	$7666144, %edi
0000000000000035: 03	movq	%rbp, %rsi
0000000000000038: 05	callq	0x4e3860 <void verify<int const volatile*>(int const volatile**, char const*)>
000000000000003d: 05	movl	$7666144, %edi
0000000000000042: 03	movq	%rbp, %rsi
0000000000000045: 05	callq	0x4e3aa0 <void cleanup<int const volatile*>(int const volatile**, char const*)>
000000000000004a: 05	movq	24(%rsp), %rax
000000000000004f: 03	incq	%rax
0000000000000052: 04	cmpq	$30, %rax
0000000000000056: 06	je	0x4cc0d9 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x599>
...
000000000000007c: 02	jl	0x4cbbe7 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xa7>
...
0000000000000094: 06	movl	2411966(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>
000000000000009a: 03	cmpl	$100, %eax
000000000000009d: 02	ja	0x4cbbe7 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xa7>
000000000000009f: 02	incl	%eax
00000000000000a1: 06	movl	%eax, 2411953(%rip)  # 718998 <(anonymous namespace)::testStatus>
...
00000000000000ce: 07	cmpb	$0, 2411899(%rip)  # 718990 <veryVerbose>
00000000000000d5: 02	je	0x4cbc36 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xf6>
...
00000000000000fb: 05	movl	$7666144, %edi
0000000000000100: 03	movq	%r12, %rsi
0000000000000103: 05	callq	0x4e3780 <int const volatile*& gg<int const volatile*>(int const volatile**, char const*)>
0000000000000108: 05	movl	$7666144, %edi
000000000000010d: 03	movq	%r12, %rsi
0000000000000110: 05	callq	0x4e3860 <void verify<int const volatile*>(int const volatile**, char const*)>
0000000000000115: 07	movl	2411848(%rip), %r12d  # 7189a4 <numCopyCtorCalls>
000000000000011c: 06	movl	2411850(%rip), %eax  # 7189ac <numCharCtorCalls>
0000000000000122: 04	movl	%eax, 20(%rsp)
0000000000000126: 05	cmpb	$0, 84(%rsp)
000000000000012b: 06	je	0x4cbd50 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x210>
0000000000000131: 07	cmpb	$0, 2411800(%rip)  # 718990 <veryVerbose>
0000000000000138: 03	movl	%r13d, %ebx
000000000000013b: 02	je	0x4cbc90 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x150>
000000000000013d: 07	cmpl	$0, 2410796(%rip)  # 7185b0 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)::firstTime>
0000000000000144: 02	je	0x4cbc90 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x150>
0000000000000146: 05	movl	$5194330, %edi
000000000000014b: 05	callq	0x401710 <puts@plt>
0000000000000150: 10	movl	$0, 2410774(%rip)  # 7185b0 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)::firstTime>
000000000000015a: 07	cmpb	$0, 2411764(%rip)  # 718995 <veryVeryVerbose>
0000000000000161: 02	je	0x4cbcad <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x16d>
0000000000000163: 05	movl	$5194369, %edi
0000000000000168: 05	callq	0x401710 <puts@plt>
000000000000016d: 07	movq	2411372(%rip), %rax  # 718820 <Z>
...
000000000000018d: 06	je	0x4cbdb9 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x279>
0000000000000193: 08	leaq	7666144(,%r15,8), %rsi
000000000000019b: 05	movq	72(%rsp), %rax
00000000000001a0: 03	addl	%r15d, %eax
00000000000001a3: 02	cltq	
00000000000001a5: 08	leaq	7666144(,%rax,8), %rdx
00000000000001ad: 03	subq	%rsi, %rdx
00000000000001b0: 02	je	0x4cbcff <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x1bf>
00000000000001b2: 08	leaq	7666144(,%r14,8), %rdi
...
00000000000001d3: 07	cmpb	$0, 2411643(%rip)  # 718995 <veryVeryVerbose>
00000000000001da: 02	je	0x4cbd26 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x1e6>
00000000000001dc: 05	movl	$5194721, %edi
00000000000001e1: 05	callq	0x401710 <puts@plt>
00000000000001e6: 07	cmpb	$0, 2411619(%rip)  # 718990 <veryVerbose>
00000000000001ed: 06	je	0x4cbffb <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x4bb>
00000000000001f3: 05	movl	$10, %edi
00000000000001f8: 05	callq	0x401720 <putchar@plt>
00000000000001fd: 05	jmp	0x4cbfd1 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x491>
0000000000000202: 10	nopw	%cs:(%rax,%rax)
000000000000020c: 04	nopl	(%rax)
0000000000000210: 08	cmpq	$0, 2411208(%rip)  # 718820 <Z>
0000000000000218: 03	movl	%r13d, %ebx
000000000000021b: 02	jne	0x4cbd6d <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x22d>
000000000000021d: 07	movq	2643284(%rip), %rax  # 7512b8 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000224: 03	testq	%rax, %rax
0000000000000227: 06	je	0x4cbe73 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x333>
000000000000022d: 06	cmpq	$6, 24(%rsp)
0000000000000233: 06	jb	0x4cbfd1 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x491>
0000000000000239: 08	leaq	7666144(,%r15,8), %rax
0000000000000241: 08	leaq	7666144(,%r14,8), %rcx
...
000000000000026f: 02	jae	0x4cbe2d <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x2ed>
0000000000000271: 03	movl	%r13d, %ebx
0000000000000274: 05	jmp	0x4cbfb0 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x470>
0000000000000279: 06	movl	$1, %r13d
000000000000027f: 07	movq	2643186(%rip), %rax  # 7512b8 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000286: 03	testq	%rax, %rax
0000000000000289: 06	jne	0x4cbcd3 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x193>
000000000000028f: 05	callq	0x4eec50 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
0000000000000294: 05	jmp	0x4cbcd3 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x193>
0000000000000299: 03	cmpl	$1, %edx
000000000000029c: 06	jne	0x4cc77e <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xc3e>
00000000000002a2: 03	movq	%rax, %rdi
00000000000002a5: 05	callq	0x4016b0 <__cxa_begin_catch@plt>
00000000000002aa: 07	cmpb	$0, 2411428(%rip)  # 718995 <veryVeryVerbose>
00000000000002b1: 02	je	0x4cbe06 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x2c6>
...
00000000000002de: 08	cmpq	$0, 2411002(%rip)  # 718820 <Z>
00000000000002e6: 02	je	0x4cbdbf <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x27f>
00000000000002e8: 05	jmp	0x4cbcd3 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x193>
00000000000002ed: 03	movq	%rbp, %r11
00000000000002f0: 08	leaq	7666144(,%r14,8), %rsi
00000000000002f8: 04	leal	(%rbx,%r15), %edx
00000000000002fc: 03	movslq	%edx, %rdx
00000000000002ff: 08	leaq	7666144(,%rdx,8), %rbp
0000000000000307: 03	cmpq	%rbp, %rsi
000000000000030a: 02	jae	0x4cbe89 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x349>
000000000000030c: 04	shlq	$3, %rdx
0000000000000310: 03	subq	%rdi, %rdx
0000000000000313: 08	leaq	7666144(%rdx,%r14,8), %rdx
000000000000031b: 08	leaq	7666144(,%r15,8), %rsi
0000000000000323: 03	cmpq	%rdx, %rsi
0000000000000326: 02	jae	0x4cbe89 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x349>
0000000000000328: 03	movq	%r11, %rbp
000000000000032b: 03	movl	%r13d, %ebx
000000000000032e: 05	jmp	0x4cbfb0 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x470>
...
000000000000033e: 06	jae	0x4cbd79 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x239>
0000000000000344: 05	jmp	0x4cbfd1 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x491>
...
000000000000036e: 02	jae	0x4cbeb7 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x377>
0000000000000370: 02	xorl	%ebx, %ebx
0000000000000372: 05	jmp	0x4cbf40 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x400>
0000000000000377: 04	andq	$-4, %rbp
000000000000037b: 03	negq	%rbp
000000000000037e: 05	movl	$7666144, %esi
...
00000000000003fe: 02	jne	0x4cbed0 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x390>
0000000000000400: 03	testq	%rdx, %rdx
0000000000000403: 02	je	0x4cbf93 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x453>
0000000000000405: 04	shlq	$3, %r14
0000000000000409: 08	leaq	7666144(,%rbx,8), %rsi
0000000000000411: 03	negq	%rdx
0000000000000414: 10	nopw	%cs:(%rax,%rax)
000000000000041e: 02	nop	
0000000000000420: 09	movdqu	7666144(%rdi,%rbx,8), %xmm0
0000000000000429: 09	movdqu	7666160(%rdi,%rbx,8), %xmm1
0000000000000432: 10	movdqu	%xmm0, 7666144(%r14,%rbx,8)
000000000000043c: 10	movdqu	%xmm1, 7666160(%r14,%rbx,8)
0000000000000446: 04	addq	$4, %rbx
000000000000044a: 04	addq	$32, %rsi
000000000000044e: 03	incq	%rdx
0000000000000451: 02	jne	0x4cbf60 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x420>
0000000000000453: 03	cmpq	%r8, %r10
0000000000000456: 03	movq	%r11, %rbp
0000000000000459: 03	movl	%r13d, %ebx
000000000000045c: 02	je	0x4cbfd1 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x491>
...
0000000000000473: 07	leaq	7666144(%r9), %rdx
...
000000000000048f: 02	jne	0x4cbfc0 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x480>
0000000000000491: 07	cmpb	$0, 2410936(%rip)  # 718990 <veryVerbose>
0000000000000498: 02	je	0x4cbffb <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x4bb>
000000000000049a: 06	movl	2410948(%rip), %edx  # 7189a4 <numCopyCtorCalls>
00000000000004a0: 03	subl	%r12d, %edx
00000000000004a3: 06	movl	2410947(%rip), %ecx  # 7189ac <numCharCtorCalls>
...
00000000000004c0: 02	je	0x4cc060 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x520>
00000000000004c2: 07	cmpl	2410907(%rip), %r12d  # 7189a4 <numCopyCtorCalls>
00000000000004c9: 02	je	0x4cc034 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x4f4>
...
00000000000004e1: 06	movl	2410865(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>
00000000000004e7: 03	cmpl	$100, %eax
00000000000004ea: 02	ja	0x4cc034 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x4f4>
00000000000004ec: 02	incl	%eax
00000000000004ee: 06	movl	%eax, 2410852(%rip)  # 718998 <(anonymous namespace)::testStatus>
00000000000004f4: 04	movl	20(%rsp), %eax
00000000000004f8: 06	cmpl	2410862(%rip), %eax  # 7189ac <numCharCtorCalls>
00000000000004fe: 06	je	0x4cbb70 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x30>
0000000000000504: 05	movl	$5196920, %edi
0000000000000509: 05	movl	$5200986, %edx
000000000000050e: 05	movl	$4102, %esi
0000000000000513: 02	jmp	0x4cc0b6 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x576>
0000000000000515: 10	nopw	%cs:(%rax,%rax)
000000000000051f: 01	nop	
0000000000000520: 05	addl	72(%rsp), %r12d
0000000000000525: 07	cmpl	2410808(%rip), %r12d  # 7189a4 <numCopyCtorCalls>
000000000000052c: 02	jle	0x4cc097 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x557>
...
0000000000000544: 06	movl	2410766(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>
000000000000054a: 03	cmpl	$100, %eax
000000000000054d: 02	ja	0x4cc097 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x557>
000000000000054f: 02	incl	%eax
0000000000000551: 06	movl	%eax, 2410753(%rip)  # 718998 <(anonymous namespace)::testStatus>
0000000000000557: 04	movl	20(%rsp), %eax
000000000000055b: 06	cmpl	2410763(%rip), %eax  # 7189ac <numCharCtorCalls>
0000000000000561: 06	je	0x4cbb70 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x30>
...
000000000000057d: 06	movl	2410709(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>
0000000000000583: 03	cmpl	$100, %eax
0000000000000586: 06	ja	0x4cbb70 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x30>
000000000000058c: 02	incl	%eax
000000000000058e: 06	movl	%eax, 2410692(%rip)  # 718998 <(anonymous namespace)::testStatus>
0000000000000594: 05	jmp	0x4cbb70 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x30>
0000000000000599: 07	cmpb	$0, 2410678(%rip)  # 718996 <verbose>
00000000000005a0: 02	je	0x4cc0ec <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x5ac>
...
00000000000005c8: 05	callq	0x4e3860 <void verify<int const volatile*>(int const volatile**, char const*)>
00000000000005cd: 05	movl	$7666144, %edi
00000000000005d2: 03	movq	%rbx, %rsi
00000000000005d5: 05	callq	0x4e3aa0 <void cleanup<int const volatile*>(int const volatile**, char const*)>
00000000000005da: 03	incq	%r12
00000000000005dd: 04	cmpq	$30, %r12
00000000000005e1: 06	je	0x4cc74d <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xc0d>
...
0000000000000602: 02	jl	0x4cc16d <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x62d>
...
000000000000061a: 06	movl	2410552(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>
0000000000000620: 03	cmpl	$100, %eax
0000000000000623: 02	ja	0x4cc16d <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x62d>
0000000000000625: 02	incl	%eax
0000000000000627: 06	movl	%eax, 2410539(%rip)  # 718998 <(anonymous namespace)::testStatus>
000000000000062d: 03	movq	%rbp, %rdi
0000000000000630: 05	callq	0x401790 <strlen@plt>
0000000000000635: 04	cmpq	$20, %rax
0000000000000639: 02	jb	0x4cc1a4 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x664>
...
0000000000000651: 06	movl	2410497(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>
0000000000000657: 03	cmpl	$100, %eax
000000000000065a: 02	ja	0x4cc1a4 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x664>
000000000000065c: 02	incl	%eax
000000000000065e: 06	movl	%eax, 2410484(%rip)  # 718998 <(anonymous namespace)::testStatus>
...
0000000000000680: 02	je	0x4cc1e0 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x6a0>
...
000000000000069e: 02	jne	0x4cc1d0 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x690>
...
00000000000006c8: 07	cmpb	$0, 2410369(%rip)  # 718990 <veryVerbose>
00000000000006cf: 02	je	0x4cc230 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x6f0>
...
00000000000006f8: 05	callq	0x4e3780 <int const volatile*& gg<int const volatile*>(int const volatile**, char const*)>
00000000000006fd: 05	movl	$7666144, %edi
0000000000000702: 03	movq	%rbp, %rsi
0000000000000705: 05	callq	0x4e3860 <void verify<int const volatile*>(int const volatile**, char const*)>
000000000000070a: 06	movl	2410324(%rip), %eax  # 7189a4 <numCopyCtorCalls>
...
0000000000000723: 06	je	0x4cc330 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x7f0>
0000000000000729: 07	cmpb	$0, 2410272(%rip)  # 718990 <veryVerbose>
0000000000000730: 03	movl	%r14d, %ebp
0000000000000733: 02	je	0x4cc288 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x748>
0000000000000735: 07	cmpl	$0, 2409272(%rip)  # 7185b4 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)::firstTime>
000000000000073c: 02	je	0x4cc288 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x748>
000000000000073e: 05	movl	$5194330, %edi
0000000000000743: 05	callq	0x401710 <puts@plt>
0000000000000748: 10	movl	$0, 2409250(%rip)  # 7185b4 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)::firstTime>
0000000000000752: 07	cmpb	$0, 2410236(%rip)  # 718995 <veryVeryVerbose>
0000000000000759: 02	je	0x4cc2a5 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x765>
000000000000075b: 05	movl	$5194369, %edi
0000000000000760: 05	callq	0x401710 <puts@plt>
0000000000000765: 07	movq	2409844(%rip), %rax  # 718820 <Z>
...
0000000000000785: 06	je	0x4cc3bd <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x87d>
000000000000078b: 06	cmpq	$6, 24(%rsp)
0000000000000791: 06	jb	0x4cc6a1 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xb61>
...
00000000000007b6: 06	jb	0x4cc686 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xb46>
...
00000000000007dd: 06	jae	0x4cc576 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xa36>
00000000000007e3: 02	xorl	%ebx, %ebx
00000000000007e5: 05	jmp	0x4cc625 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xae5>
00000000000007ea: 06	nopw	(%rax,%rax)
00000000000007f0: 08	cmpq	$0, 2409704(%rip)  # 718820 <Z>
00000000000007f8: 03	movl	%r14d, %ebp
00000000000007fb: 03	movq	%r12, %r11
00000000000007fe: 02	jne	0x4cc360 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x820>
0000000000000800: 07	movq	2641777(%rip), %rax  # 7512b8 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000807: 03	testq	%rax, %rax
000000000000080a: 02	jne	0x4cc360 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x820>
...
0000000000000829: 06	jb	0x4cc6e0 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xba0>
...
0000000000000849: 06	jb	0x4cc54a <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xa0a>
...
0000000000000870: 06	jae	0x4cc43d <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x8fd>
0000000000000876: 02	xorl	%ebx, %ebx
0000000000000878: 05	jmp	0x4cc4e5 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x9a5>
000000000000087d: 05	movl	$1, %eax
0000000000000882: 05	movq	%rax, 64(%rsp)
0000000000000887: 07	movq	2641642(%rip), %rax  # 7512b8 <BloombergLP::bslma::Default::s_defaultAllocator>
000000000000088e: 03	testq	%rax, %rax
0000000000000891: 06	jne	0x4cc2cb <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x78b>
0000000000000897: 05	callq	0x4eec50 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
000000000000089c: 05	jmp	0x4cc2cb <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x78b>
00000000000008a1: 03	cmpl	$1, %edx
00000000000008a4: 06	jne	0x4cc77e <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xc3e>
00000000000008aa: 03	movq	%rax, %rdi
00000000000008ad: 05	callq	0x4016b0 <__cxa_begin_catch@plt>
00000000000008b2: 07	cmpb	$0, 2409884(%rip)  # 718995 <veryVeryVerbose>
00000000000008b9: 02	je	0x4cc412 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x8d2>
...
00000000000008ee: 08	cmpq	$0, 2409450(%rip)  # 718820 <Z>
00000000000008f6: 02	je	0x4cc3c7 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x887>
00000000000008f8: 05	jmp	0x4cc2cb <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x78b>
...
000000000000099f: 06	jne	0x4cc450 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x910>
00000000000009a5: 03	testq	%rbp, %rbp
00000000000009a8: 02	je	0x4cc534 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x9f4>
...
00000000000009f2: 02	jne	0x4cc510 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x9d0>
00000000000009f4: 03	cmpq	%r8, %r9
00000000000009f7: 03	movq	%r10, %rbx
00000000000009fa: 03	movl	%r14d, %ebp
00000000000009fd: 06	je	0x4cc6e0 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xba0>
...
0000000000000a2f: 02	jne	0x4cc560 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xa20>
0000000000000a31: 05	jmp	0x4cc6e0 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xba0>
...
0000000000000adf: 06	jne	0x4cc590 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xa50>
0000000000000ae5: 03	testq	%rdi, %rdi
0000000000000ae8: 02	je	0x4cc674 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xb34>
...
0000000000000b32: 02	jne	0x4cc650 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xb10>
0000000000000b34: 03	cmpq	%r8, %r10
0000000000000b37: 03	movq	%r11, %rbx
0000000000000b3a: 03	movl	%r14d, %ebp
0000000000000b3d: 02	je	0x4cc6a1 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xb61>
...
0000000000000b5f: 02	jne	0x4cc690 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xb50>
...
0000000000000b75: 07	cmpb	$0, 2409177(%rip)  # 718995 <veryVeryVerbose>
0000000000000b7c: 05	movq	24(%rsp), %r12
0000000000000b81: 02	je	0x4cc6cd <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xb8d>
0000000000000b83: 05	movl	$5194721, %edi
0000000000000b88: 05	callq	0x401710 <puts@plt>
0000000000000b8d: 07	cmpb	$0, 2409148(%rip)  # 718990 <veryVerbose>
0000000000000b94: 02	je	0x4cc70b <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xbcb>
0000000000000b96: 05	movl	$10, %edi
0000000000000b9b: 05	callq	0x401720 <putchar@plt>
0000000000000ba0: 07	cmpb	$0, 2409129(%rip)  # 718990 <veryVerbose>
0000000000000ba7: 02	je	0x4cc70b <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xbcb>
0000000000000ba9: 06	movl	2409141(%rip), %edx  # 7189a4 <numCopyCtorCalls>
0000000000000baf: 04	subl	20(%rsp), %edx
0000000000000bb3: 06	movl	2409139(%rip), %ecx  # 7189ac <numCharCtorCalls>
...
0000000000000bcf: 06	cmpl	2409103(%rip), %eax  # 7189a4 <numCopyCtorCalls>
0000000000000bd5: 06	je	0x4cc100 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x5c0>
...
0000000000000bf1: 06	movl	2409057(%rip), %eax  # 718998 <(anonymous namespace)::testStatus>
0000000000000bf7: 03	cmpl	$100, %eax
0000000000000bfa: 06	ja	0x4cc100 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x5c0>
0000000000000c00: 02	incl	%eax
0000000000000c02: 06	movl	%eax, 2409040(%rip)  # 718998 <(anonymous namespace)::testStatus>
0000000000000c08: 05	jmp	0x4cc100 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0x5c0>
...
0000000000000c1c: 02	jmp	0x4cc77e <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xc3e>
0000000000000c1e: 03	movq	%rax, %rbx
0000000000000c21: 05	callq	0x401850 <__cxa_end_catch@plt>
0000000000000c26: 02	jmp	0x4cc781 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xc41>
0000000000000c28: 02	jmp	0x4cc77e <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xc3e>
0000000000000c2a: 03	movq	%rax, %rbx
0000000000000c2d: 05	callq	0x401850 <__cxa_end_catch@plt>
0000000000000c32: 02	jmp	0x4cc781 <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xc41>
0000000000000c34: 03	movq	%rax, %rdi
0000000000000c37: 05	callq	0x40bf90 <__clang_call_terminate>
0000000000000c3c: 02	jmp	0x4cc77e <void testCopyConstructWithIterators<int const volatile*>(bool, bool, bool)+0xc3e>
