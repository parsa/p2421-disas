# `BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::BlockGrowth::Strategy, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)` - Assumed
...
M000000000000006f:	je	0x40c3e8 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::BlockGrowth::Strategy, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0xd8>	;  2 bytes
...
M00000000000000a8:	jne	0x40c3ce <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::BlockGrowth::Strategy, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0xbe>	;  2 bytes
M00000000000000aa:	movq	2496783(%rip), %r8  # 66dcd0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M00000000000000b1:	testq	%r8, %r8	;  3 bytes
M00000000000000b4:	jne	0x40c3ce <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::BlockGrowth::Strategy, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0xbe>	;  2 bytes
M00000000000000b6:	callq	0x4171b0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
...
M00000000000000cb:	callq	0x40bf00 <BloombergLP::bdlma::SequentialPool::reserveCapacity(unsigned long)>	;  5 bytes
...
M00000000000000d8:	movq	$-1, %rax	;  7 bytes
M00000000000000df:	jmp	0x40c391 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::BlockGrowth::Strategy, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0x81>	;  2 bytes
M00000000000000e1:	movq	%rax, %rdi	;  3 bytes
M00000000000000e4:	callq	0x405000 <_Unwind_Resume@plt>	;  5 bytes
M00000000000000e9:	nopl	(%rax)	;  7 bytes
```
