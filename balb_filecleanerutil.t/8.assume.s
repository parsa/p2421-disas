...
M0000000000000058:	je	0x40c20e <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::BlockGrowth::Strategy, BloombergLP::bslma::Allocator*)+0xbe>	;  2 bytes
...
M0000000000000091:	jne	0x40c1f4 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::BlockGrowth::Strategy, BloombergLP::bslma::Allocator*)+0xa4>	;  2 bytes
M0000000000000093:	movq	2497254(%rip), %rax  # 66dcd0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M000000000000009a:	testq	%rax, %rax	;  3 bytes
M000000000000009d:	jne	0x40c1f4 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::BlockGrowth::Strategy, BloombergLP::bslma::Allocator*)+0xa4>	;  2 bytes
M000000000000009f:	callq	0x4171b0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
M00000000000000a4:	movq	%rax, 536(%rbx)	;  7 bytes
M00000000000000ab:	movq	%rbx, %rdi	;  3 bytes
M00000000000000ae:	movq	%r14, %rsi	;  3 bytes
M00000000000000b1:	callq	0x40bf00 <BloombergLP::bdlma::SequentialPool::reserveCapacity(unsigned long)>	;  5 bytes
M00000000000000b6:	addq	$8, %rsp	;  4 bytes
M00000000000000ba:	popq	%rbx	;  1 bytes
M00000000000000bb:	popq	%r14	;  2 bytes
M00000000000000bd:	retq		;  1 bytes
M00000000000000be:	movq	$-1, %rcx	;  7 bytes
M00000000000000c5:	jmp	0x40c1ba <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::BlockGrowth::Strategy, BloombergLP::bslma::Allocator*)+0x6a>	;  2 bytes
M00000000000000c7:	movq	%rax, %rdi	;  3 bytes
M00000000000000ca:	callq	0x405000 <_Unwind_Resume@plt>	;  5 bytes
