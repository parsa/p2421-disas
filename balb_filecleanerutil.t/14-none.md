# `BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, unsigned long, BloombergLP::bslma::Allocator*)` - Ignored
...
M0000000000000062:	je	0x40c3e7 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, unsigned long, BloombergLP::bslma::Allocator*)+0x67>	;  2 bytes
...
M00000000000000c4:	jne	0x40c45a <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, unsigned long, BloombergLP::bslma::Allocator*)+0xda>	;  2 bytes
M00000000000000c6:	movq	2496643(%rip), %r8  # 66dcd0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M00000000000000cd:	testq	%r8, %r8	;  3 bytes
M00000000000000d0:	jne	0x40c45a <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, unsigned long, BloombergLP::bslma::Allocator*)+0xda>	;  2 bytes
M00000000000000d2:	callq	0x4173a0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
...
M00000000000000ee:	jmp	0x40bea0 <BloombergLP::bdlma::SequentialPool::reserveCapacity(unsigned long)>	;  5 bytes
