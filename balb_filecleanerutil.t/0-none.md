...
M0000000000000055:	je	0x40be91 <BloombergLP::bdlma::SequentialPool::SequentialPool(int)+0xb1>	;  2 bytes
...
M0000000000000087:	movq	2498146(%rip), %rax  # 66dcd0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M000000000000008e:	testq	%rax, %rax	;  3 bytes
M0000000000000091:	jne	0x40be78 <BloombergLP::bdlma::SequentialPool::SequentialPool(int)+0x98>	;  2 bytes
M0000000000000093:	callq	0x4173a0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
M0000000000000098:	movq	%rax, 536(%rbx)	;  7 bytes
M000000000000009f:	movq	%rbx, %rdi	;  3 bytes
M00000000000000a2:	movq	%r14, %rsi	;  3 bytes
M00000000000000a5:	addq	$8, %rsp	;  4 bytes
M00000000000000a9:	popq	%rbx	;  1 bytes
M00000000000000aa:	popq	%r14	;  2 bytes
M00000000000000ac:	jmp	0x40bea0 <BloombergLP::bdlma::SequentialPool::reserveCapacity(unsigned long)>	;  5 bytes
M00000000000000b1:	movq	$-1, %rcx	;  7 bytes
M00000000000000b8:	jmp	0x40be47 <BloombergLP::bdlma::SequentialPool::SequentialPool(int)+0x67>	;  2 bytes
