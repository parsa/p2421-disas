...
M0000000000000028:	movaps	201585(%rip), %xmm1  # 43cf70 <typeinfo for BloombergLP::bdlma::ManagedAllocator+0x20>	;  7 bytes
...
M000000000000004b:	jne	0x40bc31 <BloombergLP::bdlma::SequentialPool::SequentialPool(BloombergLP::bslma::Allocator*)+0x61>	;  2 bytes
M000000000000004d:	movq	2498732(%rip), %rsi  # 66dcd0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000054:	testq	%rsi, %rsi	;  3 bytes
M0000000000000057:	jne	0x40bc31 <BloombergLP::bdlma::SequentialPool::SequentialPool(BloombergLP::bslma::Allocator*)+0x61>	;  2 bytes
