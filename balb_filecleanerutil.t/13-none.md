# `BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bslma::Allocator*)` - Ignored
...
M0000000000000055:	je	0x40c0d9 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bslma::Allocator*)+0xb9>	;  2 bytes
...
M000000000000008a:	jne	0x40c0c0 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bslma::Allocator*)+0xa0>	;  2 bytes
M000000000000008c:	movq	2497565(%rip), %rdx  # 66dcd0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000093:	testq	%rdx, %rdx	;  3 bytes
M0000000000000096:	jne	0x40c0c0 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bslma::Allocator*)+0xa0>	;  2 bytes
M0000000000000098:	callq	0x4173a0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
...
M00000000000000b4:	jmp	0x40bea0 <BloombergLP::bdlma::SequentialPool::reserveCapacity(unsigned long)>	;  5 bytes
M00000000000000b9:	movq	$-1, %rcx	;  7 bytes
M00000000000000c0:	jmp	0x40c087 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bslma::Allocator*)+0x67>	;  2 bytes
