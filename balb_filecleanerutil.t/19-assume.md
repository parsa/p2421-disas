...
M0000000000000042:	movaps	200695(%rip), %xmm1  # 43cd40 <typeinfo for BloombergLP::bdlma::ManagedAllocator+0x20>	;  7 bytes
...
M0000000000000065:	jne	0x40bd7b <BloombergLP::bdlma::SequentialPool::SequentialPool(BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0x7b>	;  2 bytes
M0000000000000067:	movq	2498402(%rip), %rdx  # 66dcd0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M000000000000006e:	testq	%rdx, %rdx	;  3 bytes
M0000000000000071:	jne	0x40bd7b <BloombergLP::bdlma::SequentialPool::SequentialPool(BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0x7b>	;  2 bytes
M0000000000000073:	callq	0x4171b0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
...
M0000000000000087:	callq	0x405000 <_Unwind_Resume@plt>	;  5 bytes
