...
M0000000000000044:	jne	0x40b81a <BloombergLP::bdlma::BufferedSequentialPool::BufferedSequentialPool(char*, unsigned long, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0x5a>	;  2 bytes
M0000000000000046:	movq	2499779(%rip), %r8  # 66dcd0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M000000000000004d:	testq	%r8, %r8	;  3 bytes
M0000000000000050:	jne	0x40b81a <BloombergLP::bdlma::BufferedSequentialPool::BufferedSequentialPool(char*, unsigned long, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0x5a>	;  2 bytes
M0000000000000052:	callq	0x4171b0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
...
M0000000000000060:	movq	%rax, %rdi	;  3 bytes
M0000000000000063:	callq	0x405000 <_Unwind_Resume@plt>	;  5 bytes
M0000000000000068:	nopl	(%rax,%rax)	;  8 bytes
```
