...
0000000000000042: 07	movaps	201319(%rip), %xmm1  # 43cf70 <typeinfo for BloombergLP::bdlma::ManagedAllocator+0x20>
...
0000000000000065: 02	jne	0x40bd3b <BloombergLP::bdlma::SequentialPool::SequentialPool(BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0x7b>
0000000000000067: 07	movq	2498466(%rip), %rdx  # 66dcd0 <BloombergLP::bslma::Default::s_defaultAllocator>
000000000000006e: 03	testq	%rdx, %rdx
0000000000000071: 02	jne	0x40bd3b <BloombergLP::bdlma::SequentialPool::SequentialPool(BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0x7b>
0000000000000073: 05	callq	0x4173a0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
