# `BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)` - Assumed

```nasm
000000000040c220 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)>:
...
M0000000000000072:	je	0x40c2f4 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0xd4>	;  2 bytes
...
M00000000000000a7:	jne	0x40c2da <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0xba>	;  2 bytes
M00000000000000a9:	movq	2497024(%rip), %rax  # 66dcd0 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M00000000000000b0:	testq	%rax, %rax	;  3 bytes
M00000000000000b3:	jne	0x40c2da <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0xba>	;  2 bytes
M00000000000000b5:	callq	0x4171b0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>	;  5 bytes
M00000000000000ba:	movq	%rax, 536(%rbx)	;  7 bytes
M00000000000000c1:	movq	%rbx, %rdi	;  3 bytes
M00000000000000c4:	movq	%r14, %rsi	;  3 bytes
M00000000000000c7:	callq	0x40bf00 <BloombergLP::bdlma::SequentialPool::reserveCapacity(unsigned long)>	;  5 bytes
M00000000000000cc:	addq	$8, %rsp	;  4 bytes
M00000000000000d0:	popq	%rbx	;  1 bytes
M00000000000000d1:	popq	%r14	;  2 bytes
M00000000000000d3:	retq		;  1 bytes
M00000000000000d4:	movq	$-1, %rcx	;  7 bytes
M00000000000000db:	jmp	0x40c2a4 <BloombergLP::bdlma::SequentialPool::SequentialPool(unsigned long, BloombergLP::bsls::Alignment::Strategy, BloombergLP::bslma::Allocator*)+0x84>	;  2 bytes
M00000000000000dd:	movq	%rax, %rdi	;  3 bytes
M00000000000000e0:	callq	0x405000 <_Unwind_Resume@plt>	;  5 bytes
