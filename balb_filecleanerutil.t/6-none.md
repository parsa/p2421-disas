...
0000000000000028: 07	movaps	201585(%rip), %xmm1  # 43cf70 <typeinfo for BloombergLP::bdlma::ManagedAllocator+0x20>
...
000000000000004b: 02	jne	0x40bc31 <BloombergLP::bdlma::SequentialPool::SequentialPool(BloombergLP::bslma::Allocator*)+0x61>
000000000000004d: 07	movq	2498732(%rip), %rsi  # 66dcd0 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000054: 03	testq	%rsi, %rsi
0000000000000057: 02	jne	0x40bc31 <BloombergLP::bdlma::SequentialPool::SequentialPool(BloombergLP::bslma::Allocator*)+0x61>
