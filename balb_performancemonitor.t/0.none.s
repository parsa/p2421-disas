...
M0000000000000023:	je	0x422bd6 <BloombergLP::bdlma::ConcurrentPool::reserveCapacity(int)+0x66>	;  2 bytes
...
M0000000000000038:	je	0x422bc0 <BloombergLP::bdlma::ConcurrentPool::reserveCapacity(int)+0x50>	;  2 bytes
M000000000000003a:	movq	16(%rsi), %rsi	;  4 bytes
M000000000000003e:	leal	-1(%r15), %eax	;  4 bytes
M0000000000000042:	testq	%rsi, %rsi	;  3 bytes
M0000000000000045:	jne	0x422ba0 <BloombergLP::bdlma::ConcurrentPool::reserveCapacity(int)+0x30>	;  2 bytes
M0000000000000047:	jmp	0x422bd6 <BloombergLP::bdlma::ConcurrentPool::reserveCapacity(int)+0x66>	;  2 bytes
...
M0000000000000064:	jne	0x422bc0 <BloombergLP::bdlma::ConcurrentPool::reserveCapacity(int)+0x50>	;  2 bytes
M0000000000000066:	testl	%r15d, %r15d	;  3 bytes
M0000000000000069:	jle	0x422c46 <BloombergLP::bdlma::ConcurrentPool::reserveCapacity(int)+0xd6>	;  2 bytes
...
M000000000000007a:	callq	0x422ce0 <BloombergLP::bdlma::InfrequentDeleteBlockList::allocate(unsigned long)>	;  5 bytes
M000000000000007f:	movq	%rax, %rcx	;  3 bytes
M0000000000000082:	decl	%r15d	;  3 bytes
M0000000000000085:	movslq	%r15d, %rax	;  3 bytes
M0000000000000088:	imulq	%r12, %rax	;  4 bytes
M000000000000008c:	movq	%rcx, %rsi	;  3 bytes
M000000000000008f:	addq	%rax, %rsi	;  3 bytes
M0000000000000092:	testq	%rax, %rax	;  3 bytes
M0000000000000095:	jle	0x422c26 <BloombergLP::bdlma::ConcurrentPool::reserveCapacity(int)+0xb6>	;  2 bytes
M0000000000000097:	movq	%rcx, %rax	;  3 bytes
...
M00000000000000b4:	jb	0x422c10 <BloombergLP::bdlma::ConcurrentPool::reserveCapacity(int)+0xa0>	;  2 bytes
...
M00000000000000d4:	jne	0x422c30 <BloombergLP::bdlma::ConcurrentPool::reserveCapacity(int)+0xc0>	;  2 bytes
