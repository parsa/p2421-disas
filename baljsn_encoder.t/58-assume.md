...
M0000000000000015:	ja	0x4b9346 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x26>	;  2 bytes
M0000000000000017:	jmpq	*6589344(,%rax,8)	;  7 bytes
...
M000000000000003a:	jne	0x4b9370 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x50>	;  2 bytes
M000000000000003c:	movq	4275525(%rip), %rdi  # 8cd0a8 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000043:	testq	%rdi, %rdi	;  3 bytes
M0000000000000046:	jne	0x4b9370 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x50>	;  2 bytes
...
M0000000000000070:	je	0x4b93ec <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0xcc>	;  2 bytes
...
M0000000000000096:	jb	0x4b93cb <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0xab>	;  2 bytes
...
M00000000000000a9:	jne	0x4b93ce <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0xae>	;  2 bytes
M00000000000000ab:	movq	%rbx, %rax	;  3 bytes
M00000000000000ae:	movq	24(%rbx), %rdx	;  4 bytes
M00000000000000b2:	incq	%rdx	;  3 bytes
M00000000000000b5:	je	0x4b93ec <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0xcc>	;  2 bytes
M00000000000000b7:	cmpq	$23, 32(%r14)	;  5 bytes
M00000000000000bc:	je	0x4b93e1 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0xc1>	;  2 bytes
...
M00000000000000e2:	je	0x4b93f6 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0xd6>	;  2 bytes
M00000000000000e4:	movq	24(%r14), %rdx	;  4 bytes
M00000000000000e8:	cmpq	$23, 32(%r14)	;  5 bytes
M00000000000000ed:	je	0x4b9412 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0xf2>	;  2 bytes
...
M000000000000010e:	jmp	0x4b93f6 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0xd6>	;  2 bytes
