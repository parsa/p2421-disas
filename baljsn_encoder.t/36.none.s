...
M000000000000001d:	je	0x483119 <int BloombergLP::baljsn::Encoder_ValueDispatcher::operator()<BloombergLP::bdlt::DateTz>(BloombergLP::bdlt::DateTz const&, BloombergLP::bdlat_TypeCategory::Simple)+0x49>	;  2 bytes
...
M0000000000000039:	jae	0x483119 <int BloombergLP::baljsn::Encoder_ValueDispatcher::operator()<BloombergLP::bdlt::DateTz>(BloombergLP::bdlt::DateTz const&, BloombergLP::bdlat_TypeCategory::Simple)+0x49>	;  2 bytes
...
M0000000000000057:	je	0x483130 <int BloombergLP::baljsn::Encoder_ValueDispatcher::operator()<BloombergLP::bdlt::DateTz>(BloombergLP::bdlt::DateTz const&, BloombergLP::bdlat_TypeCategory::Simple)+0x60>	;  2 bytes
M0000000000000059:	movl	8(%r12), %esi	;  5 bytes
M000000000000005e:	jmp	0x483135 <int BloombergLP::baljsn::Encoder_ValueDispatcher::operator()<BloombergLP::bdlt::DateTz>(BloombergLP::bdlt::DateTz const&, BloombergLP::bdlat_TypeCategory::Simple)+0x65>	;  2 bytes
...
M0000000000000085:	callq	0x4e7bb0 <BloombergLP::bdlt::Iso8601Util::generate(char*, int, BloombergLP::bdlt::DateTz const&, BloombergLP::bdlt::Iso8601UtilConfiguration const&)>	;  5 bytes
