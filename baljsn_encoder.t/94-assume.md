...
M0000000000000009:	ja	0x4d038f <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x5f>	;  2 bytes
M000000000000000b:	movq	%rdi, %r14	;  3 bytes
M000000000000000e:	jmpq	*6595616(,%rsi,8)	;  7 bytes
M0000000000000015:	movl	368(%r14), %eax	;  7 bytes
M000000000000001c:	cmpq	$3, %rax	;  4 bytes
M0000000000000020:	ja	0x4d04f8 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x1c8>	;  6 bytes
M0000000000000026:	jmpq	*6595656(,%rax,8)	;  7 bytes
M000000000000002d:	movq	%r14, %rdi	;  3 bytes
M0000000000000030:	callq	0x4c4a50 <BloombergLP::s_baltst::Sequence6::~Sequence6()>	;  5 bytes
M0000000000000035:	jmp	0x4d04f8 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x1c8>	;  5 bytes
M000000000000003a:	movl	368(%r14), %eax	;  7 bytes
M0000000000000041:	cmpq	$3, %rax	;  4 bytes
M0000000000000045:	ja	0x4d046e <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x13e>	;  6 bytes
M000000000000004b:	jmpq	*6595688(,%rax,8)	;  7 bytes
M0000000000000052:	movq	%r14, %rdi	;  3 bytes
M0000000000000055:	callq	0x4c4a50 <BloombergLP::s_baltst::Sequence6::~Sequence6()>	;  5 bytes
M000000000000005a:	jmp	0x4d046e <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x13e>	;  5 bytes
M000000000000005f:	movl	$4294967295, %ebx	;  5 bytes
M0000000000000064:	jmp	0x4d0548 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x218>	;  5 bytes
M0000000000000069:	movl	368(%r14), %eax	;  7 bytes
M0000000000000070:	cmpq	$3, %rax	;  4 bytes
M0000000000000074:	ja	0x4d0521 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x1f1>	;  6 bytes
M000000000000007a:	jmpq	*6595784(,%rax,8)	;  7 bytes
M0000000000000081:	movq	%r14, %rdi	;  3 bytes
M0000000000000084:	callq	0x4c4bf0 <BloombergLP::s_baltst::Sequence6::reset()>	;  5 bytes
M0000000000000089:	jmp	0x4d0546 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  5 bytes
M000000000000008e:	movl	368(%r14), %eax	;  7 bytes
M0000000000000095:	cmpq	$3, %rax	;  4 bytes
M0000000000000099:	ja	0x4d04b6 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x186>	;  6 bytes
M000000000000009f:	jmpq	*6595752(,%rax,8)	;  7 bytes
M00000000000000a6:	movq	%r14, %rdi	;  3 bytes
M00000000000000a9:	callq	0x4c4a50 <BloombergLP::s_baltst::Sequence6::~Sequence6()>	;  5 bytes
M00000000000000ae:	jmp	0x4d04b6 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x186>	;  5 bytes
M00000000000000b3:	movl	368(%r14), %eax	;  7 bytes
M00000000000000ba:	cmpq	$3, %rax	;  4 bytes
M00000000000000be:	ja	0x4d03ff <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0xcf>	;  2 bytes
M00000000000000c0:	jmpq	*6595720(,%rax,8)	;  7 bytes
...
M00000000000000e4:	jne	0x4d0427 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0xf7>	;  2 bytes
M00000000000000e6:	movq	4181131(%rip), %rax  # 8cd0a8 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M00000000000000ed:	testq	%rax, %rax	;  3 bytes
M00000000000000f0:	jne	0x4d0427 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0xf7>	;  2 bytes
...
M00000000000000fe:	movaps	443867(%rip), %xmm0  # 53ca10 <__dso_handle+0x8>	;  7 bytes
...
M000000000000011d:	jmp	0x4d0546 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  5 bytes
M0000000000000122:	cmpq	$23, 32(%r14)	;  5 bytes
M0000000000000127:	je	0x4d0466 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x136>	;  2 bytes
...
M0000000000000150:	jmp	0x4d0546 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  5 bytes
M0000000000000155:	movl	$0, (%r14)	;  7 bytes
M000000000000015c:	jmp	0x4d0546 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  5 bytes
M0000000000000161:	movb	$0, (%r14)	;  4 bytes
M0000000000000165:	jmp	0x4d0546 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  5 bytes
M000000000000016a:	cmpq	$23, 32(%r14)	;  5 bytes
M000000000000016f:	je	0x4d04ae <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x17e>	;  2 bytes
...
M0000000000000195:	jmp	0x4d0546 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  2 bytes
...
M00000000000001aa:	jmp	0x4d0548 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x218>	;  2 bytes
M00000000000001ac:	cmpq	$23, 32(%r14)	;  5 bytes
M00000000000001b1:	je	0x4d04f0 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x1c0>	;  2 bytes
...
M00000000000001d3:	jmp	0x4d0546 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x216>	;  2 bytes
M00000000000001d5:	cmpq	$23, 32(%r14)	;  5 bytes
M00000000000001da:	je	0x4d0519 <BloombergLP::s_baltst::SequenceWithAnonymityChoice::makeSelection(int)+0x1e9>	;  2 bytes
