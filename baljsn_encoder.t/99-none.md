...
0000000000000011: 06	je	0x4c57b5 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x105>
0000000000000017: 04	movq	8(%rdi), %r14
000000000000001b: 03	cmpq	%r14, %rbx
000000000000001e: 06	je	0x4c57a8 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0xf8>
0000000000000024: 04	movq	%rdi, (%rsp)
0000000000000028: 02	jmp	0x4c570b <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x5b>
...
0000000000000055: 06	je	0x4c57a1 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0xf1>
000000000000005b: 03	movl	8(%rbx), %eax
000000000000005e: 03	cmpl	$3, %eax
0000000000000061: 02	je	0x4c5740 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x90>
0000000000000063: 03	cmpl	$2, %eax
0000000000000066: 02	jne	0x4c56f7 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x47>
0000000000000068: 03	movq	(%rbx), %r15
000000000000006b: 03	testq	%r15, %r15
000000000000006e: 02	je	0x4c56f7 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x47>
...
0000000000000089: 02	jmp	0x4c56f7 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x47>
000000000000008b: 05	nopl	(%rax,%rax)
0000000000000090: 03	movq	(%rbx), %r15
0000000000000093: 03	testq	%r15, %r15
0000000000000096: 02	je	0x4c56f7 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x47>
0000000000000098: 04	movq	16(%rbx), %r12
000000000000009c: 04	movl	48(%r15), %eax
00000000000000a0: 03	cmpl	$2, %eax
00000000000000a3: 02	je	0x4c5777 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0xc7>
00000000000000a5: 03	cmpl	$1, %eax
00000000000000a8: 02	jne	0x4c56e2 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x32>
00000000000000aa: 05	cmpq	$23, 32(%r15)
00000000000000af: 06	je	0x4c56da <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x2a>
...
00000000000000c2: 05	jmp	0x4c56da <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x2a>
00000000000000c7: 03	movq	(%r15), %r13
00000000000000ca: 03	testq	%r13, %r13
00000000000000cd: 06	je	0x4c56e2 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x32>
...
00000000000000ec: 05	jmp	0x4c56e2 <bsl::vector<BloombergLP::s_baltst::Choice1, bsl::allocator<BloombergLP::s_baltst::Choice1> >::~vector()+0x32>
