# `BloombergLP::s_baltst::SequenceWithAnonymityChoice1::reset()` - Assumed

```nasm
00000000004d0f30 <BloombergLP::s_baltst::SequenceWithAnonymityChoice1::reset()>:
...
M0000000000000009:	je	0x4d0f5c <BloombergLP::s_baltst::SequenceWithAnonymityChoice1::reset()+0x2c>	;  2 bytes
M000000000000000b:	cmpl	$1, %eax	;  3 bytes
M000000000000000e:	jne	0x4d0f5c <BloombergLP::s_baltst::SequenceWithAnonymityChoice1::reset()+0x2c>	;  2 bytes
M0000000000000010:	cmpq	$23, 32(%rbx)	;  5 bytes
M0000000000000015:	je	0x4d0f54 <BloombergLP::s_baltst::SequenceWithAnonymityChoice1::reset()+0x24>	;  2 bytes
...
M0000000000000038:	callq	0x428650 <__clang_call_terminate>	;  5 bytes
