...
0000000000000009: 02	ja	0x4b9c17 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x67>
000000000000000b: 03	movq	%rdi, %r14
000000000000000e: 07	jmpq	*6590272(,%rsi,8)
0000000000000015: 07	movl	368(%r14), %eax
000000000000001c: 03	cmpl	$2, %eax
000000000000001f: 06	je	0x4b9ca0 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0xf0>
0000000000000025: 02	testl	%eax, %eax
0000000000000027: 06	jne	0x4b9cbc <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x10c>
000000000000002d: 03	movq	%r14, %rdi
0000000000000030: 05	callq	0x4c4be0 <BloombergLP::s_baltst::Sequence6::~Sequence6()>
0000000000000035: 05	jmp	0x4b9cbc <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x10c>
000000000000003a: 07	movl	368(%r14), %eax
0000000000000041: 02	testl	%eax, %eax
0000000000000043: 06	je	0x4b9d6a <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1ba>
0000000000000049: 03	cmpl	$2, %eax
000000000000004c: 06	je	0x4b9d74 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1c4>
0000000000000052: 03	cmpl	$3, %eax
0000000000000055: 06	jne	0x4b9d90 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1e0>
000000000000005b: 07	movl	$0, (%r14)
0000000000000062: 05	jmp	0x4b9dd9 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x229>
0000000000000067: 05	movl	$4294967295, %ebx
000000000000006c: 05	jmp	0x4b9ddb <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x22b>
0000000000000071: 07	movl	368(%r14), %eax
0000000000000078: 03	cmpl	$2, %eax
000000000000007b: 06	je	0x4b9ccc <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x11c>
0000000000000081: 02	testl	%eax, %eax
0000000000000083: 06	jne	0x4b9ce8 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x138>
0000000000000089: 03	movq	%r14, %rdi
000000000000008c: 05	callq	0x4c4d80 <BloombergLP::s_baltst::Sequence6::reset()>
0000000000000091: 05	jmp	0x4b9dd9 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x229>
0000000000000096: 07	movl	368(%r14), %eax
000000000000009d: 02	testl	%eax, %eax
000000000000009f: 06	je	0x4b9da4 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1f4>
00000000000000a5: 03	cmpl	$2, %eax
00000000000000a8: 06	je	0x4b9dae <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1fe>
00000000000000ae: 03	cmpl	$1, %eax
00000000000000b1: 06	jne	0x4b9dca <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x21a>
00000000000000b7: 04	movb	$0, (%r14)
00000000000000bb: 05	jmp	0x4b9dd9 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x229>
00000000000000c0: 07	movl	368(%r14), %eax
00000000000000c7: 02	testl	%eax, %eax
00000000000000c9: 06	je	0x4b9d12 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x162>
00000000000000cf: 03	cmpl	$2, %eax
00000000000000d2: 06	jne	0x4b9d1a <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x16a>
...
00000000000000eb: 05	jmp	0x4b9ddb <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x22b>
00000000000000f0: 05	cmpq	$23, 32(%r14)
00000000000000f5: 02	je	0x4b9cb4 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x104>
...
0000000000000117: 05	jmp	0x4b9dd9 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x229>
000000000000011c: 05	cmpq	$23, 32(%r14)
0000000000000121: 02	je	0x4b9ce0 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x130>
...
000000000000015d: 05	jmp	0x4b9dd9 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x229>
...
000000000000017f: 02	jne	0x4b9d42 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x192>
0000000000000181: 07	movq	4273008(%rip), %rax  # 8cd0a8 <BloombergLP::bslma::Default::s_defaultAllocator>
0000000000000188: 03	testq	%rax, %rax
000000000000018b: 02	jne	0x4b9d42 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x192>
...
0000000000000199: 07	movaps	538848(%rip), %xmm0  # 53d630 <__dso_handle+0x8>
...
00000000000001b8: 02	jmp	0x4b9dd9 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x229>
00000000000001ba: 03	movq	%r14, %rdi
00000000000001bd: 05	callq	0x4c4be0 <BloombergLP::s_baltst::Sequence6::~Sequence6()>
00000000000001c2: 02	jmp	0x4b9d90 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1e0>
00000000000001c4: 05	cmpq	$23, 32(%r14)
00000000000001c9: 02	je	0x4b9d88 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1d8>
...
00000000000001f2: 02	jmp	0x4b9dd9 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x229>
00000000000001f4: 03	movq	%r14, %rdi
00000000000001f7: 05	callq	0x4c4be0 <BloombergLP::s_baltst::Sequence6::~Sequence6()>
00000000000001fc: 02	jmp	0x4b9dca <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x21a>
00000000000001fe: 05	cmpq	$23, 32(%r14)
0000000000000203: 02	je	0x4b9dc2 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x212>
