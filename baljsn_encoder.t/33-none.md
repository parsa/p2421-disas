# `BloombergLP::s_baltst::Choice1::~Choice1()` - Ignored
...
M0000000000000012:	je	0x4c9cc3 <BloombergLP::s_baltst::Choice1::~Choice1()+0x43>	;  2 bytes
M0000000000000014:	cmpl	$2, %eax	;  3 bytes
M0000000000000017:	jne	0x4c9d30 <BloombergLP::s_baltst::Choice1::~Choice1()+0xb0>	;  6 bytes
M000000000000001d:	movq	(%rbx), %r14	;  3 bytes
M0000000000000020:	testq	%r14, %r14	;  3 bytes
M0000000000000023:	je	0x4c9d30 <BloombergLP::s_baltst::Choice1::~Choice1()+0xb0>	;  6 bytes
M0000000000000029:	movq	16(%rbx), %r15	;  4 bytes
M000000000000002d:	movq	%r14, %rdi	;  3 bytes
M0000000000000030:	callq	0x4c06a0 <BloombergLP::s_baltst::Sequence4::~Sequence4()>	;  5 bytes
...
M0000000000000041:	jmp	0x4c9d30 <BloombergLP::s_baltst::Choice1::~Choice1()+0xb0>	;  2 bytes
M0000000000000043:	movq	(%rbx), %r14	;  3 bytes
M0000000000000046:	testq	%r14, %r14	;  3 bytes
M0000000000000049:	je	0x4c9d30 <BloombergLP::s_baltst::Choice1::~Choice1()+0xb0>	;  2 bytes
M000000000000004b:	movq	16(%rbx), %r15	;  4 bytes
M000000000000004f:	movl	48(%r14), %eax	;  4 bytes
M0000000000000053:	cmpl	$2, %eax	;  3 bytes
M0000000000000056:	je	0x4c9cfb <BloombergLP::s_baltst::Choice1::~Choice1()+0x7b>	;  2 bytes
M0000000000000058:	cmpl	$1, %eax	;  3 bytes
M000000000000005b:	jne	0x4c9d1c <BloombergLP::s_baltst::Choice1::~Choice1()+0x9c>	;  2 bytes
M000000000000005d:	cmpq	$23, 32(%r14)	;  5 bytes
M0000000000000062:	je	0x4c9cf1 <BloombergLP::s_baltst::Choice1::~Choice1()+0x71>	;  2 bytes
...
M0000000000000079:	jmp	0x4c9d1c <BloombergLP::s_baltst::Choice1::~Choice1()+0x9c>	;  2 bytes
M000000000000007b:	movq	(%r14), %r12	;  3 bytes
M000000000000007e:	testq	%r12, %r12	;  3 bytes
M0000000000000081:	je	0x4c9d1c <BloombergLP::s_baltst::Choice1::~Choice1()+0x9c>	;  2 bytes
M0000000000000083:	movq	56(%r14), %r13	;  4 bytes
M0000000000000087:	movq	%r12, %rdi	;  3 bytes
M000000000000008a:	callq	0x4c9c80 <BloombergLP::s_baltst::Choice1::~Choice1()>	;  5 bytes
...
M00000000000000c4:	callq	0x4286b0 <__clang_call_terminate>	;  5 bytes
M00000000000000c9:	movq	%rax, %rdi	;  3 bytes
M00000000000000cc:	callq	0x4286b0 <__clang_call_terminate>	;  5 bytes
M00000000000000d1:	movq	%rax, %rdi	;  3 bytes
M00000000000000d4:	callq	0x4286b0 <__clang_call_terminate>	;  5 bytes
