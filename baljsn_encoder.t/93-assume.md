...
0000000000000009: 02	ja	0x4b997f <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x5f>
000000000000000b: 03	movq	%rdi, %r14
000000000000000e: 07	jmpq	*6589696(,%rsi,8)
0000000000000015: 07	movl	368(%r14), %eax
000000000000001c: 04	cmpq	$3, %rax
0000000000000020: 06	ja	0x4b9ae8 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1c8>
0000000000000026: 07	jmpq	*6589736(,%rax,8)
000000000000002d: 03	movq	%r14, %rdi
0000000000000030: 05	callq	0x4c4a50 <BloombergLP::s_baltst::Sequence6::~Sequence6()>
0000000000000035: 05	jmp	0x4b9ae8 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1c8>
000000000000003a: 07	movl	368(%r14), %eax
0000000000000041: 04	cmpq	$3, %rax
0000000000000045: 06	ja	0x4b9a5e <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x13e>
000000000000004b: 07	jmpq	*6589768(,%rax,8)
0000000000000052: 03	movq	%r14, %rdi
0000000000000055: 05	callq	0x4c4a50 <BloombergLP::s_baltst::Sequence6::~Sequence6()>
000000000000005a: 05	jmp	0x4b9a5e <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x13e>
000000000000005f: 05	movl	$4294967295, %ebx
0000000000000064: 05	jmp	0x4b9b38 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x218>
0000000000000069: 07	movl	368(%r14), %eax
0000000000000070: 04	cmpq	$3, %rax
0000000000000074: 06	ja	0x4b9b11 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1f1>
000000000000007a: 07	jmpq	*6589864(,%rax,8)
0000000000000081: 03	movq	%r14, %rdi
0000000000000084: 05	callq	0x4c4bf0 <BloombergLP::s_baltst::Sequence6::reset()>
0000000000000089: 05	jmp	0x4b9b36 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x216>
000000000000008e: 07	movl	368(%r14), %eax
0000000000000095: 04	cmpq	$3, %rax
0000000000000099: 06	ja	0x4b9aa6 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x186>
000000000000009f: 07	jmpq	*6589832(,%rax,8)
00000000000000a6: 03	movq	%r14, %rdi
00000000000000a9: 05	callq	0x4c4a50 <BloombergLP::s_baltst::Sequence6::~Sequence6()>
00000000000000ae: 05	jmp	0x4b9aa6 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x186>
00000000000000b3: 07	movl	368(%r14), %eax
00000000000000ba: 04	cmpq	$3, %rax
00000000000000be: 02	ja	0x4b99ef <BloombergLP::s_baltst::Choice3::makeSelection(int)+0xcf>
00000000000000c0: 07	jmpq	*6589800(,%rax,8)
...
00000000000000e4: 02	jne	0x4b9a17 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0xf7>
00000000000000e6: 07	movq	4273819(%rip), %rax  # 8cd0a8 <BloombergLP::bslma::Default::s_defaultAllocator>
00000000000000ed: 03	testq	%rax, %rax
00000000000000f0: 02	jne	0x4b9a17 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0xf7>
...
00000000000000fe: 07	movaps	536555(%rip), %xmm0  # 53ca10 <__dso_handle+0x8>
...
000000000000011d: 05	jmp	0x4b9b36 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x216>
0000000000000122: 05	cmpq	$23, 32(%r14)
0000000000000127: 02	je	0x4b9a56 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x136>
...
0000000000000150: 05	jmp	0x4b9b36 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x216>
0000000000000155: 07	movl	$0, (%r14)
000000000000015c: 05	jmp	0x4b9b36 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x216>
0000000000000161: 04	movb	$0, (%r14)
0000000000000165: 05	jmp	0x4b9b36 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x216>
000000000000016a: 05	cmpq	$23, 32(%r14)
000000000000016f: 02	je	0x4b9a9e <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x17e>
...
0000000000000195: 02	jmp	0x4b9b36 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x216>
...
00000000000001aa: 02	jmp	0x4b9b38 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x218>
00000000000001ac: 05	cmpq	$23, 32(%r14)
00000000000001b1: 02	je	0x4b9ae0 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1c0>
...
00000000000001d3: 02	jmp	0x4b9b36 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x216>
00000000000001d5: 05	cmpq	$23, 32(%r14)
00000000000001da: 02	je	0x4b9b09 <BloombergLP::s_baltst::Choice3::makeSelection(int)+0x1e9>
