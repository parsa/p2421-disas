...
M000000000000001d:	je	0x483449 <int BloombergLP::baljsn::Encoder_ValueDispatcher::operator()<BloombergLP::bdlt::Time>(BloombergLP::bdlt::Time const&, BloombergLP::bdlat_TypeCategory::Simple)+0x49>	;  2 bytes
...
M0000000000000039:	jae	0x483449 <int BloombergLP::baljsn::Encoder_ValueDispatcher::operator()<BloombergLP::bdlt::Time>(BloombergLP::bdlt::Time const&, BloombergLP::bdlat_TypeCategory::Simple)+0x49>	;  2 bytes
...
M0000000000000057:	je	0x48346a <int BloombergLP::baljsn::Encoder_ValueDispatcher::operator()<BloombergLP::bdlt::Time>(BloombergLP::bdlt::Time const&, BloombergLP::bdlat_TypeCategory::Simple)+0x6a>	;  2 bytes
...
M0000000000000068:	jmp	0x483479 <int BloombergLP::baljsn::Encoder_ValueDispatcher::operator()<BloombergLP::bdlt::Time>(BloombergLP::bdlt::Time const&, BloombergLP::bdlat_TypeCategory::Simple)+0x79>	;  2 bytes
...
M000000000000008e:	callq	0x4e6300 <BloombergLP::bdlt::Iso8601Util::generate(char*, int, BloombergLP::bdlt::Time const&, BloombergLP::bdlt::Iso8601UtilConfiguration const&)>	;  5 bytes
