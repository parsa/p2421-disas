...
M0000000000000011:	je	0x482c10 <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0x80>	;  2 bytes
M0000000000000013:	testl	%eax, %eax	;  2 bytes
M0000000000000015:	jne	0x482c67 <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0xd7>	;  6 bytes
M000000000000001b:	movq	8(%rbx), %rsi	;  4 bytes
M000000000000001f:	movq	16(%rbx), %rdx	;  4 bytes
M0000000000000023:	movq	830750(%rip), %r10  # 54d8d8 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x8>	;  7 bytes
M000000000000002a:	movslq	830751(%rip), %rdi  # 54d8e0 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x10>	;  7 bytes
M0000000000000031:	movl	830760(%rip), %r9d  # 54d8f0 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x20>	;  7 bytes
...
M0000000000000071:	callq	0x482c80 <int BloombergLP::baljsn::Encoder_EncodeImplUtil::encodeMember<BloombergLP::balb::Choice4, BloombergLP::bdlat_TypeCategory::Choice>(bool*, BloombergLP::baljsn::Formatter*, std::__1::basic_ostream<char, std::__1::char_traits<char> >*, std::__1::basic_string_view<char, std::__1::char_traits<char> > const&, BloombergLP::balb::Choice4 const&, int, BloombergLP::baljsn::EncoderOptions const&, bool, BloombergLP::bdlat_TypeCategory::Choice)>	;  5 bytes
M0000000000000076:	addq	$16, %rsp	;  4 bytes
M000000000000007a:	testl	%eax, %eax	;  2 bytes
M000000000000007c:	jne	0x482c6c <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0xdc>	;  2 bytes
M000000000000007e:	jmp	0x482c60 <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0xd0>	;  2 bytes
M0000000000000080:	movups	8(%rbx), %xmm0	;  4 bytes
M0000000000000084:	movq	830693(%rip), %rax  # 54d900 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x30>	;  7 bytes
M000000000000008b:	movslq	830694(%rip), %rcx  # 54d908 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x38>	;  7 bytes
M0000000000000092:	movl	830704(%rip), %edx  # 54d918 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x48>	;  6 bytes
...
M00000000000000ce:	jne	0x482c6c <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0xdc>	;  2 bytes
M00000000000000d0:	movb	(%rsp), %cl	;  3 bytes
M00000000000000d3:	movb	%cl, (%rbx)	;  2 bytes
M00000000000000d5:	jmp	0x482c6c <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0xdc>	;  2 bytes
