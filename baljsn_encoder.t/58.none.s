...
M0000000000000013:	je	0x4b9612 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x52>	;  2 bytes
M0000000000000015:	cmpl	$2, %eax	;  3 bytes
M0000000000000018:	jne	0x4b961a <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x5a>	;  2 bytes
M000000000000001a:	cmpq	%r14, %rbx	;  3 bytes
M000000000000001d:	je	0x4b96ca <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x10a>	;  6 bytes
M0000000000000023:	movq	24(%r14), %rdx	;  4 bytes
M0000000000000027:	cmpq	$23, 32(%r14)	;  5 bytes
M000000000000002c:	je	0x4b95f1 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x31>	;  2 bytes
...
M000000000000004d:	jmp	0x4b96ca <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x10a>	;  5 bytes
...
M000000000000006e:	jne	0x4b9644 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x84>	;  2 bytes
M0000000000000070:	movq	4274801(%rip), %rdi  # 8cd0a8 <BloombergLP::bslma::Default::s_defaultAllocator>	;  7 bytes
M0000000000000077:	testq	%rdi, %rdi	;  3 bytes
M000000000000007a:	jne	0x4b9644 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x84>	;  2 bytes
...
M00000000000000a4:	je	0x4b96c0 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x100>	;  2 bytes
...
M00000000000000ca:	jb	0x4b969f <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0xdf>	;  2 bytes
...
M00000000000000dd:	jne	0x4b96a2 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0xe2>	;  2 bytes
M00000000000000df:	movq	%rbx, %rax	;  3 bytes
M00000000000000e2:	movq	24(%rbx), %rdx	;  4 bytes
M00000000000000e6:	incq	%rdx	;  3 bytes
M00000000000000e9:	je	0x4b96c0 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0x100>	;  2 bytes
M00000000000000eb:	cmpq	$23, 32(%r14)	;  5 bytes
M00000000000000f0:	je	0x4b96b5 <BloombergLP::s_baltst::Choice3::makeSelection3(BloombergLP::s_baltst::CustomString const&)+0xf5>	;  2 bytes
