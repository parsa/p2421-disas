...
0000000000000011: 02	je	0x482c10 <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0x80>
0000000000000013: 02	testl	%eax, %eax
0000000000000015: 06	jne	0x482c67 <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0xd7>
000000000000001b: 04	movq	8(%rbx), %rsi
000000000000001f: 04	movq	16(%rbx), %rdx
0000000000000023: 07	movq	830750(%rip), %r10  # 54d8d8 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x8>
000000000000002a: 07	movslq	830751(%rip), %rdi  # 54d8e0 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x10>
0000000000000031: 07	movl	830760(%rip), %r9d  # 54d8f0 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x20>
...
0000000000000071: 05	callq	0x482c80 <int BloombergLP::baljsn::Encoder_EncodeImplUtil::encodeMember<BloombergLP::balb::Choice4, BloombergLP::bdlat_TypeCategory::Choice>(bool*, BloombergLP::baljsn::Formatter*, std::__1::basic_ostream<char, std::__1::char_traits<char> >*, std::__1::basic_string_view<char, std::__1::char_traits<char> > const&, BloombergLP::balb::Choice4 const&, int, BloombergLP::baljsn::EncoderOptions const&, bool, BloombergLP::bdlat_TypeCategory::Choice)>
0000000000000076: 04	addq	$16, %rsp
000000000000007a: 02	testl	%eax, %eax
000000000000007c: 02	jne	0x482c6c <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0xdc>
000000000000007e: 02	jmp	0x482c60 <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0xd0>
0000000000000080: 04	movups	8(%rbx), %xmm0
0000000000000084: 07	movq	830693(%rip), %rax  # 54d900 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x30>
000000000000008b: 07	movslq	830694(%rip), %rcx  # 54d908 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x38>
0000000000000092: 06	movl	830704(%rip), %edx  # 54d918 <BloombergLP::balb::Choice5::SELECTION_INFO_ARRAY+0x48>
...
00000000000000ce: 02	jne	0x482c6c <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0xdc>
00000000000000d0: 03	movb	(%rsp), %cl
00000000000000d3: 02	movb	%cl, (%rbx)
00000000000000d5: 02	jmp	0x482c6c <int BloombergLP::balb::Choice5::accessSelection<BloombergLP::baljsn::Encoder_SelectionVisitor>(BloombergLP::baljsn::Encoder_SelectionVisitor&) const+0xdc>
