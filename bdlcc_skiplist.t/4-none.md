...
000000000000007c: 05	movl	$6797685, %esi
0000000000000081: 05	movl	$22, %edx
0000000000000086: 05	callq	0x5bcfd0 <std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::__put_character_sequence<char, std::__1::char_traits<char> >(std::__1::basic_ostream<char, std::__1::char_traits<char> >&, char const*, unsigned long)>
...
00000000000000e0: 05	movl	$6798732, %esi
00000000000000e5: 05	movl	$22, %edx
00000000000000ea: 03	movq	%rbx, %rdi
00000000000000ed: 05	callq	0x5bcfd0 <std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::__put_character_sequence<char, std::__1::char_traits<char> >(std::__1::basic_ostream<char, std::__1::char_traits<char> >&, char const*, unsigned long)>
...
0000000000000147: 07	movaps	2566850(%rip), %xmm0  # 678d30 <__dso_handle+0x12b8>
000000000000014e: 08	movaps	%xmm0, 320(%rsp)
0000000000000156: 07	movaps	2566819(%rip), %xmm0  # 678d20 <__dso_handle+0x12a8>
000000000000015d: 08	movaps	%xmm0, 304(%rsp)
0000000000000165: 07	movaps	2566788(%rip), %xmm0  # 678d10 <__dso_handle+0x1298>
000000000000016c: 08	movaps	%xmm0, 288(%rsp)
0000000000000174: 07	movaps	2566757(%rip), %xmm0  # 678d00 <__dso_handle+0x1288>
000000000000017b: 08	movaps	%xmm0, 272(%rsp)
0000000000000183: 07	movaps	2566726(%rip), %xmm0  # 678cf0 <__dso_handle+0x1278>
000000000000018a: 08	movaps	%xmm0, 256(%rsp)
0000000000000192: 03	movq	%rsp, %rdi
0000000000000195: 05	callq	0x64a5e0 <BloombergLP::bdlcc::SkipList_RandomLevelGenerator::SkipList_RandomLevelGenerator()>
...
00000000000001ce: 05	callq	0x64efc0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
00000000000001d3: 03	movq	%rax, %rdx
00000000000001d6: 05	movq	%rdx, 88(%rsp)
00000000000001db: 07	movaps	2574334(%rip), %xmm0  # 67ab00 <(anonymous namespace)::u::DATA+0x1a60>
00000000000001e2: 05	movaps	%xmm0, 96(%rsp)
00000000000001e7: 07	movaps	2574338(%rip), %xmm0  # 67ab10 <(anonymous namespace)::u::DATA+0x1a70>
00000000000001ee: 05	movaps	%xmm0, 112(%rsp)
00000000000001f3: 07	movaps	2574342(%rip), %xmm0  # 67ab20 <(anonymous namespace)::u::DATA+0x1a80>
00000000000001fa: 08	movaps	%xmm0, 128(%rsp)
0000000000000202: 07	movaps	2574343(%rip), %xmm0  # 67ab30 <(anonymous namespace)::u::DATA+0x1a90>
0000000000000209: 08	movaps	%xmm0, 144(%rsp)
0000000000000211: 07	movaps	2574344(%rip), %xmm0  # 67ab40 <(anonymous namespace)::u::DATA+0x1aa0>
0000000000000218: 08	movaps	%xmm0, 160(%rsp)
0000000000000220: 07	movaps	2574345(%rip), %xmm0  # 67ab50 <(anonymous namespace)::u::DATA+0x1ab0>
0000000000000227: 08	movaps	%xmm0, 176(%rsp)
000000000000022f: 07	movaps	2574346(%rip), %xmm0  # 67ab60 <(anonymous namespace)::u::DATA+0x1ac0>
0000000000000236: 08	movaps	%xmm0, 192(%rsp)
000000000000023e: 07	movaps	2574347(%rip), %xmm0  # 67ab70 <(anonymous namespace)::u::DATA+0x1ad0>
...
000000000000025a: 05	callq	0x64aae0 <BloombergLP::bdlcc::SkipList_PoolUtil::createPoolManager(int*, int, BloombergLP::bslma::Allocator*)>
000000000000025f: 05	movq	%rax, 80(%rsp)
0000000000000264: 03	movq	%rax, %rdi
0000000000000267: 05	movl	$31, %esi
000000000000026c: 05	callq	0x64aa20 <BloombergLP::bdlcc::SkipList_PoolUtil::allocate(BloombergLP::bdlcc::SkipList_PoolManager*, int)>
0000000000000271: 05	movq	%rax, 16(%rsp)
0000000000000276: 05	movq	80(%rsp), %rdi
000000000000027b: 05	movl	$31, %esi
0000000000000280: 05	callq	0x64aa20 <BloombergLP::bdlcc::SkipList_PoolUtil::allocate(BloombergLP::bdlcc::SkipList_PoolManager*, int)>
...
00000000000002e8: 05	callq	0x64aa20 <BloombergLP::bdlcc::SkipList_PoolUtil::allocate(BloombergLP::bdlcc::SkipList_PoolManager*, int)>
...
0000000000000304: 05	callq	0x64efc0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
0000000000000309: 10	movabsq	$4294967297, %rax
0000000000000313: 04	movq	%rax, 8(%r15)
0000000000000317: 03	movq	%r15, %rdi
000000000000031a: 05	callq	0x64a590 <BloombergLP::bdlcc::SkipList_Control::incrementRefCount()>
...
000000000000032f: 05	callq	0x5bd4b0 <BloombergLP::bdlcc::SkipList<int, int>::addNode(bool*, BloombergLP::bdlcc::SkipList_Node<int, int>*)>
...
000000000000034a: 05	callq	0x64aa20 <BloombergLP::bdlcc::SkipList_PoolUtil::allocate(BloombergLP::bdlcc::SkipList_PoolManager*, int)>
...
0000000000000366: 05	callq	0x64efc0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
000000000000036b: 10	movabsq	$12884901891, %rax
0000000000000375: 04	movq	%rax, 8(%r15)
0000000000000379: 03	movq	%r15, %rdi
000000000000037c: 05	callq	0x64a590 <BloombergLP::bdlcc::SkipList_Control::incrementRefCount()>
...
0000000000000391: 05	callq	0x5bd4b0 <BloombergLP::bdlcc::SkipList<int, int>::addNode(bool*, BloombergLP::bdlcc::SkipList_Node<int, int>*)>
...
00000000000003ad: 05	callq	0x64aa20 <BloombergLP::bdlcc::SkipList_PoolUtil::allocate(BloombergLP::bdlcc::SkipList_PoolManager*, int)>
...
00000000000003c9: 05	callq	0x64efc0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
00000000000003ce: 08	movq	$0, 8(%r15)
00000000000003d6: 03	movq	%r15, %rdi
00000000000003d9: 05	callq	0x64a590 <BloombergLP::bdlcc::SkipList_Control::incrementRefCount()>
...
00000000000003ee: 05	callq	0x5bd4b0 <BloombergLP::bdlcc::SkipList<int, int>::addNode(bool*, BloombergLP::bdlcc::SkipList_Node<int, int>*)>
...
000000000000040a: 05	callq	0x64aa20 <BloombergLP::bdlcc::SkipList_PoolUtil::allocate(BloombergLP::bdlcc::SkipList_PoolManager*, int)>
...
0000000000000426: 05	callq	0x64efc0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
000000000000042b: 10	movabsq	$8589934594, %rax
0000000000000435: 04	movq	%rax, 8(%r15)
0000000000000439: 03	movq	%r15, %rdi
000000000000043c: 05	callq	0x64a590 <BloombergLP::bdlcc::SkipList_Control::incrementRefCount()>
...
0000000000000451: 05	callq	0x5bd4b0 <BloombergLP::bdlcc::SkipList<int, int>::addNode(bool*, BloombergLP::bdlcc::SkipList_Node<int, int>*)>
...
000000000000046d: 05	callq	0x64aa20 <BloombergLP::bdlcc::SkipList_PoolUtil::allocate(BloombergLP::bdlcc::SkipList_PoolManager*, int)>
...
0000000000000489: 05	callq	0x64efc0 <BloombergLP::bslma::Default::determineAndReturnDefaultAllocator()>
000000000000048e: 10	movabsq	$17179869188, %rax
0000000000000498: 05	movq	%rax, 8(%r12)
000000000000049d: 03	movq	%r12, %rdi
00000000000004a0: 05	callq	0x64a590 <BloombergLP::bdlcc::SkipList_Control::incrementRefCount()>
...
00000000000004b9: 05	callq	0x5bd4b0 <BloombergLP::bdlcc::SkipList<int, int>::addNode(bool*, BloombergLP::bdlcc::SkipList_Node<int, int>*)>
...
00000000000005de: 05	callq	0x437d00 <void SKIPLIST_OLD_TEST_CASES_NAMEPSACE::verifyEx<BloombergLP::bdlcc::SkipList<int, int>, SKIPLIST_OLD_TEST_CASES_NAMEPSACE::IDATA [5]>(BloombergLP::bdlcc::SkipList<int, int>*, SKIPLIST_OLD_TEST_CASES_NAMEPSACE::IDATA const (&) [5], int, int)>
00000000000005e3: 05	movq	16(%rsp), %rbx
00000000000005e8: 08	nopl	(%rax,%rax)
00000000000005f0: 04	movq	16(%rbx), %rbx
00000000000005f4: 05	cmpq	24(%rsp), %rbx
00000000000005f9: 02	je	0x406725 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x605>
00000000000005fb: 03	movq	%rbx, %rdi
00000000000005fe: 05	callq	0x64a560 <BloombergLP::bdlcc::SkipList_Control::decrementRefCount()>
0000000000000603: 02	jmp	0x406710 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x5f0>
0000000000000605: 05	movq	80(%rsp), %rsi
000000000000060a: 05	movq	88(%rsp), %rdi
000000000000060f: 05	callq	0x64aba0 <BloombergLP::bdlcc::SkipList_PoolUtil::deletePoolManager(BloombergLP::bslma::Allocator*, BloombergLP::bdlcc::SkipList_PoolManager*)>
0000000000000614: 05	leaq	32(%rsp), %rdi
0000000000000619: 05	callq	0x650110 <BloombergLP::bslmt::MutexImpl<BloombergLP::bslmt::Platform::PosixThreads>::~MutexImpl()>
000000000000061e: 07	addq	$336, %rsp
0000000000000625: 01	popq	%rbx
0000000000000626: 02	popq	%r12
0000000000000628: 02	popq	%r14
000000000000062a: 02	popq	%r15
000000000000062c: 01	popq	%rbp
000000000000062d: 01	retq	
000000000000062e: 02	jmp	0x4067c8 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x6a8>
0000000000000630: 02	jmp	0x406779 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x659>
0000000000000632: 02	jmp	0x406756 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x636>
0000000000000634: 02	jmp	0x406756 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x636>
0000000000000636: 03	movq	%rax, %r15
0000000000000639: 05	leaq	96(%rsp), %rdi
000000000000063e: 05	callq	0x405240 <_ZNSt3__16localeD1Ev@plt>
0000000000000643: 03	movq	%r15, %rdi
0000000000000646: 05	callq	0x405360 <_Unwind_Resume@plt>
000000000000064b: 03	movq	%rax, %r15
000000000000064e: 03	movq	%r14, %rdi
0000000000000651: 02	jmp	0x4067b9 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x699>
0000000000000653: 02	jmp	0x406779 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x659>
0000000000000655: 02	jmp	0x406779 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x659>
0000000000000657: 02	jmp	0x4067c8 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x6a8>
0000000000000659: 03	movq	%rax, %r15
000000000000065c: 05	movq	16(%rsp), %rbx
0000000000000661: 10	nopw	%cs:(%rax,%rax)
000000000000066b: 05	nopl	(%rax,%rax)
0000000000000670: 04	movq	16(%rbx), %rbx
0000000000000674: 05	cmpq	24(%rsp), %rbx
0000000000000679: 02	je	0x4067a5 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x685>
000000000000067b: 03	movq	%rbx, %rdi
000000000000067e: 05	callq	0x64a560 <BloombergLP::bdlcc::SkipList_Control::decrementRefCount()>
0000000000000683: 02	jmp	0x406790 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x670>
0000000000000685: 05	movq	80(%rsp), %rsi
000000000000068a: 05	movq	88(%rsp), %rdi
000000000000068f: 05	callq	0x64aba0 <BloombergLP::bdlcc::SkipList_PoolUtil::deletePoolManager(BloombergLP::bslma::Allocator*, BloombergLP::bdlcc::SkipList_PoolManager*)>
0000000000000694: 05	leaq	32(%rsp), %rdi
0000000000000699: 05	callq	0x650110 <BloombergLP::bslmt::MutexImpl<BloombergLP::bslmt::Platform::PosixThreads>::~MutexImpl()>
000000000000069e: 03	movq	%r15, %rdi
00000000000006a1: 05	callq	0x405360 <_Unwind_Resume@plt>
00000000000006a6: 02	jmp	0x4067c8 <SKIPLIST_OLD_TEST_CASES_NAMEPSACE::run()+0x6a8>
00000000000006a8: 03	movq	%rax, %rbx
00000000000006ab: 03	movq	%r14, %rdi
00000000000006ae: 05	callq	0x5ba170 <BloombergLP::bslmt::Mutex::~Mutex()>
00000000000006b3: 03	movq	%rbx, %rdi
00000000000006b6: 05	callq	0x5ba160 <__clang_call_terminate>
00000000000006bb: 05	nopl	(%rax,%rax)
```
